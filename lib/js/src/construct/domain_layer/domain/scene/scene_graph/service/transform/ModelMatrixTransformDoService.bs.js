...
var Matrix3$Wonderjs = require("../../../../../library/structure/matrix/Matrix3.bs.js");
...
function getNormalMatrix(transform) {
  return Result$Wonderjs.mapSuccess(Matrix4$Wonderjs.invertTo3x3(Curry._1(DpContainer$Wonderjs.unsafeGetGlobalTempRepoDp(undefined).getFloat9Array, undefined), Curry._1(DpContainer$Wonderjs.unsafeGetTransformRepoDp(undefined).getLocalToWorldMatrix, TransformEntity$Wonderjs.value(transform))), (function (mat3) {
                return NormalMatrixVO$Wonderjs.create(Matrix3$Wonderjs.transposeSelf(mat3));
              }));
}
...
function setPosition(transform, parent, position) {
  return Result$Wonderjs.bind(LocalToWorldMatrixVO$Wonderjs.invert(Curry._1(DpContainer$Wonderjs.unsafeGetGlobalTempRepoDp(undefined).getFloat32Array1, undefined), getLocalToWorldMatrix(parent)), (function (mat4) {
...
function setLocalEulerAngles(transform, localEulerAngles) {
  return setLocalRotation(transform, RotationVO$Wonderjs.create(EulerAnglesVO$Wonderjs.convertToQuaternion(localEulerAngles)));
}
