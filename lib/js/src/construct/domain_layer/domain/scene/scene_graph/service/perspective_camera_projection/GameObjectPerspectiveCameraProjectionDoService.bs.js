...
function getGameObject(cameraProjection) {
  return OptionSt$Wonderjs.map(Curry._1(DpContainer$Wonderjs.unsafeGetPerspectiveCameraProjectionRepoDp(undefined).getGameObject, PerspectiveCameraProjectionEntity$Wonderjs.value(cameraProjection)), GameObjectEntity$Wonderjs.create);
}
