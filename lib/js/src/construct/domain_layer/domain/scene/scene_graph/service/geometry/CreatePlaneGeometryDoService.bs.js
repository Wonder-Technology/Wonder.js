...
function create(width, height, widthSegments, heightSegments) {
  return CreateDefaultGeometryDoService$Wonderjs.create(ComputePointsGeometryDoService$Wonderjs.addTangents(_generate(width, height, widthSegments, heightSegments)));
}
