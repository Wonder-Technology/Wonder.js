...
function getParent(transform) {
  return OptionSt$Wonderjs.map(OptionSt$Wonderjs.fromNullable(Curry._1(DpContainer$Wonderjs.unsafeGetTransformRepoDp(undefined).getParent, TransformEntity$Wonderjs.value(transform))), TransformEntity$Wonderjs.create);
}

function getChildren(transform) {
  return OptionSt$Wonderjs.map(OptionSt$Wonderjs.fromNullable(Curry._1(DpContainer$Wonderjs.unsafeGetTransformRepoDp(undefined).getChildren, TransformEntity$Wonderjs.value(transform))), (function (children) {
