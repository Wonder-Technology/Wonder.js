...
function isDirty(transform) {
  var isDirty$1 = OptionSt$Wonderjs.fromNullable(Curry._1(DpContainer$Wonderjs.unsafeGetTransformRepoDp(undefined).getIsDirty, TransformEntity$Wonderjs.value(transform)));
