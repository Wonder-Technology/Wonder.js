...
function getGameObjects(geometry) {
  return OptionSt$Wonderjs.map(OptionSt$Wonderjs.fromNullable(Curry._1(DpContainer$Wonderjs.unsafeGetGeometryRepoDp(undefined).getGameObjects, GeometryEntity$Wonderjs.value(geometry))), (function (gameObjects) {
