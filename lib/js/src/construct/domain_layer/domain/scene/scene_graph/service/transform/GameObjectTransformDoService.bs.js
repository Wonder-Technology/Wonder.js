...
function getGameObject(transform) {
  return OptionSt$Wonderjs.map(Curry._1(DpContainer$Wonderjs.unsafeGetTransformRepoDp(undefined).getGameObject, TransformEntity$Wonderjs.value(transform)), GameObjectEntity$Wonderjs.create);
}
