...
function getGameObject(cameraView) {
  return OptionSt$Wonderjs.map(OptionSt$Wonderjs.fromNullable(Curry._1(DpContainer$Wonderjs.unsafeGetBasicCameraViewRepoDp(undefined).getGameObject, BasicCameraViewEntity$Wonderjs.value(cameraView))), GameObjectEntity$Wonderjs.create);
}
