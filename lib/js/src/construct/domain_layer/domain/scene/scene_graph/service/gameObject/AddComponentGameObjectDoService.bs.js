...
var AddBSDFMaterialDoService$Wonderjs = require("../bsdf_material/AddBSDFMaterialDoService.bs.js");
...
function addBSDFMaterial(gameObject, material) {
  return _addComponent([
              DpContainer$Wonderjs.unsafeGetGameObjectRepoDp(undefined).hasBSDFMaterial,
              DpContainer$Wonderjs.unsafeGetGameObjectRepoDp(undefined).addBSDFMaterial,
              AddBSDFMaterialDoService$Wonderjs.handleAddComponent
            ], [
              GameObjectEntity$Wonderjs.value(gameObject),
              BSDFMaterialEntity$Wonderjs.value(material)
            ]);
}
