...
function getSceneGameObject(param) {
  return OptionSt$Wonderjs.map(Curry._1(DpContainer$Wonderjs.unsafeGetSceneRepoDp(undefined).getSceneGameObject, undefined), GameObjectEntity$Wonderjs.create);
}
