...
function getGameObject(light) {
  return OptionSt$Wonderjs.map(Curry._1(DpContainer$Wonderjs.unsafeGetDirectionLightRepoDp(undefined).getGameObject, DirectionLightEntity$Wonderjs.value(light)), GameObjectEntity$Wonderjs.create);
}
