...
function mutableUpdate(transform) {
...
function updateAndSetEulerAngles(transform, eulerAngles) {
  return updateAndSetRotation(transform, RotationVO$Wonderjs.create(EulerAnglesVO$Wonderjs.convertToQuaternion(eulerAngles)));
}
