...
function getGameObjects(material) {
  return OptionSt$Wonderjs.map(Curry._1(DpContainer$Wonderjs.unsafeGetPBRMaterialRepoDp(undefined).getGameObjects, PBRMaterialEntity$Wonderjs.value(material)), (function (gameObjects) {
