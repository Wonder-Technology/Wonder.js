...
function unsafeGetBSDFMaterialRepoDp(param) {
  return OptionSt$Wonderjs.unsafeGet(dpContainer.repo).bsdfMaterialRepo;
}
...
function unsafeGetTimeRepoDp(param) {
  return OptionSt$Wonderjs.unsafeGet(dpContainer.timeJobRepo);
}

function setTimeRepoDp(dp) {
  dpContainer.timeJobRepo = dp;
