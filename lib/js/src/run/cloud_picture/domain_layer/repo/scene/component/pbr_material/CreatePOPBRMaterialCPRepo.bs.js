...
function createPO(param) {
  ...
  return Result$Wonderjs.mapSuccess(_initBufferData(pbrMaterialCount, [
                ...
                return {
                        ...
                        diffuseMapImageIdMap: CreateMapComponentCPRepoUtils$Wonderjs.createEmptyMap(pbrMaterialCount),
                        channelRoughnessMetallicMapImageIdMap: CreateMapComponentCPRepoUtils$Wonderjs.createEmptyMap(pbrMaterialCount),
                        emissionMapImageIdMap: CreateMapComponentCPRepoUtils$Wonderjs.createEmptyMap(pbrMaterialCount),
                        normalMapImageIdMap: CreateMapComponentCPRepoUtils$Wonderjs.createEmptyMap(pbrMaterialCount)
                      };
              }));
}
