...
function _getAllUsedImageIdAndData(param) {
  return ListSt$Wonderjs.removeDuplicateItemsU(ListSt$Wonderjs.reduce(GameObjectRunAPI$Wonderjs.getAllRenderBSDFMaterials(undefined), /* [] */0, (function (result, material) {
