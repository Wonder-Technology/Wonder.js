...
function create(param) {
  return JobEntity$Wonderjs.create("render_rayTracing");
}

function exec(param) {
  return Most.just(Result$Wonderjs.mapSuccess(Tuple4$Wonderjs.collectOption(WebGPUCPRepo$Wonderjs.getDevice(undefined), WebGPUCPRepo$Wonderjs.getQueue(undefined), WebGPUCPRepo$Wonderjs.getWindow(undefined), RayTracingPassCPRepo$Wonderjs.getPipeline(undefined)), (function (param) {
                    var $$window = param[2];
                    ...
                    ListSt$Wonderjs.forEach(RayTracingPassCPRepo$Wonderjs.getAllStaticBindGroupData(undefined), (function (param) {
