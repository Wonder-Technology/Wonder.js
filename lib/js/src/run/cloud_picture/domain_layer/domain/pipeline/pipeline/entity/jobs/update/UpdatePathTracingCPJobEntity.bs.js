...
function _buildAndSetPBRMaterialBufferData(device, allRenderPBRMaterials) {
  ...
  var bufferData = new Float32Array(Math.imul(pbrMaterialCount, 20));
  var bufferSize = bufferData.byteLength;
  var buffer = StorageBufferVO$Wonderjs.createFromDevice(device, bufferSize, WebGPUCoreDpRunAPI$Wonderjs.unsafeGet(undefined).bufferUsage.copy_dst | WebGPUCoreDpRunAPI$Wonderjs.unsafeGet(undefined).bufferUsage.storage, undefined);
  return Result$Wonderjs.mapSuccess(ListSt$Wonderjs.traverseReduceResultM(allRenderPBRMaterials, 0, (function (offset, pbrMaterial) {
                    ...
                    var diffuseMapImageId = PBRMaterialRunAPI$Wonderjs.getDiffuseMapImageId(pbrMaterial);
                    var channelRoughnessMetallicMapImageId = PBRMaterialRunAPI$Wonderjs.getChannelRoughnessMetallicMapImageId(pbrMaterial);
                    var emissionMapImageId = PBRMaterialRunAPI$Wonderjs.getEmissionMapImageId(pbrMaterial);
                    var normalMapImageId = PBRMaterialRunAPI$Wonderjs.getNormalMapImageId(pbrMaterial);
                    return Result$Wonderjs.mapSuccess(Result$Wonderjs.bind(Tuple4$Wonderjs.collectResult(_computeMapScale(diffuseMapImageId), _computeMapScale(channelRoughnessMetallicMapImageId), _computeMapScale(emissionMapImageId), _computeMapScale(normalMapImageId)), (function (param) {
                                      return ListResult$Wonderjs.mergeResults({
                                                  ...
                                                  tl: {
                                                    ...
                                                    tl: {
                                                      ...
                                                      tl: {
                                                        hd: TypeArrayCPRepoUtils$Wonderjs.setFloat2(offset + 12 | 0, param[0], bufferData),
                                                        tl: {
                                                          hd: TypeArrayCPRepoUtils$Wonderjs.setFloat2(offset + 14 | 0, param[1], bufferData),
                                                          tl: {
                                                            hd: TypeArrayCPRepoUtils$Wonderjs.setFloat2(offset + 16 | 0, param[2], bufferData),
                                                            tl: {
                                                              hd: TypeArrayCPRepoUtils$Wonderjs.setFloat2(offset + 18 | 0, param[3], bufferData),
                                                              tl: /* [] */0
                                                            }
                                                          }
                                                        }
