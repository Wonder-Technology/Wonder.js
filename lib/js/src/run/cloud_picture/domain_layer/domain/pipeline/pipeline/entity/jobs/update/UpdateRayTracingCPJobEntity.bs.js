...
function create(param) {
  return JobEntity$Wonderjs.create("update_rayTracing");
}
...
function _updateSceneDescBufferData(param, allRenderGameObjects) {
  ...
  return Result$Wonderjs.mapSuccess(Result$Wonderjs.bind(ListSt$Wonderjs.traverseResultM(allRenderGameObjects, (function (gameObject) {
                ...
                return RayTracingPassCPRepo$Wonderjs.setSceneDescBufferData([
                            sceneDescBuffer,
                            sceneDescBufferSize,
                            sceneDescBufferData
                          ]);
...
function _updatePointIndexBufferData(param, allRenderGeometries) {
  ...
  return Result$Wonderjs.mapSuccess(Result$Wonderjs.bind(ListSt$Wonderjs.traverseResultM(allRenderGeometries, (function (geometry) {
                ...
                return RayTracingPassCPRepo$Wonderjs.setPointIndexBufferData([
                            pointIndexBuffer,
...
function _updateVertexBufferData(param) {
  ...
  return Result$Wonderjs.tap(Contract$Wonderjs.requireCheck((function (param) {
                ...
                return RayTracingPassCPRepo$Wonderjs.setVertexBufferData([
                            vertexBuffer,
                            vertexBufferSize,
                            vertexBufferData
                          ]);
...
function _updateIndexBufferData(param) {
  ...
  return RayTracingPassCPRepo$Wonderjs.setIndexBufferData([
              indexBuffer,
              param[1]
            ]);
}
...
function _updatePBRMaterialBufferData(param, allRenderPBRMaterials) {
  ...
  return Result$Wonderjs.mapSuccess(ListSt$Wonderjs.traverseReduceResultM(allRenderPBRMaterials, 0, (function (offset, pbrMaterial) {
                ...
                return RayTracingPassCPRepo$Wonderjs.setPBRMaterialBufferData([
                            pbrMaterialBuffer,
...
function _createAndAddRayTracingBindGroup(device, instanceContainer, param, param$1) {
  ...
  RayTracingPassCPRepo$Wonderjs.addStaticBindGroupData(0, Curry._2(DpContainer$Wonderjs.unsafeGetWebGPURayTracingDp(undefined).device.createRayTracingBindGroup, {
...
function _createAndSetPipeline(device, rtBindGroupLayout) {
  return Result$Wonderjs.mapSuccess(Tuple3$Wonderjs.collectOption(RayTracingPassCPRepo$Wonderjs.getShaderBindingTable(undefined), RayTracingPassCPRepo$Wonderjs.getCameraBindGroupLayout(undefined), RayTracingPassCPRepo$Wonderjs.getDirectionLightBindGroupLayout(undefined)), (function (param) {
                return RayTracingPassCPRepo$Wonderjs.setPipeline(Curry._2(DpContainer$Wonderjs.unsafeGetWebGPURayTracingDp(undefined).device.createRayTracingPipeline, {
...
function exec(param) {
  return Most.just(Result$Wonderjs.bind(Tuple2$Wonderjs.collectOption(WebGPUCPRepo$Wonderjs.getDevice(undefined), WebGPUCPRepo$Wonderjs.getQueue(undefined)), (function (param) {
                    ...
                    return Result$Wonderjs.bind(BuildAccerlerationContainerDoService$Wonderjs.buildContainers(device, param[1]), (function (instanceContainer) {
                                  return Result$Wonderjs.bind(Tuple5$Wonderjs.collectOption(RayTracingPassCPRepo$Wonderjs.getSceneDescBufferData(undefined), RayTracingPassCPRepo$Wonderjs.getPointIndexBufferData(undefined), RayTracingPassCPRepo$Wonderjs.getVertexBufferData(undefined), RayTracingPassCPRepo$Wonderjs.getIndexBufferData(undefined), RayTracingPassCPRepo$Wonderjs.getPBRMaterialBufferData(undefined)), (function (allBufferData) {
