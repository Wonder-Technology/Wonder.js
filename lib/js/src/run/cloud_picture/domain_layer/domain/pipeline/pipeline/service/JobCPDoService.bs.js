...
var UpdateTransformJobEntity$Wonderjs = require("../../../../../../../construct/domain_layer/domain/pipeline/pipeline/entity/jobs/UpdateTransformJobEntity.bs.js");
...
function _getUpdatePipelineJobs(param) {
  return {
          hd: [
            UpdateTransformJobEntity$Wonderjs.create(undefined),
            UpdateTransformJobEntity$Wonderjs.exec
          ],
          tl: {
            hd: [
