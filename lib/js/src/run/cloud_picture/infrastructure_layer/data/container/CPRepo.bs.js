...
function getExnBSDFMaterial(param) {
  var po = CPContainerManager$Wonderjs.getPO(undefined);
  return OptionSt$Wonderjs.getExn(po.bsdfMaterial);
}

function setBSDFMaterial(bsdfMaterial) {
  var po = CPContainerManager$Wonderjs.getPO(undefined);
  return CPContainerManager$Wonderjs.setPO({
              pipeline: po.pipeline,
              scene: po.scene,
...
exports.getExnBSDFMaterial = getExnBSDFMaterial;
exports.setBSDFMaterial = setBSDFMaterial;
