...
function getGameObject(transform) {
  return ImmutableSparseMap$Wonderjs.getNullable(CPRepo$Wonderjs.getExnTransform(undefined).gameObjectMap, transform);
}
...
function getParent(transform) {
  return ImmutableSparseMap$Wonderjs.getNullable(CPRepo$Wonderjs.getExnTransform(undefined).parentMap, transform);
}
...
function getChildren(transform) {
  return ImmutableSparseMap$Wonderjs.getNullable(CPRepo$Wonderjs.getExnTransform(undefined).childrenMap, transform);
}
...
function getIsDirty(transform) {
  return ImmutableSparseMap$Wonderjs.getNullable(CPRepo$Wonderjs.getExnTransform(undefined).dirtyMap, transform);
}
