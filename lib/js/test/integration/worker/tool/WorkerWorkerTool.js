...
function setFakeWorkersAndSetState(state) {
  ...
  return MainStateTool$Wonderjs.setState((newrecord[/* workerInstanceRecord */37] = WorkerInstanceMainWorkerTool$Wonderjs.setRenderWorker(state[/* workerInstanceRecord */37], Curry._1(createWorker, /* () */0)), newrecord));
}
