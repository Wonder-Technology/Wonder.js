...
var InitLightMaterialJobRenderWorkerTool$Wonderjs = require("./tool/InitLightMaterialJobRenderWorkerTool.js");

describe("test init light material render worker job", (function () {
        ...
        describe("test glsl", (function () {
                describe("test shader lib's glsl", (function () {
                        ...
                        describe("test normalMatrix instance shader libs", (function () {
                                ...
                                describe("else", (function () {
                                        return Wonder_jest.testPromise("if support hardware instance, use normalMatrix_hardware_instance shader lib", (function () {
                                                      var match = InitLightMaterialJobRenderWorkerTool$Wonderjs.prepareForJudgeGLSLNotExec(sandbox, state[0]);
                                                      var shaderSource = match[1];
                                                      var match$1 = InstanceTool$Wonderjs.addSourceInstance(match[2], match[0]);
                                                      InstanceRenderWorkerTool$Wonderjs.setGPUDetectDataAllowHardwareInstance(sandbox);
