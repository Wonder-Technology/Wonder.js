...
setStateFunc(runWithDefaultTimeFunc(unsafeGetStateFunc()));
                      ...
                      var _buildChunkData = function (arrayBuffer, $staropt$star, param) {
                      ...
                      var _buildReader = function (readStub) {
                        return {
                                read: readStub
                              };
                      };
                      var _getDefault11Image = function (param) {
                        return TextureTool$Wonderjs.buildSource(undefined, undefined, "default", /* () */0);
                      };
                      var _prepareWithReadStub = function (sandbox, readStub, state) {
                        var default11Image = _getDefault11Image(/* () */0);
                      ...
                      var _prepare = function (sandbox, wdbArrayBuffer, state) {
                        ...
                        var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(wdbArrayBuffer), undefined, /* () */0), Sinon.onCall(0, readStub))));
                      ...
                      Wonder_jest.describe("trigger handleWhenLoadingFunc", (function (param) {
                              var _prepare = function (sandbox, state) {
                                var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(boxTexturedWDBArrayBuffer[0].slice(1000)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(boxTexturedWDBArrayBuffer[0].slice(0, 1000)), undefined, /* () */0), Sinon.onCall(0, readStub))))));
                                return _prepareWithReadStub(sandbox, readStub$1, state);
                              };
                              return Wonder_jest.testPromise("trigger when load each chunk data", undefined, (function (param) {
                                            ...
                                            return LoadStreamWDBTool$Wonderjs.readWithHandleWhenLoadingFunc(/* tuple */[
                                                          ...
                                                          match[2],
                                                          match[3]
                                                        ], _buildReader(match[1])).then((function (param) {
                              ...
                              Wonder_jest.describe("test skybox and one gameObject with map(basic source texture) wdb", (function (param) {
                                      return Wonder_jest.describe("\n            load blob image;\n            set it to be source;\n            ", (function (param) {
                                                    ...
                                                    return Wonder_jest.describe("\n            chunk1: header + json + stream + stream_chunk1-stream_chunk4\n            chunk2: stream_chunk5->stream_chunk11 + a part of stream_chunk12(all are image chunks)\n            chunk3: other stream_chunk12(basic source texture image chunk)\n            done\n            ", (function (param) {
                                                                  var _prepare = function (sandbox, state) {
                                                                    var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                                    var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(skyboxWDBArrayBuffer[0].slice(2927)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1912, 2927)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(skyboxWDBArrayBuffer[0].slice(0, 1912)), undefined, /* () */0), Sinon.onCall(0, readStub))))))));
                                                                    return _prepareWithReadStub(sandbox, readStub$1, state);
                                                                  };
                                                                  return Wonder_jest.testPromise("test", undefined, (function (param) {
                                                                                var sandbox$1 = sandbox;
                              ...
                              Wonder_jest.describe("test CesiumMilkTruck wdb", (function (param) {
                                      ...
                                      Wonder_jest.describe("\n            1.chunk1: header + json + stream + stream_chunk1-stream_chunk4 + a part of stream_chunk5(image chunk)\n            2.chunk2: a part of stream_chunk5(image chunk)\n            3.chunk3: other stream_chunk5 + stream_chunk6 + a part of stream_chunk7\n            4.chunk4: other stream chunk data\n            5.done\n            ", (function (param) {
                                              ...
                                              Wonder_jest.describe("test 1,5", (function (param) {
                                                      var _prepare = function (sandbox, state) {
                                                        var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                        var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 32768)), undefined, /* () */0), Sinon.onCall(0, readStub))));
                                                        return _prepareWithReadStub(sandbox, readStub$1, state);
                                                      };
                                              ...
                                              Wonder_jest.describe("test 1,2,5", (function (param) {
                                                      var _prepare = function (sandbox, state) {
                                                        var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                        var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(32768, 40000)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 32768)), undefined, /* () */0), Sinon.onCall(0, readStub))))));
                                                        return _prepareWithReadStub(sandbox, readStub$1, state);
                                                      };
                                              ...
                                              Wonder_jest.describe("test 1,2,3,5", (function (param) {
                                                      var _prepare = function (sandbox, state) {
                                                        var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                        var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(40000, 470000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(32768, 40000)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 32768)), undefined, /* () */0), Sinon.onCall(0, readStub))))))));
                                                        return _prepareWithReadStub(sandbox, readStub$1, state);
                                                      };
                                                      Wonder_jest.testPromise("not set new geometry point data", undefined, (function (param) {
                                                              return _testSetGeometryPointData(sandbox, 2, _prepare, state);
                                              ...
                                              return Wonder_jest.describe("test 1,2,3,4,5", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(4, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(80000)), undefined, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(40000, 80000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(32768, 40000)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 32768)), undefined, /* () */0), Sinon.onCall(0, readStub))))))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                      ...
                                      return Wonder_jest.describe("\n            1.chunk1: header + a part of json\n            2.chunk2: other json + a part of stream\n            3.chunk3: other stream + a part of stream_chunk1\n            4.chunk4: other stream_chunk1 + stream_chunk2\n            5.chunk5: stream_chunk3-stream_chunk5 + a part of stream_chunk6\n            6.chunk6: other stream_chunk6 + stream_chunkk7-stream_chunk10 + a part of stream_chunk11\n            7.chunk7: other stream chunk data\n            8.done\n            ", (function (param) {
                                                    ...
                                                    Wonder_jest.describe("test 1,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                    ...
                                                    Wonder_jest.describe("test 1,2,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                            return Wonder_jest.testPromise("contract error", undefined, (function (param) {
                                                                          return _testContractError(sandbox, _prepare, state);
                                                    ...
                                                    Wonder_jest.describe("test 1,2,3,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1650, 3000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                    ...
                                                    Wonder_jest.describe("test 1,2,3,4,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(4, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(3000, 10000)), undefined, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1650, 3000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                            Wonder_jest.testPromise("not set geometry point data", undefined, (function (param) {
                                                                    return _testSetGeometryPointData(sandbox, 0, _prepare, state);
                                                    ...
                                                    Wonder_jest.describe("test 1,2,3,4,5,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(5, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(10000, 50000)), undefined, /* () */0), Sinon.onCall(4, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(3000, 10000)), undefined, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1650, 3000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))))))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                    ...
                                                    Wonder_jest.describe("test 1,2,3,4,5,6,8", (function (param) {
                                                            var _prepare = function (sandbox, state) {
                                                              var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                              var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(6, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(50000, 523828)), undefined, /* () */0), Sinon.onCall(5, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(10000, 50000)), undefined, /* () */0), Sinon.onCall(4, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(3000, 10000)), undefined, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1650, 3000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))))))))))));
                                                              return _prepareWithReadStub(sandbox, readStub$1, state);
                                                            };
                                                            return Wonder_jest.testPromise("set geometry point data", undefined, (function (param) {
                                                    ...
                                                    return Wonder_jest.describe("test 1,2,3,4,5,6,7,8", (function (param) {
                                                                  var _prepare = function (sandbox, state) {
                                                                    var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                                    var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(7, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(523828)), undefined, /* () */0), Sinon.onCall(6, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(50000, 523828)), undefined, /* () */0), Sinon.onCall(5, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(10000, 50000)), undefined, /* () */0), Sinon.onCall(4, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(3000, 10000)), undefined, /* () */0), Sinon.onCall(3, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(1650, 3000)), undefined, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(300, 1650)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(cesiumMilkTruckWDBArrayBuffer[0].slice(0, 300)), undefined, /* () */0), Sinon.onCall(0, readStub))))))))))))))));
                                                                    return _prepareWithReadStub(sandbox, readStub$1, state);
                                                                  };
                                                                  return Wonder_jest.testPromise("set geometry point data", undefined, (function (param) {
                                                                                return _testSetGeometryPointData(sandbox, 5, _prepare, state);
                              ...
                              return Wonder_jest.describe("test AlphaBlendModeTest wdb", (function (param) {
                                            return Wonder_jest.describe("\n            1.chunk1: header + json + stream + stream_chunk1-stream_chunk4 + a part of stream_chunk5(image chunk)\n            ...\n            2.done\n            ", (function (param) {
                                                          return Wonder_jest.describe("test 1,2", (function (param) {
                                                                        var _prepare = function (sandbox, state) {
                                                                          var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                                          var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(alphaBlendModeTestWDBArrayBuffer[0].slice(0, 65536)), undefined, /* () */0), Sinon.onCall(0, readStub))));
                                                                          return _prepareWithReadStub(sandbox, readStub$1, state);
                                                                        };
                                                                        return Wonder_jest.testPromise("set geometry point data", undefined, (function (param) {
                                                                                      var sandbox$1 = sandbox;
                      ...
                      Wonder_jest.describe("test imgui", (function (param) {
                              ...
                              return Wonder_jest.describe("\n            1.chunk1: header + json +  a part of first stream_chunk\n            2.chunk2: other stream chunk data\n            3.done\n            ", (function (param) {
                                            return Wonder_jest.describe("test 1,2,3", (function (param) {
                                                          var _prepare = function (sandbox, state) {
                                                            var readStub = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                                            var readStub$1 = Sinon.returns(_buildChunkData(undefined, true, /* () */0), Sinon.onCall(2, Sinon.returns(_buildChunkData(Caml_option.some(imguiWDBArrayBuffer[0].slice(800)), undefined, /* () */0), Sinon.onCall(1, Sinon.returns(_buildChunkData(Caml_option.some(imguiWDBArrayBuffer[0].slice(0, 800)), undefined, /* () */0), Sinon.onCall(0, readStub))))));
                                                            return _prepareWithReadStub(sandbox, readStub$1, state);
                                                          };
                      ...
                      return Wonder_jest.describe("if not support stream load", (function (param) {
                                    var _buildFakeFetchReturnResponse = function (contentLength, ok, arrayBuffer) {
                                      return Promise.resolve({
                                                  ok: true,
                                                  headers: {
