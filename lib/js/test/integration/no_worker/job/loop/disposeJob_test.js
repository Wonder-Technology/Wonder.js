                ...
                describe("dispose components", (function () {
                        describe("test disposeGameObjectBasicCameraViewComponent", (function () {
                                ...
                                return Wonder_jest.test("dispose data in dispose job", (function () {
                                              var match = _prepare(state);
                                              var match$1 = match[2];
                                              var state$1 = DisposeJob$Wonderjs.execJob(/* None */0, match[0]);
                        ...
                        describe("test disposeGameObjectPerspectiveCameraProjectionComponent", (function () {
                                var _prepare = function (state) {
                                  ...
                                  var gameObject1 = match[1];
                                  var match$1 = CameraTool$Wonderjs.createCameraGameObject(match[0]);
                                  var state$1 = GameObjectAPI$Wonderjs.disposeGameObject(gameObject1, match$1[0]);
                                  return /* tuple */[
                                          state$1,
                                          /* tuple */[
                                            gameObject1,
                        ...
                        describe("test disposeGameObjectTransformComponent", (function () {
                                ...
                                var _prepareForTestChildrenOrder = function (isKeepOrder, state) {
                                  ...
                                  var state$3 = DisposeJob$Wonderjs.execJob(/* None */0, state$2);
                                  return /* tuple */[
                                          state$3,
                                          parent
                                        ];
                                ...
                                describe("test not keep order", (function () {
                                        Wonder_jest.test("shouldn't dispose data", (function () {
                                                var match = _prepare(/* false */0, state);
                                        ...
                                        describe("test dispose job", (function () {
                                                ...
                                                return Wonder_jest.test("change its current parent's children order", (function () {
                                                              var match = _prepareForTestChildrenOrder(/* false */0, state);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.unsafeGetTransformChildren(match[1], match[0])), /* int array */[
                                                                          3,
                                                                          2
                                                                        ]);
                                                            }));
                                ...
                                describe("test keep order", (function () {
                                        Wonder_jest.test("shouldn't dispose data", (function () {
                                                var match = _prepare(/* true */1, state);
                                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.getTransformPosition(match[3][1], match[0])), /* tuple */[
                                                            3,
                                                            5,
                                                            7
                                        ...
                                        describe("test dispose job", (function () {
                                                ...
                                                return Wonder_jest.test("not change its current parent's children order", (function () {
                                                              var match = _prepareForTestChildrenOrder(/* true */1, state);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.unsafeGetTransformChildren(match[1], match[0])), /* int array */[
                                                                          2,
                                                                          3
                                                                        ]);
                                ...
                                describe("dispose data in dispose job", (function () {
                                        describe("dispose vbo buffer data", (function () {
                                                Wonder_jest.test("add buffer to pool", (function () {
                                                        ...
                                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                        SparseMapService$WonderCommonlib.has(geometry1, match$1[/* vertexArrayBufferPool */7]),
                                                                        SparseMapService$WonderCommonlib.has(geometry1, match$1[/* elementArrayBufferPool */8])
                                                                      ]), /* tuple */[
                                                                    /* true */1,
                                                                    /* true */1
                                                                  ]);
                                                ...
                                                return Wonder_jest.test("remove from buffer map", (function () {
                                                              ...
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                              ...
                                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* boxGeometryNormalBufferMap */1]),
                                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* boxGeometryElementArrayBufferMap */2])
                                                                            ]), /* tuple */[
                                                                          /* false */0,
                                                                          /* false */0,
                                                                          /* false */0
                                ...
                                describe("dispose data in dispose job", (function () {
                                        describe("dispose vbo buffer data", (function () {
                                                ...
                                                Wonder_jest.test("add buffer to pool", (function () {
                                                        ...
                                                        var match$1 = VboBufferTool$Wonderjs.getVboBufferRecord(state$1);
                                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                        SparseMapService$Wonderjs.length(match$1[/* vertexArrayBufferPool */7]),
                                                                        SparseMapService$Wonderjs.length(match$1[/* elementArrayBufferPool */8])
                                                                      ]), /* tuple */[
                                                                    2,
                                                                    1
                                                                  ]);
                                                ...
                                                return Wonder_jest.test("remove from buffer map", (function () {
                                                              ...
                                                              var match$1 = VboBufferTool$Wonderjs.getVboBufferRecord(state$1);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* customGeometryVertexBufferMap */3]),
                                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* customGeometryNormalBufferMap */4]),
                                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* customGeometryElementArrayBufferMap */5])
                                                                            ]), /* tuple */[
                                                                          /* false */0,
                                                                          /* false */0,
                                                                          /* false */0
                                ...
                                describe("dispose data in dispose job", (function () {
                                        describe("dispose vbo buffer data", (function () {
                                                ...
                                                Wonder_jest.test("add buffer to pool", (function () {
                                                        ...
                                                        var state$1 = DisposeJob$Wonderjs.execJob(/* None */0, match[0]);
                                                        var match$1 = VboBufferTool$Wonderjs.getVboBufferRecord(state$1);
                                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$Wonderjs.length(match$1[/* matrixInstanceBufferPool */9])), 1);
                                                      }));
                                                return Wonder_jest.test("remove from buffer map", (function () {
                                                              var match = _prepare(state);
                                                              var state$1 = DisposeJob$Wonderjs.execJob(/* None */0, match[0]);
                                                              var match$1 = VboBufferTool$Wonderjs.getVboBufferRecord(state$1);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$WonderCommonlib.has(match[2], match$1[/* matrixInstanceBufferMap */6])), /* false */0);
                                                            }));
                                              }));
                                        return /* () */0;
                                      }));
                ...
                describe("dispose gameObjects", (function () {
                        describe("test batchDisposeGameObject", (function () {
                                Wonder_jest.test("shouldn't dispose data", (function () {
                                        ...
                                        var state$1 = GameObjectAPI$Wonderjs.batchDisposeGameObject(/* int array */[
                                              match[1],
                                              match[2]
                                            ], match[0]);
                                ...
                                return Wonder_jest.test("dispose data in dispose job", (function () {
                                              ...
                                              var state$2 = DisposeJob$Wonderjs.execJob(/* None */0, state$1);
                        ...
                        describe("test disposeGameObjectKeepOrder", (function () {
                                ...
                                describe("dispose data in dispose job", (function () {
                                        ...
                                        return Wonder_jest.test("dispose data in dispose job that not change its current parent's children order", (function () {
                                                      ...
                                                      var state$2 = DisposeJob$Wonderjs.execJob(/* None */0, state$1);
                                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.unsafeGetTransformChildren(match$1[0], state$2)), /* int array */[
                                                                  match$1[2],
                                                                  match$1[3]
                                                                ]);
                                                    }));
        ...
        describe("clear all defer disposed data", (function () {
                describe("not dispose the same one again in the second job execution", (function () {
                        return Wonder_jest.test("test dispose box geometry component", (function () {
                                      ...
                                      var state$3 = DisposeJob$Wonderjs.execJob(/* None */0, match$2[0]);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                      match$2[2],
