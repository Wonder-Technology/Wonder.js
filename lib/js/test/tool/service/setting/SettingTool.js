...
function buildBufferConfigStr($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, $staropt$star$8, $staropt$star$9, _) {
  var customGeometryPointCount = $staropt$star !== undefined ? $staropt$star : 300;
  var customGeometryCount = $staropt$star$1 !== undefined ? $staropt$star$1 : 30;
  ...
  var textureCountPerMaterial = $staropt$star$5 !== undefined ? $staropt$star$5 : 3;
  var basicSourceTextureCount = $staropt$star$6 !== undefined ? $staropt$star$6 : 50;
  var arrayBufferViewSourceTextureCount = $staropt$star$7 !== undefined ? $staropt$star$7 : 50;
  var sourceInstanceCount = $staropt$star$8 !== undefined ? $staropt$star$8 : 2;
  var objectInstanceCountPerSourceInstance = $staropt$star$9 !== undefined ? $staropt$star$9 : 100;
...
function createStateAndSetToStateData($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, _) {
  ...
  var buffer = $staropt$star$5 !== undefined ? $staropt$star$5 : buildBufferConfigStr(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
...
function setBufferSize(state, $staropt$star, _) {
  var customGeometryPointCount = $staropt$star !== undefined ? $staropt$star : 100;
  var newrecord = Caml_array.caml_array_dup(state);
  var init = state[/* settingRecord */0];
