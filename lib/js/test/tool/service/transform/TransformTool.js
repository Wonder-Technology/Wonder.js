...
function update(transform, state) {
  UpdateTransformMainService$Wonderjs.update(transform, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}

function updateAndGetLocalToWorldMatrixTypeArray(transform, state) {
  return UpdateTransformMainService$Wonderjs.updateAndGetLocalToWorldMatrixTypeArray(transform, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
}
...
function updateAndGetNormalMatrixTypeArray(transform, state) {
  return UpdateTransformMainService$Wonderjs.updateAndGetNormalMatrixTypeArray(transform, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
}
...
function getTransformPositionTypeArray(transform, state) {
  return UpdateTransformMainService$Wonderjs.updateAndGetPositionTypeArray(transform, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
}
...
function setDefaultTypeArrData(count, state, param) {
  var match = RecordTransformMainService$Wonderjs._setDefaultTypeArrData(count, RecordTransformMainService$Wonderjs.getRecord(state)[/* defaultLocalToWorldMatrix */7], RecordTransformMainService$Wonderjs.getRecord(state)[/* defaultLocalPosition */8], /* tuple */[
        1,
        param[0],
        param[1]
      ]);
...
exports.setDefaultTypeArrData                          = setDefaultTypeArrData;
