...
function createStateWithoutMaterialData(state) {
  ...
  if (match) {
    ...
    newrecord[/* basicMaterialRecord */15] = /* record */[
      ...
      /* disposedIndexArray */init[/* disposedIndexArray */10],
    ...
    newrecord$1[/* basicMaterialRecord */15] = /* record */[
      ...
      /* textureCountMap */init$1[/* textureCountMap */6],
      /* defaultColor */init$1[/* defaultColor */7],
      /* gameObjectMap */init$1[/* gameObjectMap */8],
      /* groupCountMap */init$1[/* groupCountMap */9],
      /* disposedIndexArray */init$1[/* disposedIndexArray */10],
