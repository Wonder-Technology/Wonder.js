        ...
        describe("get worker detect data and set to main state data", (function () {
                return Wonder_jest.testPromise("test", (function () {
                              ...
                              return WorkerJobWorkerTool$Wonderjs.execRenderWorkerJob(GetWorkerDetectDataRenderWorkerJob$Wonderjs.execJob, (function (state) {
                                            return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](WorkerDetectRenderWorkerTool$Wonderjs.getRecord(state)[/* isUseWorker */0]), true));
                                          }), Js_primitive.some({
                                              data: {
                                                workerDetectData: {
                                                  isUseWorker: true
                ...
                return Wonder_jest.testPromise("test", (function () {
                              ...
                              return MainInitJobMainWorkerTool$Wonderjs.test(sandbox, WorkerInstanceMainWorkerTool$Wonderjs.unsafeGetRenderWorker, (function (postMessageToRenderWorker) {
                                            return Sinon.toCalledWith(/* array */[SendInitRenderDataWorkerTool$Wonderjs.buildInitRenderData(undefined, undefined, {
                                                              isUseWorker: false
                                                            }, undefined, undefined, undefined, /* () */0)], Wonder_jest.Expect[/* expect */0](postMessageToRenderWorker));
