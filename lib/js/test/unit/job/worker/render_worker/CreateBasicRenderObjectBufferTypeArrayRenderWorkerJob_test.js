...
describe("CreateBasicRenderObjectBufferTypeArrayRenderWorkerJob", (function () {
        ...
        describe("fix bug", (function () {
                return Wonder_jest.testPromise("renderRecord->basicRenderObjectRecord should be correct ", (function () {
                              var state = SettingTool$Wonderjs.createStateAndSetToStateData(/* None */0, /* None */0, /* None */0, /* None */0, /* Some */["true"], /* Some */[SettingTool$Wonderjs.buildBufferConfigStr(/* None */0, /* None */0, /* None */0, /* Some */[5], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* () */0)], /* () */0);
