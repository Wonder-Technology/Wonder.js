...
describe("DisposeVboRenderWorkerJob", (function () {
        ...
        describe("dispose vbo buffer data", (function () {
                var _prepare = function (state) {
                  ...
                  renderWorkerState[/* vboBufferRecord */21] = VboBufferTool$Wonderjs.addVboBufferToSourceInstanceBufferMapByRecord(sourceInstance4, VboBufferTool$Wonderjs.addVboBufferToCustomGeometryBufferMapByRecord(geometry3, VboBufferTool$Wonderjs.addVboBufferToBoxGeometryBufferMapByRecord(geometry2, VboBufferTool$Wonderjs.addVboBufferToBoxGeometryBufferMapByRecord(geometry1, renderWorkerState[/* vboBufferRecord */21]))));
                  return /* tuple */[
                          match$3[0],
                          /* tuple */[
                            match$2[0],
                ...
                Wonder_jest.testPromise("add buffer to pool", (function () {
                        ...
                        return Most.drain(DisposeVboRenderWorkerJob$Wonderjs.execJob(/* None */0, _buildData(match$1[0], match$1[1], match$1[2], match$1[3]), RenderWorkerStateTool$Wonderjs.getStateData(/* () */0))).then((function () {
                                      ...
                                      var match = renderWorkerState[/* vboBufferRecord */21];
                                      return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                          SparseMapService$Wonderjs.length(match[/* vertexArrayBufferPool */7]),
                                                          SparseMapService$Wonderjs.length(match[/* elementArrayBufferPool */8]),
                                                          SparseMapService$Wonderjs.length(match[/* matrixInstanceBufferPool */9])
                                                        ]), /* tuple */[
                                                      6,
                                                      3,
                                                      1
                ...
                return Wonder_jest.testPromise("remove from buffer map", (function () {
                              ...
                              return Most.drain(DisposeVboRenderWorkerJob$Wonderjs.execJob(/* None */0, _buildData(geometry1, geometry2, geometry3, sourceInstance4), RenderWorkerStateTool$Wonderjs.getStateData(/* () */0))).then((function () {
                                            var renderWorkerState = RenderWorkerStateTool$Wonderjs.unsafeGetState(/* () */0);
                                            var match = renderWorkerState[/* vboBufferRecord */21];
                                            var boxGeometryElementArrayBufferMap = match[/* boxGeometryElementArrayBufferMap */2];
                                            var boxGeometryNormalBufferMap = match[/* boxGeometryNormalBufferMap */1];
                                            ...
                                            return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                ...
                                                                SparseMapService$WonderCommonlib.has(geometry3, match[/* customGeometryVertexBufferMap */3]),
                                                                SparseMapService$WonderCommonlib.has(geometry3, match[/* customGeometryNormalBufferMap */4]),
                                                                SparseMapService$WonderCommonlib.has(geometry3, match[/* customGeometryElementArrayBufferMap */5]),
                                                                SparseMapService$WonderCommonlib.has(sourceInstance4, match[/* matrixInstanceBufferMap */6])
                                                              ]), /* tuple */[
                                                            /* false */0,
                                                            /* false */0,
                                                            /* false */0,
