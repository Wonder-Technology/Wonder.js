...
describe("GameObject", (function () {
        ...
        describe("test operate component", (function () {
                ...
                describe("test geometry component", (function () {
                        describe("unsafeGetCustomGeometryComponent", (function () {
                                return Wonder_jest.test("get last added geometry component", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectAPI$Wonderjs.unsafeGetGameObjectCustomGeometryComponent(gameObject, state$1)), customGeometry2);
                                            }));
                              }));
                        ...
                        describe("test custom geometry component", (function () {
                                describe("hasGameObjectCustomGeometryComponent", (function () {
                                        return Wonder_jest.test("has geometry component", (function () {
                                                      ...
                                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectAPI$Wonderjs.hasGameObjectCustomGeometryComponent(gameObject, state$1)), true);
                                                    }));
                                      }));
                                return /* () */0;
                              }));
                ...
                describe("test light component", (function () {
                        ...
                        describe("hasGameObjectAmbientLightComponent", (function () {
                                return Wonder_jest.test("has light component", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectAPI$Wonderjs.hasGameObjectAmbientLightComponent(gameObject, state$1)), true);
                                            }));
                              }));
                        return /* () */0;
                      }));
                ...
                describe("test reallocate gameObject", (function () {
                        describe("if have dispose too many gameObjects, reallocate gameObject", (function () {
                                ...
                                return Wonder_jest.test("update aliveUidArray", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](aliveUidArray), /* array */[gameObject3]);
                                            }));
                              }));
        ...
        describe("contract check: is alive", (function () {
                describe("if gameObject is disposed", (function () {
                        ...
                        Wonder_jest.test("unsafeGetCustomGeometryComponent should error", (function () {
                                return _testTwoParamFunc(GameObjectAPI$Wonderjs.unsafeGetGameObjectCustomGeometryComponent);
                              }));
