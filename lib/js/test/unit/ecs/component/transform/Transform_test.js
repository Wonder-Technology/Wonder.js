...
describe("Transform", (function () {
        ...
        describe("createTransform", (function () {
                ...
                return Wonder_jest.test("mark new transform dirty", (function () {
                              var match = TransformAPI$Wonderjs.createTransform(state[0]);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformTool$Wonderjs.isDirty(match[1], match[0])), /* true */1);
                            }));
              }));
        ...
        describe("setTransformParent", (function () {
                ...
                describe("if child already has parent", (function () {
                        ...
                        return Wonder_jest.test("change its current parent's children order", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.unsafeGetTransformChildren(parent, state$2)), /* int array */[
                                                  3,
                                                  2
                                                ]);
                                    }));
                ...
                describe("test cache", (function () {
                        ...
                        describe("test cache invalid", (function () {
                                ...
                                describe("test with parent", (function () {
                                        ...
                                        return Wonder_jest.test("invalid after change local position", (function () {
                                                      var match = _prepare(state);
                                                      var child = match[1][1];
        ...
        describe("dispose component", (function () {
                ...
                describe("if child is disposed", (function () {
                        Wonder_jest.test("should remove it from childMap", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.unsafeGetTransformChildren(transform1, state$2)), /* int array */[]);
                              }));
                ...
                describe("dispose map record", (function () {
                        Wonder_jest.test("remove from parentMap, childMap,  dirtyMap, gameObjectMap", (function () {
                                var match = GameObjectTool$Wonderjs.createGameObject(state[0]);
                                var transform1 = match[2];
                                var state$1 = GameObjectTool$Wonderjs.disposeGameObjectTransformComponent(match[1], transform1, /* false */0, match[0]);
                                var match$1 = TransformTool$Wonderjs.getRecord(state$1);
                                var parentMap = match$1[/* parentMap */9];
                                var childMap = match$1[/* childMap */10];
                                var gameObjectMap = match$1[/* gameObjectMap */11];
                                var dirtyMap = match$1[/* dirtyMap */12];
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                        ...
                        describe("test remove from type array", (function () {
                                describe("remove from localToWorldMatrices", (function () {
                                        var _prepare = function (state) {
                                          ...
                                          var state$3 = GameObjectTool$Wonderjs.disposeGameObjectTransformComponent(gameObject1, transform1, /* false */0, state$2);
                                          return /* tuple */[
                                                  state$3,
                                                  /* tuple */[
                                                    gameObject1,
                ...
                describe("contract check", (function () {
                        return Wonder_jest.test("expect dispose the alive component, but actual not", (function () {
                                      ...
                                      var transform1 = match[2];
                                      var gameObject1 = match[1];
                                      var state$1 = GameObjectTool$Wonderjs.disposeGameObjectTransformComponent(gameObject1, transform1, /* false */0, match[0]);
                                      return Wonder_jest.Expect[/* toThrowMessage */20]("expect dispose the alive component, but actual not", Wonder_jest.Expect[/* expect */0]((function () {
                                                        GameObjectTool$Wonderjs.disposeGameObjectTransformComponent(gameObject1, transform1, /* false */0, state$1);
                                                        return /* () */0;
                                                      })));
                                    }));
                      }));
