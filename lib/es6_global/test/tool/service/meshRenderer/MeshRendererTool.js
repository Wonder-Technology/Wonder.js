...
function getBasicMaterialRenderArray(state) {
  return RenderArrayMeshRendererService$Wonderjs.getBasicMaterialRenderArray(state[/* meshRendererRecord */24]);
}

function getLightMaterialRenderArray(state) {
  return RenderArrayMeshRendererService$Wonderjs.getLightMaterialRenderArray(state[/* meshRendererRecord */24]);
}
...
function getMeshRendererRecord(state) {
  return state[/* meshRendererRecord */24];
}
