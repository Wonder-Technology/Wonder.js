...
function buildFakeGl(sandbox) {
  return {
          ...
          getParameter: Curry._1(Sinon.createEmptyStub, sandbox[0]),
...
function setBufferSize(state, $staropt$star, _) {
  ...
  var newrecord = state.slice();
  var newrecord$1 = state[/* settingRecord */0].slice();
  var newrecord$2 = BufferSettingService$Wonderjs.unsafeGetBuffer(state[/* settingRecord */0]).slice();
  newrecord$1[/* buffer */2] = /* Some */[(newrecord$2[/* customGeometryPointCount */0] = customGeometryPointCount, newrecord$2)];
  newrecord[/* settingRecord */0] = newrecord$1;
  return newrecord;
}
