...
function getRecord(state) {
  return state[/* directionLightRecord */18];
}

function isAlive(light, state) {
  return DisposeDirectionLightService$Wonderjs.isAlive(light, state[/* directionLightRecord */18]);
}

function getColor(light, state) {
  return OperateDirectionLightService$Wonderjs.getColor(light, state[/* directionLightRecord */18]);
}

function getIntensity(light, state) {
  return OperateDirectionLightService$Wonderjs.getIntensity(light, state[/* directionLightRecord */18]);
}
