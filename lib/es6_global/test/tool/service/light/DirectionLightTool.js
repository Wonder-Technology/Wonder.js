...
function getRecord(state) {
  return state[/* directionLightRecord */20];
}

function isAlive(light, state) {
  return DisposeDirectionLightService$Wonderjs.isAlive(light, state[/* directionLightRecord */20]);
}

function getColor(light, state) {
  return OperateDirectionLightService$Wonderjs.getColor(light, state[/* directionLightRecord */20]);
}

function getIntensity(light, state) {
  return OperateDirectionLightService$Wonderjs.getIntensity(light, state[/* directionLightRecord */20]);
}
