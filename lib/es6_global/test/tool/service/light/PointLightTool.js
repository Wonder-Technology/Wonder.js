...
function getRecord(state) {
  return state[/* pointLightRecord */22];
}

function isAlive(light, state) {
  return DisposePointLightService$Wonderjs.isAlive(light, state[/* pointLightRecord */22]);
}

function getColor(light, state) {
  return OperatePointLightService$Wonderjs.getColor(light, state[/* pointLightRecord */22]);
}

function getIntensity(light, state) {
  return OperatePointLightService$Wonderjs.getIntensity(light, state[/* pointLightRecord */22]);
}

function getConstant(light, state) {
  return OperatePointLightService$Wonderjs.getConstant(light, state[/* pointLightRecord */22]);
}

function getLinear(light, state) {
  return OperatePointLightService$Wonderjs.getLinear(light, state[/* pointLightRecord */22]);
}

function getQuadratic(light, state) {
  return OperatePointLightService$Wonderjs.getQuadratic(light, state[/* pointLightRecord */22]);
}

function getRange(light, state) {
  return OperatePointLightService$Wonderjs.getRange(light, state[/* pointLightRecord */22]);
}
