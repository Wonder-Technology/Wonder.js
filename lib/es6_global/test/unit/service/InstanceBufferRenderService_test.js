...
describe("InstanceBufferRenderService", (function () {
        ...
        describe("getOrCreateMatrixFloat32Array", (function () {
                return Wonder_jest.test("test get typeArr from pool", (function () {
                              ...
                              TypeArrayPoolTool$Wonderjs.addFloat32TypeArrayToPool(typeArr1, 1000, TypeArrayPoolService$Wonderjs.getFloat32ArrayPoolMap(state[0][/* typeArrayPoolRecord */36]));
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              typeArr2,
                                              Caml_array.caml_array_get(TypeArrayPoolTool$Wonderjs.getFloat32ArrayPoolMap(state[0][/* typeArrayPoolRecord */36]), typeArr1.length).length
                                            ]), /* tuple */[
                                          typeArr1,
                                          0
                                        ]);
