...
describe("GetBoxGeometryIndicesRenderService", (function () {
        ...
        describe("getIndicesCount", (function () {
                return Wonder_jest.test("get indices count", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GeometryTool$Wonderjs.getIndicesCount(match[2], RenderStateTool$Wonderjs.createState(match[0]))), 36);
                            }));
              }));
        return /* () */0;
      }));
