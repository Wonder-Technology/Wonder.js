        ...
        describe("test sended init render data->isDebug", (function () {
                ...
                Wonder_jest.testPromise("test false", (function () {
                        ...
                        return MainInitJobMainWorkerTool$Wonderjs.test(sandbox, WorkerInstanceMainWorkerTool$Wonderjs.unsafeGetRenderWorker, (function (postMessageToRenderWorker) {
                                      return Sinon.toCalledWith(/* array */[SendInitRenderDataWorkerTool$Wonderjs.buildInitRenderData(/* Some */[false], /* None */0, /* None */0, /* None */0, /* None */0, /* () */0)], Wonder_jest.Expect[/* expect */0](postMessageToRenderWorker));
                ...
                return Wonder_jest.testPromise("test true", (function () {
                              ...
                              return MainInitJobMainWorkerTool$Wonderjs.test(sandbox, WorkerInstanceMainWorkerTool$Wonderjs.unsafeGetRenderWorker, (function (postMessageToRenderWorker) {
                                            return Sinon.toCalledWith(/* array */[SendInitRenderDataWorkerTool$Wonderjs.buildInitRenderData(/* Some */[true], /* None */0, /* None */0, /* None */0, /* None */0, /* () */0)], Wonder_jest.Expect[/* expect */0](postMessageToRenderWorker));
                                          }), MainInitJobMainWorkerTool$Wonderjs.prepare(/* () */0));
                            }));
              }));
        return /* () */0;
