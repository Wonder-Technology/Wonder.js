...
describe("CreateBasicRenderObjectBufferTypeArrayRenderWorkerJob", (function () {
        ...
        describe("fix bug", (function () {
                return Wonder_jest.testPromise("renderRecord->basicRenderObjectRecord should be correct ", (function () {
                              var state = SettingTool$Wonderjs.createStateAndSetToStateData(undefined, undefined, undefined, undefined, "true", SettingTool$Wonderjs.buildBufferConfigStr(undefined, undefined, undefined, 5, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0), /* () */0);
                              ...
                              return Most.drain(GetCameraDataMainWorkerJob$Wonderjs.execJob(undefined, MainStateTool$Wonderjs.getStateData(/* () */0)).concat(CreateBasicRenderObjectBufferMainWorkerJob$Wonderjs.execJob(undefined, MainStateTool$Wonderjs.getStateData(/* () */0)))).then((function () {
                                                              ...
                                                              data: {
                                                                renderData: {
                                                                  ...
                                                                  basic: {
                                                                    ...
                                                                    renderArray: match[/* renderArray */1],
