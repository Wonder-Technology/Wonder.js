...
describe("CreateWorkerInstanceMainWorkerJob", (function () {
        ...
        describe("create worker and set to state", (function () {
                return Wonder_jest.testPromise("create render worker", (function () {
                              ...
                              return Most.drain(CreateWorkerInstanceMainWorkerJob$Wonderjs.execJob(undefined, MainStateTool$Wonderjs.getStateData(/* () */0))).then((function () {
                                            var state = MainStateTool$Wonderjs.unsafeGetState(/* () */0);
                                            return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](WorkerInstanceMainWorkerTool$Wonderjs.unsafeGetRenderWorker(state).path), "" + (String(workerFileDir) + "wd.render.worker.js")));
                                          }));
                            }));
              }));
        return /* () */0;
