...
describe("test light", (function () {
        ...
        describe("fix bug", (function () {
                describe("test operate the light which is is-render", (function () {
                        return Wonder_jest.test("if the light exceed max count, should still work", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](DirectionLightAPI$Wonderjs.getDirectionLightColor(lightExceedMaxCount, state$1)), color);
                                    }));
                      }));
                return /* () */0;
              }));
