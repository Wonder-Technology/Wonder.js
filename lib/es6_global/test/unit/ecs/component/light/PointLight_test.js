...
describe("PointLight", (function () {
        ...
        describe("getPointLightColor", (function () {
                return Wonder_jest.test("test default color", (function () {
                              var match = PointLightAPI$Wonderjs.createPointLight(state[0]);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](PointLightAPI$Wonderjs.getPointLightColor(match[1], match[0])), /* float array */[
                                          1,
                                          1,
                                          1
                                        ]);
        ...
        describe("disposeComponent", (function () {
                describe("dispose data", (function () {
                        Wonder_jest.test("mark disposed", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](PointLightTool$Wonderjs.isAlive(light1, state$1)), /* false */0);
                              }));
                        Wonder_jest.test("remove from gameObjectMap", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$WonderCommonlib.has(light1, match$1[/* gameObjectMap */9])), /* false */0);
                              }));
                ...
                describe("contract check", (function () {
                        return Wonder_jest.test("count should <= max buffer count", (function () {
                                      return Wonder_jest.Expect[/* toThrowMessage */20]("light count: 5 <= max buffer count: 4", Wonder_jest.Expect[/* expect */0]((function () {
                                                        ...
                                                        var newrecord$1 = state[0][/* pointLightRecord */22].slice();
                                                        newrecord$1[/* index */0] = 5;
                                                        newrecord[/* pointLightRecord */22] = newrecord$1;
