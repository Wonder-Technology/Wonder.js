...
import * as DisposeJobTool$Wonderjs from "../../../../../integration/no_worker/job/loop/tool/DisposeJobTool.js";
...
Wonder_jest.describe("FlyCameraController", (function (param) {
        ...
        Wonder_jest.describe("dispose", (function (param) {
                ...
                return Wonder_jest.describe("dispose component's gameObject", (function (param) {
                              return Wonder_jest.test("should dispose component", (function (param) {
                                            var match = _prepareTwo(state);
                                            var state$1 = DisposeJobTool$Wonderjs.disposeAndReallocate(GameObjectTool$Wonderjs.disposeGameObject(match[1], match[0]));
                                            var match$1 = state$1[/* flyCameraControllerRecord */26];
                                            return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](MutableSparseMapService$WonderCommonlib.has(match[2], match$1[/* moveSpeedMap */7])), false);
                                          }));
                            }));
              }));
