...
describe("ArrayBufferViewTexture", (function () {
        ...
        describe("createArrayBufferViewSourceTexture", (function () {
                ...
                return Wonder_jest.test("shouldn't exceed buffer count", (function () {
                              var state = TestTool$Wonderjs.initWithoutBuildFakeDom(sandbox, undefined, SettingTool$Wonderjs.buildBufferConfigStr(undefined, undefined, undefined, undefined, undefined, undefined, undefined, 2, undefined, undefined, /* () */0), /* () */0);
