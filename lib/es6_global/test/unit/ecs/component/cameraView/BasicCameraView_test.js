        ...
        describe("dispose component", (function () {
                ...
                describe("dispose data", (function () {
                        return Wonder_jest.test("remove from gameObjectMap", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$WonderCommonlib.has(basicCameraView1, match$1[/* gameObjectMap */1])), /* false */0);
                                    }));
                      }));
