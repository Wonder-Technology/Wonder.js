...
describe("BoxGeometry", (function () {
        ...
        Wonder_jest.test("test texCoords", (function () {
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BoxGeometryAPI$Wonderjs.getBoxGeometryTexCoords(state[0])), BoxGeometryTool$Wonderjs.getDefaultTexCoords(/* () */0));
              }));
                ...
                describe("dispose geometry data", (function () {
                        ...
                        describe("test dispose not shared geometry", (function () {
                                ...
                                return Wonder_jest.test("remove from groupCountMap, gameObjectMap", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* groupCountMap */6]),
                                                              SparseMapService$WonderCommonlib.has(geometry1, match$1[/* gameObjectMap */5])
                                                            ]), /* tuple */[
                                                          false,
                                                          false
                                                        ]);
