...
describe("SourceInstance", (function () {
        ...
        describe("getSourceInstanceObjectInstanceTransformArray", (function () {
                return Wonder_jest.test("get objectInstance transform array", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SourceInstanceAPI$Wonderjs.getSourceInstanceObjectInstanceTransformArray(match$1[2], state$1)), /* int array */[GameObjectAPI$Wonderjs.unsafeGetGameObjectTransformComponent(match$1[3], state$1)]);
                            }));
              }));
        describe("getGameObject", (function () {
                return Wonder_jest.test("get component's gameObject", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SourceInstanceTool$Wonderjs.getGameObject(match[2], match[0])), /* Some */[match[1]]);
                            }));
              }));
        ...
        describe("dispose component", (function () {
                describe("dispose data", (function () {
                        Wonder_jest.test("add matrixFloat32ArrayMap->typeArray to pool", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$Wonderjs.length(Caml_array.caml_array_get(TypeArrayPoolTool$Wonderjs.getFloat32ArrayPoolMap(state$2[/* typeArrayPoolRecord */33]), typeArr.length))), 1);
                              }));
                        Wonder_jest.test("reset objectInstanceTransformIndexMap", (function () {
                                ...
                                var match$1 = SourceInstanceTool$Wonderjs.getRecord(state$1);
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](match$1[/* objectInstanceTransformIndexMap */1]), /* int array */[0]);
                              }));
                        Wonder_jest.test("remove from t32ArrayMap, matrixInstanceBufferCapacityMap, isTransforsformMatrixDataMap, gameObjectMap", (function () {
                                var match = SourceInstanceTool$Wonderjs.createSourceInstanceGameObject(state[0]);
                                var sourceInstance = match[2];
                        ...
                        describe("test remove from type array", (function () {
                                return Wonder_jest.test("delete and reset from isTransformStatics", (function () {
                                              ...
                                              var state$2 = GameObjectTool$Wonderjs.disposeGameObjectSourceInstanceComponent(match[1], sourceInstance, state$1);
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StaticTransformTool$Wonderjs.isTransformStatic(sourceInstance, state$2)), /* true */1);
                                            }));
                              }));
