                        ...
                        describe("test map shader lib's glsl", (function () {
                                describe("if has map, add basic_map shader lib", (function () {
                                        Wonder_jest.test("test vs glsl", (function () {
                                                var match = InitBasicMaterialJobTool$Wonderjs.prepareForJudgeGLSLWithMap(sandbox, state[0]);
                                        ...
                                        describe("test fs glsl", (function () {
                                                ...
                                                return Wonder_jest.test("should contain u_color only once", (function () {
                                                              var match = InitBasicMaterialJobTool$Wonderjs.prepareForJudgeGLSLWithMap(sandbox, state[0]);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GLSLTool$Wonderjs.containSpecifyCount(GLSLTool$Wonderjs.getFsSource(match[1]), "uniform vec3 u_color;", 1, /* () */0)), true);
                                                            }));
                                              }));
                                        return /* () */0;
                                      }));
