                                ...
                                describe("dispose data in dispose job", (function () {
                                        describe("dispose vbo buffer data", (function () {
                                                ...
                                                return Wonder_jest.test("remove from buffer map", (function () {
                                                              ...
                                                              var state$1 = DisposeJob$Wonderjs.execJob(/* None */0, match[0]);
                                                              var match$1 = VboBufferTool$Wonderjs.getVboBufferRecord(state$1);
                                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$WonderCommonlib.has(match[2], match$1[/* matrixInstanceBufferMap */8])), /* false */0);
                                                            }));
                                              }));
                                        return /* () */0;
                                      }));
