...
describe("test redo,undo geometry data", (function () {
        ...
        var _createGameObjectAndSetPointData = function (state) {
          ...
          var state$2 = GeometryAPI$Wonderjs.setGeometryIndices32(geometry, indices32_1, GeometryAPI$Wonderjs.setGeometryIndices(geometry, indices1, GeometryAPI$Wonderjs.setGeometryNormals(geometry, normals1, GeometryAPI$Wonderjs.setGeometryTexCoords(geometry, texCoords1, GeometryAPI$Wonderjs.setGeometryVertices(geometry, vertices1, state$1)))));
          return /* tuple */[
                  state$2,
                  gameObject,
                  geometry,
        ...
        var _prepare = function () {
          ...
          var currentState = GeometryAPI$Wonderjs.setGeometryIndices32(geometry2, indices32_2, GeometryAPI$Wonderjs.setGeometryIndices(geometry2, indices2, GeometryAPI$Wonderjs.setGeometryNormals(geometry3, normals2, GeometryAPI$Wonderjs.setGeometryTexCoords(geometry1, texCoords2, GeometryAPI$Wonderjs.setGeometryVertices(geometry2, vertices2, match$3[0])))));
          return /* tuple */[
                  /* tuple */[
                    currentState,
                    copiedState
        ...
        describe("deep copy geometry record", (function () {
                Wonder_jest.test("shadow copy nameMap", (function () {
                ...
                Wonder_jest.test("shadow copy indicesTypeMap", (function () {
                        return MainStateTool$Wonderjs.testShadowCopyArrayLikeMapData((function (state) {
                                      var match = GeometryTool$Wonderjs.getRecord(state);
                                      return /* array */[match[/* indicesTypeMap */17]];
                                    }), state[0]);
                      }));
                return Wonder_jest.test("deep copy gameObjectsMap", (function () {
                              ...
                              SparseMapService$WonderCommonlib.set(geometry1, originGameObjectsArr, match$1[/* gameObjectsMap */18]);
                              var copiedState = MainStateTool$Wonderjs.deepCopyForRestore(state$1);
                              var match$2 = GeometryTool$Wonderjs.getRecord(copiedState);
                              var arr = SparseMapService$WonderCommonlib.unsafeGet(geometry1, match$2[/* gameObjectsMap */18]);
                              arr[0] = 2;
                              var match$3 = GeometryTool$Wonderjs.getRecord(state$1);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$WonderCommonlib.unsafeGet(geometry1, match$3[/* gameObjectsMap */18])), copiedOriginGameObjectsArr);
                            }));
              }));
        describe("restore geometry record to target state", (function () {
                Wonder_jest.test("test restore point data typeArrays", (function () {
                ...
                Wonder_jest.test("test restore point info typeArrays", (function () {
                        var match = _prepare(/* () */0);
                        var match$1 = match[1];
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        ...
                                        GeometryAPI$Wonderjs.getGeometryIndices(geometry1, restoredState).length,
                ...
                Wonder_jest.test("test set point after restore", (function () {
                        var match = _prepare(/* () */0);
                ...
                Wonder_jest.test("test create geometry and set point after restore", (function () {
                        var match = _prepare(/* () */0);
                        var match$1 = match[0];
                        var restoredState = MainStateTool$Wonderjs.restore(match$1[0], match$1[1]);
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        ...
                                        GeometryAPI$Wonderjs.getGeometryIndices(geometry4, restoredState$1),
                ...
                describe("test reallocate geometry", (function () {
                        Wonder_jest.test("test restore after reallocate", (function () {
                                var match = _prepare(/* () */0);
                                var match$1 = match[2];
                                var match$2 = match[1];
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                ...
                                                GeometryAPI$Wonderjs.getGeometryIndices(geometry1, restoredState),
                        ...
                        return Wonder_jest.test("\n          1.create 3 geometrys g1,g2,g3;\n          2.set g1 points data p1;\n          3.copy state to copiedState1;\n          4.set g2,g3 points data p2;\n          5.dispose g1 with state;\n          6.reallocate geometry with state;\n          7.copy state to copiedState2;\n          8.restore state to copiedState1 to be restoreState1;\n          9.restore restoreState1 to copiedState2 to be restoreState2;\n\n          get g2,g3 points data with restoreState2 should be p2.\n          ", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                      ...
                                                      GeometryAPI$Wonderjs.getGeometryIndices(geometry2, restoredState2),
