...
describe("test redo,undo other data", (function () {
        ...
        var _prepareTypeArrayPoolData = function (state) {
          ...
          var newrecord = state.slice();
          return /* tuple */[
                  (newrecord[/* typeArrayPoolRecord */33] = /* record */[
        ...
        var _prepareVboBufferData = function (state) {
          ...
          var vertexArrayBufferPool = match[/* vertexArrayBufferPool */7];
          vertexArrayBufferPool.push(0);
          vertexArrayBufferPool.push(1);
          match[/* elementArrayBufferPool */8].push(2);
          match[/* matrixInstanceBufferPool */9].push(3);
          SparseMapService$WonderCommonlib.set(0, 10, match[/* boxGeometryVertexBufferMap */0]);
          SparseMapService$WonderCommonlib.set(0, 11, match[/* boxGeometryNormalBufferMap */1]);
          SparseMapService$WonderCommonlib.set(0, 12, match[/* boxGeometryElementArrayBufferMap */2]);
          SparseMapService$WonderCommonlib.set(0, 13, match[/* matrixInstanceBufferMap */6]);
          return /* tuple */[
                  state,
                  0,
                  /* tuple */[
        ...
        describe("deepCopyForRestore", (function () {
                ...
                describe("deep copy vbo buffer record", (function () {
                        return Wonder_jest.test("clear all buffer map and all buffer pool record", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                      ...
                                                      match$1[/* boxGeometryNormalBufferMap */1],
                                                      match$1[/* boxGeometryElementArrayBufferMap */2],
                                                      match$1[/* customGeometryVertexBufferMap */3],
                                                      match$1[/* customGeometryNormalBufferMap */4],
                                                      match$1[/* customGeometryElementArrayBufferMap */5],
                                                      match$1[/* matrixInstanceBufferMap */6],
                                                      match$1[/* vertexArrayBufferPool */7],
                                                      match$1[/* elementArrayBufferPool */8],
                                                      match$1[/* matrixInstanceBufferPool */9]
                                                    ]), /* tuple */[
                                                  /* array */[],
                                                  /* array */[],
                                                  /* array */[],
                ...
                describe("deep copy typeArrayPool record", (function () {
                        return Wonder_jest.test("clear pool map", (function () {
                                      ...
                                      var copiedState = MainStateTool$Wonderjs.deepCopyForRestore(match[0]);
                                      var match$1 = copiedState[/* typeArrayPoolRecord */33];
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
        ...
        describe("restore", (function () {
                ...
                describe("restore global temp record to target state", (function () {
                        return Wonder_jest.test("use current record->float16Array1", (function () {
                                      ...
                                      var record = currentState[/* globalTempRecord */32];
                                      record[/* float16Array1 */0] = new Float32Array(/* float array */[2]);
                                      MainStateTool$Wonderjs.restore(currentState, state$1);
                                      var match = MainStateTool$Wonderjs.unsafeGetState(/* () */0)[/* globalTempRecord */32];
                ...
                describe("restore vbo buffer record to target state", (function () {
                        Wonder_jest.test("clear buffer map record", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                ...
                                                match$2[/* boxGeometryNormalBufferMap */1],
                                                match$2[/* boxGeometryElementArrayBufferMap */2],
                                                match$2[/* customGeometryVertexBufferMap */3],
                                                match$2[/* customGeometryNormalBufferMap */4],
                                                match$2[/* customGeometryElementArrayBufferMap */5],
                                                match$2[/* matrixInstanceBufferMap */6]
                                              ]), /* tuple */[
                                            /* array */[],
                                            /* array */[],
                                            /* array */[],
                        ...
                        return Wonder_jest.test("add current state->vboBufferRecord->vertexBufferMap, normalBufferMap, elementArrayBufferMap, matrixInstanceBufferMap buffer to pool", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                      match$4[/* vertexArrayBufferPool */7],
                                                      match$4[/* elementArrayBufferPool */8],
                                                      match$4[/* matrixInstanceBufferPool */9]
                                                    ]), /* tuple */[
                                                  /* array */[
                                                    match$2[0],
                                                    match$2[1],
