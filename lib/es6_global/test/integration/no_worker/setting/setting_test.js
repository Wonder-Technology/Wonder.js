        ...
        describe("gpu config", (function () {
                ...
                describe("if pass gpu config", (function () {
                        return Wonder_jest.test("set to setting", (function () {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SettingTool$Wonderjs.unsafeGetGPU(state)), _buildExpectedGPUConfig(/* Some */[false], /* () */0));
                                    }));
                      }));
