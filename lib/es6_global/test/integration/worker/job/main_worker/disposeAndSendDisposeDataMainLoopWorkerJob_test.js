...
describe("test dispose and send dispose data main worker job", (function () {
        ...
        beforeEach((function () {
                ...
                state[0] = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[SettingTool$Wonderjs.buildBufferConfigStr(/* None */0, /* None */0, /* None */0, /* None */0, /* Some */[2], /* None */0, /* () */0)], /* () */0);
                return /* () */0;
              }));
        afterEach((function () {
                                                ...
                                                return Wonder_jest.testPromise("not add buffer to pool", (function () {
                                                              ...
                                                              return RenderJobsRenderWorkerTool$Wonderjs.initAndMainLoopAndRender((function () {
                                                                            ...
                                                                            return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                                                SparseMapService$WonderCommonlib.has(geometry1, match[/* vertexArrayBufferPool */7]),
                                                                                                SparseMapService$WonderCommonlib.has(geometry1, match[/* elementArrayBufferPool */8])
                                                                                              ]), /* tuple */[
                                                                                            /* false */0,
                                                                                            /* false */0
                                                                                          ]));
                                                ...
                                                return Wonder_jest.testPromise("not add typeArray to pool", (function () {
                                                              ...
                                                              return RenderJobsRenderWorkerTool$Wonderjs.initAndMainLoopAndRender((function () {
                                                                            ...
                                                                            return RenderJobsRenderWorkerTool$Wonderjs.mainLoopAndRender((function () {
                                                                                          var state = MainStateTool$Wonderjs.unsafeGetState(/* () */0);
                                                                                          return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](SparseMapService$Wonderjs.length(TypeArrayPoolTool$Wonderjs.getFloat32ArrayPoolMap(state[/* typeArrayPoolRecord */33]))), 0));
                                                                                        }), state$2, sandbox, /* None */0, /* () */0);
                                                                          }), state$2, sandbox, /* None */0, /* () */0);
                                                            }));
                                              }));
        ...
        describe("dispose gameObjects", (function () {
                describe("test disposeGameObject", (function () {
                        return Wonder_jest.testPromise("dispose data", (function () {
                                      ...
                                      var state$2 = FakeGlWorkerTool$Wonderjs.setFakeGl(FakeGlWorkerTool$Wonderjs.buildFakeGl(sandbox, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* () */0), state$1);
