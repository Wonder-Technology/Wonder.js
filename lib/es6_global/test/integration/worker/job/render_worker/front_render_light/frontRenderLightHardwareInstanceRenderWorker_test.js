...
describe("test front render light hardware instance in render worker", (function () {
        ...
        beforeEach((function () {
                ...
                state[0] = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, undefined, undefined, undefined, undefined, undefined, undefined, SettingTool$Wonderjs.buildBufferConfigStr(300, undefined, 500, undefined, 50, undefined, undefined, undefined, undefined, undefined, /* () */0), /* () */0);
                return /* () */0;
              }));
        afterEach((function () {
        ...
        describe("fix bug", (function () {
                describe("test create sourceInstance type arrays", (function () {
                        return Wonder_jest.testPromise("test objectInstanceTransformCollections->length", (function () {
                                      ...
                                      var state = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, undefined, undefined, undefined, undefined, undefined, undefined, SettingTool$Wonderjs.buildBufferConfigStr(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 2, 3, /* () */0), /* () */0);
                                      var match = FrontRenderLightHardwareInstanceRenderWorkerTool$Wonderjs.prepare(sandbox, state);
