...
describe("test front render light hardware instance in render worker", (function () {
        ...
        beforeEach((function () {
                ...
                state[0] = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[SettingTool$Wonderjs.buildBufferConfigStr(/* Some */[300], /* None */0, /* Some */[500], /* None */0, /* Some */[50], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* () */0)], /* () */0);
                return /* () */0;
              }));
        afterEach((function () {
        ...
        describe("fix bug", (function () {
                describe("test create sourceInstance type arrays", (function () {
                        return Wonder_jest.testPromise("test objectInstanceTransformCollections->length", (function () {
                                      ...
                                      var state = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[SettingTool$Wonderjs.buildBufferConfigStr(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[2], /* Some */[3], /* () */0)], /* () */0);
                                      var match = FrontRenderLightHardwareInstanceRenderWorkerTool$Wonderjs.prepare(sandbox, state);
