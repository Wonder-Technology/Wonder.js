...
describe("test init geometry render worker job", (function () {
        ...
        describe("test send init data to render worker", (function () {
                return Wonder_jest.testPromise("send indicesTypeMap", (function () {
                              ...
                              return MainInitJobMainWorkerTool$Wonderjs.test(sandbox, WorkerInstanceMainWorkerTool$Wonderjs.unsafeGetRenderWorker, (function (postMessageToRenderWorker) {
                                            return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](Sinon.getCallCount(Sinon.withOneArg(SendInitRenderDataWorkerTool$Wonderjs.buildInitRenderData(undefined, undefined, undefined, undefined, undefined, undefined, undefined, {
        ...
        describe("test render worker job", (function () {
                return Wonder_jest.testPromise("get indicesTypeMap", (function () {
                              ...
                              return RenderJobsRenderWorkerTool$Wonderjs.init((function () {
                                            ...
                                            return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](match[/* indicesTypeMap */9]), indicesTypeMapInMainState));
                                          }), state$2);
                            }));
              }));
        return /* () */0;
