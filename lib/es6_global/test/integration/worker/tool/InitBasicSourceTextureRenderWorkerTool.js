...
function prepareState(sandbox, param) {
  ...
  SettingWorkerTool$Wonderjs.buildFakeCanvasForNotPassCanvasIdWithCanvas(sandbox, _buildFakeCanvas(sandbox, context));
  var state = TestMainWorkerTool$Wonderjs.initWithJobConfig(sandbox, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[WorkerJobTool$Wonderjs.buildWorkerJobConfig(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* () */0)], /* None */0, /* None */0, /* () */0);
  return /* tuple */[
          state,
          context
        ];
