...
function getOrCreateMatrixFloat32Array(sourceInstance, defaultCapacity, param, state) {
  ...
  if (match) {
    ...
    if (match$1) {
      ...
      SparseMapSystem$WonderCommonlib.set(sourceInstance, typeArr, matrixFloat32ArrayMap);
      return typeArr;
    }
  }
}
...
function setCapacityAndUpdateBufferTypeArray(param, param$1, param$2, state) {
  ...
  if (needIncreaseCapacity) {
    ...
    SparseMapSystem$WonderCommonlib.set(sourceInstance, matrixFloat32Array, param$2[1]);
    return /* tuple */[
            buffer$1,
            matrixFloat32Array
          ];
