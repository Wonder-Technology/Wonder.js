...
function _sendAttributeData(gl, shaderIndex, geometryIndex, state) {
  ...
  return ArraySystem$Wonderjs.reduceState((function (state, param) {
              ...
              }), state, GLSLSenderConfigDataHandleSystem$Wonderjs.getAttributeSendData(shaderIndex, state));
}
...
function _sendUniformNoCacheData(gl, shaderIndex, transformIndex, state) {
  return ArraySystem$Wonderjs.reduceState((function (state, param) {
                ...
                return state;
              }), state, GLSLSenderConfigDataHandleSystem$Wonderjs.getUniformSendNoCachableData(shaderIndex, state));
}
...
function _sendUniformCachableData(gl, shaderIndex, materialIndex, state) {
  return ArraySystem$Wonderjs.reduceState((function (state, param) {
                ...
                return state;
              }), state, GLSLSenderConfigDataHandleSystem$Wonderjs.getUniformSendCachableData(shaderIndex, state));
}
