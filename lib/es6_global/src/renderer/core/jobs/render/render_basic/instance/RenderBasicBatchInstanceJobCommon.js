...
function render(gl, uid, state) {
  ...
  var state$1 = match[0];
  var instanceUniformSendNoCacheableData = GLSLSenderConfigDataHandleSystem$Wonderjs.getInstanceUniformSendNoCacheableData(match[1], state$1);
  ...
  return ArraySystem$Wonderjs.reduceState((function (state, uid) {
                var state$1 = ArraySystem$Wonderjs.reduceState((function (state, param) {
                        param[/* sendNoCacheableDataFunc */2](gl, param[/* pos */0], param[/* getNoCacheableDataFunc */1](GameObjectAdmin$Wonderjs.unsafeGetTransformComponent(uid, state), state));
                        return state;
                      }), state, instanceUniformSendNoCacheableData);
                GLSLSenderDrawUtils$Wonderjs.drawElement(drawMode, indexType, indexTypeSize, indicesCount, gl);
                return state$1;
