...
function getCanvas(state) {
  return Js_option.getExn(state[/* viewData */9][/* canvas */0]);
}

function setCanvas(canvas, state) {
  var newrecord = state.slice();
  var init = state[/* viewData */9];
  newrecord[/* viewData */9] = /* record */[
    /* canvas : Some */[canvas],
...
function getContextConfig(state) {
  return Js_option.getExn(state[/* viewData */9][/* contextConfig */1]);
}
