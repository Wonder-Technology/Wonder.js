...
function detect(gl, state) {
  ...
  newrecord[/* gpuDetectData */6] = _detectPrecision(gl, _detectExtension(gl, GPUStateUtils$Wonderjs.getGpuDetectData(state)));
  return newrecord;
}

var hasExtension = Js_option.isSome;

function unsafeGetInstanceExtension(state) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("extensionInstancedArrays exist", "not"), (function () {
                        return Contract$WonderLog.assertExist(GPUStateUtils$Wonderjs.getGpuDetectData(state)[/* extensionInstancedArrays */0]);
                      }));
        }), StateData$Wonderjs.stateData[/* isDebug */1]);
  return Js_option.getExn(GPUStateUtils$Wonderjs.getGpuDetectData(state)[/* extensionInstancedArrays */0]);
}
