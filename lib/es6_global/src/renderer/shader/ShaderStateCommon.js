...
function getIntersectShaderIndexDataArray(currentState, targetState) {
  var match = currentState[/* shaderData */18];
  var currentShaderIndexMap = match[/* shaderIndexMap */1];
  var match$1 = targetState[/* shaderData */18];
...
function restore(currentState, targetState) {
  Contract$WonderLog.requireCheck((function () {
          var currentPrecision = currentState[/* shaderData */18][/* glslData */2][/* precision */0];
          var targetPrecision = targetState[/* shaderData */18][/* glslData */2][/* precision */0];
  ...
  var match = currentState[/* shaderData */18];
  var currentShaderIndexMap = match[/* shaderIndexMap */1];
  var targetShaderData = targetState[/* shaderData */18];
