...
function _checkShouldNotAddBefore(shaderIndex, state) {
  return Contract$WonderLog.requireCheck((function () {
                return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("not be added before", "be"), (function () {
                              return Contract$WonderLog.assertNotExist(SparseMapSystem$WonderCommonlib.get(shaderIndex, GLSLSenderStateUtils$Wonderjs.getGLSLSenderData(state)[/* uniformSendNoCachableDataMap */3]));
                            }));
...
var unsafeGetUniformSendNoCachableData = GLSLSenderConfigDataHandleUniformNoCacheCommon$Wonderjs.unsafeGetUniformSendData;

var unsafeGetUniformSendCachableData = GLSLSenderConfigDataHandleUniformCacheCommon$Wonderjs.unsafeGetUniformSendData;

var unsafeGetShaderUniformSendNoCachableData = GLSLSenderConfigDataHandleUniformShaderCommon$Wonderjs.unsafeGetUniformSendData;

var unsafeGetInstanceUniformSendNoCachableData = GLSLSenderConfigDataHandleUniformInstanceCommon$Wonderjs.unsafeGetUniformSendData;
