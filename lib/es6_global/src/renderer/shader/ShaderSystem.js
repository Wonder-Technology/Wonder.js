...
function _init(gl, materialIndex, shaderLibDataArr, buildGLSLSource, state) {
  ...
  if (match) {
    ...
    GLSLSenderConfigDataHandleSystem$Wonderjs.addUniformSendData(gl, shaderIndex, program, shaderLibDataArr, GLSLSenderConfigDataHandleSystem$Wonderjs.addAttributeSendData(gl, shaderIndex, program, shaderLibDataArr, state$1));
    return shaderIndex;
  }
}
