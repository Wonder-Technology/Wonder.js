...
function convertShadersToRecord(shaders) {
  ...
  return /* record */[
          /* static_branchs */Json_decode.field("static_branchs", (function (json) {
                  return Json_decode.array((function (json) {
                                return /* record */[
                                        /* name */Json_decode.field("name", Json_decode.string, json),
          ...
          /* groups */Json_decode.field("groups", (function (json) {
                  return Json_decode.array((function (json) {
                                return /* record */[
                                        /* name */Json_decode.field("name", Json_decode.string, json),
                                        /* value */Json_decode.field("value", (function (param) {
...
function convertShaderLibsToRecord(shader_libs) {
  return Json_decode.array((function (json) {
                return /* record */[
                        /* name */Json_decode.field("name", Json_decode.string, json),
                        /* glsls */Json_decode.optional((function (param) {
                        ...
                        /* variables */Json_decode.optional((function (param) {
