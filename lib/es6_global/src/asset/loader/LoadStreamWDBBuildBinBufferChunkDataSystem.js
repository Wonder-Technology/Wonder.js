...
function _loadBlobImageFromImageArrayBufferData(loadedStreamChunkDataArr, loadBlobImageMap) {
  ...
  return Most.drain(Most.concatMap((function (param) {
                      ...
                      if (type_ >= 4) {
                        ...
                        var match$1 = SparseMapService$WonderCommonlib.get(imageIndex, loadBlobImageMap);
                        if (match$1 !== undefined) {
                          ArrayService$Wonderjs.push(/* record */[
                                /* geometryData */undefined,
                                /* imageData *//* record */[
                                  /* imageIndex */imageIndex,
                                  /* image */Js_primitive.valFromOption(match$1)
                                ],
                                /* type_ */type_
                          ...
                          return Most.map((function () {
                                        return /* () */0;
                                            ...
                                            SparseMapService$WonderCommonlib.set(imageIndex, image, loadBlobImageMap);
                                            return /* () */0;
                                          }), AssembleUtils$Wonderjs.buildLoadImageStream(match[/* arrayBuffer */3], match[/* mimeType */2], "load image error. imageIndex: " + (String(imageIndex) + ""))));
                        }
                      } else {
                        ArrayService$Wonderjs.push(/* record */[
                    ...
                    }), Most.from(loadedStreamChunkDataArr))).then((function () {
