...
function checkByteLengthShouldBeAligned(byteLength) {
  return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("byteLength:" + (String(byteLength) + " aligned with multiple of 4"), "is " + (String(byteLength) + "")), (function () {
...
function getGLBChunkHeaderByteLength() {
  return 8;
}
