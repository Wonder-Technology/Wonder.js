...
function _buildLightMaterialData(lightMaterialDataMap, imageUint8ArrayDataMap, param, getResultUint8ArrayDataFunc, state) {
...
function build(basicMaterialDataMap, lightMaterialDataMap, imageUint8ArrayDataMap, param, getResultUint8ArrayDataFunc, state) {
  ...
  var match$1 = match[2];
  var match$2 = match[0];
  var basicMaterialDataArr = SparseMapService$Wonderjs.reduceValid((function (basicMaterialDataArr, param) {
