...
function generateGLBData(rootGameObject, imageUint8ArrayDataMap, param, state) {
  var match = GetNodeDataSystem$Wonderjs.getAllNodeData(rootGameObject, param[0], state);
  var match$1 = match[1];
  var state$1 = match[0];
  ...
  var match$5 = BuildMaterialDataSystem$Wonderjs.build(match$1[2], match$1[3], imageUint8ArrayDataMap, /* tuple */[
        totalByteLength,
        totalByteLength,
        match$4[0]
      ], param[1], state$1);
