...
function generateGLBData(rootGameObject, imageBase64Map, state) {
  ...
  var arcballCameraControllerDataArr = BuildCameraControllerDataSystem$Wonderjs.build(match$1[3], state$1);
  var lightDataArr = BuildLightDataSystem$Wonderjs.build(match$1[4], state$1);
