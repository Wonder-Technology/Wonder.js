...
function buildBasicCameraViewData(cameraDataMap, state) {
  ...
  return Contract$WonderLog.ensureCheck((function (cameraDataArr) {
                return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("has at most one active", "not"), (function () {
                              return Contract$WonderLog.Operators[/* <= */11](cameraDataArr.filter((function (param) {
                                                return param[/* isActive */0] === true;
                                              })).length, 1);
                            }));
              }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData), SparseMapService$Wonderjs.reduceValid((function (cameraDataArr, basicCameraView) {
