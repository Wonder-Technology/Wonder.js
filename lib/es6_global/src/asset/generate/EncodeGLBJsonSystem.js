...
function _encodeNodeExtras(extras, list) {
  if (extras !== undefined) {
    ...
    var extraList$4 = isRoot !== undefined ? /* :: */[
        /* tuple */[
          "isRoot",
          isRoot
        ],
    ...
    return /* :: */[
            /* tuple */[
              "extras",
              Json_encode$WonderBsJson.object_(extraList$4)
            ],
            list
          ];
  } else {
...
function _encodeExtras(basicCameraViewDataArr, meshRendererDataArr, basicMaterialDataArr, arcballCameraControllerDataArr) {
  return /* tuple */[
          "extras",
          Json_encode$WonderBsJson.object_(_encodeArcballCameraControllerExtra(arcballCameraControllerDataArr, _encodeBasicMaterialExtra(basicMaterialDataArr, _encodeMeshRendererExtra(meshRendererDataArr, _encodeBasicCameraViewExtra(basicCameraViewDataArr, /* [] */0)))))
        ];
}
