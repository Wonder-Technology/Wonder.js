...
function _encodeNodeMaterial(material, extraList) {
...
function _encodeNodeExtras(extras, list) {
  if (extras !== undefined) {
    var match = extras;
    var extraList = _encodeNodeMaterial(match[/* material */0], /* [] */0);
    var extraList$1 = _encodeNodeCameraController(match[/* cameraController */1], extraList);
    return /* :: */[
            /* tuple */[
              "extras",
...
function _encodeExtras(arcballCameraControllerDataArr) {
  ...
  return /* tuple */[
          "extras",
          Json_encode$WonderBsJson.object_(match !== 0 ? /* :: */[
                  /* tuple */[
...
function _encodeScenes(extensionsUsedArr, lightDataArr, imguiData, _) {
  ...
  if (exit === 1) {
    list$2 = Log$WonderLog.fatal(Log$WonderLog.buildFatalMessage("_encodeScenes", "imguiData error", "", "", ""));
  }
  return /* tuple */[
          "scenes",
