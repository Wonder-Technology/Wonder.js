...
function _encodeExtras(basicCameraViewDataArr, meshRendererDataArr, basicMaterialDataArr, arcballCameraControllerDataArr) {
  ...
  return /* tuple */[
          "extras",
          Json_encode$WonderBsJson.object_(extrasList$3)
        ];
}
...
function _encodeSceneExtras(imguiData) {
  ...
  if (exit === 1) {
    extrasList = Log$WonderLog.fatal(Log$WonderLog.buildFatalMessage("_encodeScenes", "imguiData error", "", "", ""));
  }
  return /* :: */[
          /* tuple */[
            "extras",
            Json_encode$WonderBsJson.object_(extrasList)
          ],
          /* [] */0
        ];
}
