...
function generateGLBData(rootGameObject, imageUint8ArrayMap, state) {
  return GenerateGLBSystem$Wonderjs.generateGLBData(rootGameObject, imageUint8ArrayMap, /* tuple */[
              /* tuple */[
                VerticesGeometryMainService$Wonderjs.getVertices,
                NormalsGeometryMainService$Wonderjs.getNormals,
                TexCoordsGeometryMainService$Wonderjs.getTexCoords,
...
function generateWDB(rootGameObject, imageUint8ArrayMap, state) {
  return GenerateWDBSystem$Wonderjs.generateWDB(rootGameObject, imageUint8ArrayMap, /* tuple */[
              /* tuple */[
                VerticesGeometryMainService$Wonderjs.getVertices,
                NormalsGeometryMainService$Wonderjs.getNormals,
                TexCoordsGeometryMainService$Wonderjs.getTexCoords,
