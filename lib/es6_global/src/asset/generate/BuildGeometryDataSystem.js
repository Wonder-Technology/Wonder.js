...
function _getComponentType(pointType) {
  if (pointType !== 3) {
    if (pointType >= 4) {
      return 5125;
    } else {
...
function _addIndex16And32Data(param, param$1, param$2) {
  ...
  if (indices !== undefined) {
    return _addIndex16Data(/* tuple */[
                ...
                Js_primitive.valFromOption(indices),
                indicesSize
              ], /* tuple */[
                indexDataArr,
                index32DataArr
...
function build(meshPointAndNameDataMap) {
  ...
  var match = MutableSparseMapService$WonderCommonlib.reduceiValid((function (param, param$1, _) {
          var match = param$1[0];
