...
function _getNodeData(state, param, param$1, param$2, param$3, getPointsDataFuncTuple) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (param, transform) {
                ...
                var gameObjectChildrenMap$1 = match$3 !== 0 ? SparseMapService$WonderCommonlib.set(gameObject, childrenGameObjectArr, gameObjectChildrenMap) : gameObjectChildrenMap;
                var gameObjectNodeIndexMap = SparseMapService$WonderCommonlib.set(gameObject, nodeIndex, match$1[4]);
                var match$4 = GetNodeComponentDataSystem$Wonderjs.getComponentData(/* tuple */[
                      gameObject,
                      state,
                      /* tuple */[
                        match$2[1],
