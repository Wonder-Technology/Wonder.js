...
function getComponentData(param) {
  ...
  var arcballCameraControllerDataMap$1 = arcballCameraControllerIndex !== undefined ? SparseMapService$WonderCommonlib.set(arcballCameraControllerIndex, OptionService$Wonderjs.unsafeGet(match$8[1]), arcballCameraControllerDataMap) : arcballCameraControllerDataMap;
  var match$9 = _getLightData(/* tuple */[
        gameObject,
        match$3[4]
      ], state);
  var lightIndex = match$9[0];
  var lightDataMap$1 = lightIndex !== undefined ? SparseMapService$WonderCommonlib.set(lightIndex, OptionService$Wonderjs.unsafeGet(match$9[1]), lightDataMap) : lightDataMap;
  return /* tuple */[
          state,
          /* tuple */[
            meshIndex,
