...
function build(wd, param) {
  ...
  if (match !== 1) {
    ...
    var state$2 = IsRootGameObjectMainService$Wonderjs.setIsRoot(gameObject, scene[/* isRoot */4], state$1);
    ...
    var state$3 = match$3 ? state : IsRootGameObjectMainService$Wonderjs.setIsRoot(rootGameObject, scene[/* isRoot */4], state);
    return /* tuple */[
            state$3,
            rootGameObject
          ];
