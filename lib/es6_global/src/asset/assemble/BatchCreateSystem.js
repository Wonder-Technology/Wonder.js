...
function _batchCreateTransform(param, state) {
  return _batchCreateComponent(param[/* transforms */16], CreateTransformMainService$Wonderjs.create, state);
}
...
function _batchCreateMeshRenderer(param, state) {
  return _batchCreateComponent(param[/* meshRenderers */18], CreateMeshRendererMainService$Wonderjs.create, state);
}
...
function _createFlyCameraControllerOneByOne(param, state) {
  return _batchCreateComponent(param[/* flyCameraControllers */14], CreateFlyCameraControllerMainService$Wonderjs.create, state);
}

function _createArcballCameraControllerOneByOne(param, state) {
  return _batchCreateComponent(param[/* arcballCameraControllers */15], CreateArcballCameraControllerMainService$Wonderjs.create, state);
}

function _batchCreateScript(param, state) {
  return _batchCreateComponent(param[/* scripts */21], CreateScriptMainService$Wonderjs.create, state);
}

function _batchCreateBasicMaterial(param, state) {
  return _batchCreateComponent(param[/* basicMaterials */19], CreateBasicMaterialMainService$Wonderjs.create, state);
}

function _batchCreateLightMaterial(param, state) {
  return _batchCreateComponent(param[/* lightMaterials */20], CreateLightMaterialMainService$Wonderjs.create, state);
}
...
function batchCreate(isRenderLight, wd, state) {
  ...
  var match$11 = _batchCreateDirectionLight(isRenderLight, wd, match$10[0]);
  var match$12 = _batchCreatePointLight(isRenderLight, wd, match$11[0]);
  var match$13 = _batchCreateScript(wd, match$12[0]);
  return /* tuple */[
          match$13[0],
          match[1],
          /* tuple */[
