...
function _batchCreateGameObject(param, state) {
  ...
  var aliveUidArray = gameObjectRecord[/* aliveUidArray */23];
  ...
  newrecord$1[/* aliveUidArray */23] = aliveUidArray.concat(uidArr);
...
function _batchCreateBasicSourceTextureArr(param, state) {
  ...
  var match = ArrayService$Wonderjs.reduceOneParamValidi((function (param, param$1, basicSourceTextureIndex) {
          var indexArr = param[1];
