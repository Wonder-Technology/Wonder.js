...
function _batchCreateBasicSourceTextureArr(param, state) {
  ...
  var newIndex = index + param[/* basicSourceTextures */5][/* count */0] | 0;
  var indexArr = _checkNotExceedMaxCountByIndex(BufferSettingService$Wonderjs.getLightMaterialCount(state[/* settingRecord */0]), ArrayService$Wonderjs.range(index, newIndex - 1 | 0).map(IndexSourceTextureMainService$Wonderjs.generateBasicSourceTextureIndex));
  var notFlipY = BufferSourceTextureService$Wonderjs.getFlipYTypeArrayValue(false);
  state[/* basicSourceTextureRecord */18] = /* Some */[/* record */[
      ...
      /* flipYs */ArrayService$WonderCommonlib.reduceOneParam((function (flipYs, index) {
              return OperateTypeArrayBasicSourceTextureService$Wonderjs.setFlipY(index, notFlipY, flipYs);
            }), basicSourceTextureRecord[/* flipYs */8], indexArr),
...
function batchCreate(wdRecord, state) {
  ...
  var match$3 = _batchCreateBasicCameraView(wdRecord, match$2[0]);
  var match$4 = _batchCreatePerspectiveCameraProjection(wdRecord, match$3[0]);
  var match$5 = _batchCreateLightMaterial(wdRecord, match$4[0]);
  var match$6 = _batchCreateBasicSourceTextureArr(wdRecord, match$5[0]);
  var match$7 = _batchCreateDirectionLightArr(wdRecord, match$6[0]);
  var match$8 = _batchCreatePointLightArr(wdRecord, match$7[0]);
  return /* tuple */[
          match$8[0],
          match[1],
          /* tuple */[
