...
function assembleGLBData(wd, binBuffer, state) {
  ...
  return Most.fromPromise(_buildImageArray(wd, binBuffer).then((function (blobObjectUrlImageArr) {
                    return Promise.resolve(BuildSceneGameObjectSystem$Wonderjs.build(wd, BatchOperateSystem$Wonderjs.batchOperate(wd, blobObjectUrlImageArr, _buildBufferArray(buffers, binBuffer), BatchCreateSystem$Wonderjs.batchCreate(wd, state))));
                  })));
}
