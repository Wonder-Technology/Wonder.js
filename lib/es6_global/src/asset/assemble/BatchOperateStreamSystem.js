...
function batchOperate(wd, default11Image, param) {
  ...
  return /* tuple */[
          BatchSetStreamCubemapTextureAllDataSystem$Wonderjs.batchSet(cubemapTextureData, BatchSetStreamBasicSourceTextureAllDataSystem$Wonderjs.batchSet(basicSourceTextureData, BatchOperateSystem$Wonderjs.batchSetComponentData(wd, /* tuple */[
                        true,
                        true
                      ], /* tuple */[
                        transformArr,
                      ...
                      ], BatchOperateSystem$Wonderjs.batchAddComponent(wd, /* tuple */[
                            match$3[2],
                            gameObjectTransforms,
                            geometryGameObjects,
                            gameObjectGeometrys,
