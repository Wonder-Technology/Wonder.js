  ...
  return ArrayService$WonderCommonlib.reduceOneParami((function (state, geometryData, geometryIndex) {
                ...
                if (match) {
                  ...
                  if (match$4 !== undefined) {
                    return IndicesGeometryMainService$Wonderjs.setIndicesByUint16Array(geometry, Caml_option.valFromOption(match$4), state$3);
                  } else {
                    var match$5 = _getBufferIndex32Data(componentType, index, dataViewArr, wd);
                    if (match$5 !== undefined) {
                      return IndicesGeometryMainService$Wonderjs.setIndicesByUint32Array(geometry, Caml_option.valFromOption(match$5), state$3);
                    } else {
