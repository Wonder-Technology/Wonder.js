...
function _getBufferAttributeData(accessorIndex, dataViewArr, wd) {
  var match = _getBufferData(wd, /* tuple */[
        accessorIndex,
        dataViewArr,
        Float32Array.BYTES_PER_ELEMENT
      ]);
  return new Float32Array(match[0], match[1], match[2]);
}
...
function _getBufferIndexData(accessorIndex, dataViewArr, wd) {
  ...
  return new Uint16Array(match[0], match[1], match[2]);
}
...
function _batchSetCustomGeometryData(wd, customGeometryArr, bufferArr, state) {
  ...
  return ArrayService$WonderCommonlib.reduceOneParami((function (state, geometryData, geometryIndex) {
                if (geometryData) {
                  ...
                  var state$1 = VerticesCustomGeometryMainService$Wonderjs.setVerticesByTypeArray(customGeometry, _getBufferAttributeData(match[/* position */0], dataViewArr, wd), state);
                  var state$2 = normal ? NormalsCustomGeometryMainService$Wonderjs.setNormalsByTypeArray(customGeometry, _getBufferAttributeData(normal[0], dataViewArr, wd), state$1) : state$1;
                  var state$3 = texCoord ? TexCoordsCustomGeometryMainService$Wonderjs.setTexCoordsByTypeArray(customGeometry, _getBufferAttributeData(texCoord[0], dataViewArr, wd), state$2) : state$2;
                  return IndicesCustomGeometryMainService$Wonderjs.setIndicesByTypeArray(customGeometry, _getBufferIndexData(match[/* index */3], dataViewArr, wd), state$3);
                } else {
                  return state;
                }
