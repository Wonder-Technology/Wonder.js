...
function _createRecordWithState(state) {
  return RecordRenderMainService$Wonderjs.create(RecordCustomGeometryMainService$Wonderjs.create(RecordSourceInstanceMainService$Wonderjs.create(RecordLightMaterialMainService$Wonderjs.create(RecordBasicMaterialMainService$Wonderjs.create(RecordTransformMainService$Wonderjs.create(state))))));
}
  ...
  return Most.flatMap((function (json) {
                return Most.tap((function (state) {
                              ...
                              return /* () */0;
                                ...
                                }), _createHandleJobConfigStreamArr(dataDir, fetchFunc, _createRecordWithState(WorkerDetectMainService$Wonderjs.detect(_setSetting(stateData, StateDataMainService$Wonderjs.unsafeGetState(stateData), ParseSettingService$Wonderjs.convertToRecord(json)))))));
