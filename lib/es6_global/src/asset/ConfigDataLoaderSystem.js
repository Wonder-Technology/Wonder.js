...
function _createHandleNoWorkerJobConfigStreamArr(dataDir, fetchFunc, state) {
  return Most.fromPromise(_collectAllRecords(MostUtils$Wonderjs.concatArray(_createFetchNoWorkerJobStreamArr(dataDir, fetchFunc))).then((function (recordArr) {
                    var newrecord = Caml_array.caml_array_dup(state);
                    return Promise.resolve(NoWorkerJobMainService$Wonderjs.init(/* tuple */[
                                    NoWorkerJobHandleSystem$Wonderjs.createInitJobHandleMap,
                                    NoWorkerJobHandleSystem$Wonderjs.createLoopJobHandleMap
                                  ], (newrecord[/* noWorkerJobRecord */2] = RecordNoWorkerJobService$Wonderjs.create(recordArr), newrecord)));
                  })));
}
...
function _createRecordWithState(state) {
  return RecordSceneMainService$Wonderjs.create(RecordRenderMainService$Wonderjs.create(RecordCustomGeometryMainService$Wonderjs.create(RecordSourceInstanceMainService$Wonderjs.create(RecordArrayBufferViewSourceTextureMainService$Wonderjs.create(RecordBasicSourceTextureMainService$Wonderjs.create(RecordSourceTextureMainService$Wonderjs.create(RecordLightMaterialMainService$Wonderjs.create(RecordBasicMaterialMainService$Wonderjs.create(RecordTransformMainService$Wonderjs.create(state))))))))));
}
