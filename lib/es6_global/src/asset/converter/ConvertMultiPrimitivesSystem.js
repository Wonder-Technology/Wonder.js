...
function _buildMultiPrimitivesMeshName(meshName, primitiveIndex) {
  if (meshName) {
    return /* Some */["" + (String(meshName[0]) + ("_" + (String(primitiveIndex) + "")))];
  } else {
    return /* None */0;
  }
}

function _buildMultiPrimitivesNodeName(nodeName, primitiveIndex) {
  if (nodeName) {
    return /* Some */["" + (String(nodeName[0]) + ("_" + (String(primitiveIndex) + "")))];
  } else {
    return /* None */0;
  }
}
                    ...
                    var newMeshDataArr = ArrayService$WonderCommonlib.reduceOneParami((function (newMeshDataArr, primitive, primitiveIndex) {
                            return ArrayService$Wonderjs.push(/* tuple */[
                                        /* record */[
                                          ...
                                          /* name */_buildMultiPrimitivesMeshName(name, primitiveIndex)
                                        ],
            ...
            if (match) {
              ...
              var newNodesOfMultiPrimitives$1 = ArrayService$WonderCommonlib.reduceOneParami((function (newNodesOfMultiPrimitives, param, primitiveIndex) {
                      return ArrayService$Wonderjs.push(/* record */[
                                  /* name */_buildMultiPrimitivesNodeName(name, primitiveIndex),
                                  /* camera : None */0,
                                  /* mesh : Some */[param[1]],
                                  /* children : None */0,
                                  /* matrix : None */0,
