...
function _createDefaultMaterial() {
  return /* record */[
          /* pbrMetallicRoughness : Some */[/* record */[
              ...
              /* metallicRoughnessTexture : None */0
            ]],
...
function _addDefaultMaterial(gltf) {
  ...
  var match;
  if (materials) {
    var materials$1 = materials[0];
    match = /* tuple */[
      materials$1.length,
      /* Some */[ArrayService$Wonderjs.push(defaultMaterial, materials$1)]
    ];
  } else {
    match = /* tuple */[
      0,
      /* Some */[/* array */[defaultMaterial]]
    ];
  }
  return /* tuple */[
          match[0],
          ...
          /* nodes */ArrayService$WonderCommonlib.reduceOneParam((function (newNodes, node) {
                  ...
                  if (match) {
                    return ArrayService$Wonderjs.push(/* record */[
                                ...
                                /* scale */node[/* scale */7],
                                /* extras */node[/* extras */8] ? /* Some */[/* record */[/* material : Some */[defaultMaterialIndex]]] : /* Some */[/* record */[/* material : Some */[defaultMaterialIndex]]],
