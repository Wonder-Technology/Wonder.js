...
function _convertPBRData(name, diffuseColorFactor, arr, index) {
  var tmp;
  if (diffuseColorFactor !== undefined) {
    var colorFactor = diffuseColorFactor;
    tmp = /* array */[
      Caml_array.caml_array_get(colorFactor, 0),
      Caml_array.caml_array_get(colorFactor, 1),
      Caml_array.caml_array_get(colorFactor, 2)
    ];
  } else {
    tmp = /* array */[
      1,
