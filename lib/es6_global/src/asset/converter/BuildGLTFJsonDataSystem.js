...
function _addPrimitiveData(mesh, primitive, param, gltf) {
  ...
  var streamChunkArr = match[5];
  var newBufferViewOffset = match[4];
  var bufferViewDataArr = match[3];
  var accessorBufferArr = match[2];
  var match$1 = normal !== undefined ? _addPrimitivePointData(/* tuple */[
          normal,
          mesh,
          /* Normal */1
        ], /* tuple */[
  ...
  var streamChunkArr$1 = match$1[5];
  var newBufferViewOffset$1 = match$1[4];
  var bufferViewDataArr$1 = match$1[3];
  var accessorBufferArr$1 = match$1[2];
  var match$2 = texCoord_0 !== undefined ? _addPrimitivePointData(/* tuple */[
          texCoord_0,
          mesh,
          /* TexCoord */2
        ], /* tuple */[
  ...
  var streamChunkArr$2 = match$2[5];
  var newBufferViewOffset$2 = match$2[4];
  var bufferViewDataArr$2 = match$2[3];
  var accessorBufferArr$2 = match$2[2];
  var match$3 = indices !== undefined ? _addPrimitivePointData(/* tuple */[
          indices,
          mesh,
          /* Index */3
        ], /* tuple */[
  ...
  if (match$1) {
    ...
    if (match$2) {
      ...
      match$3 = /* tuple */[
        ...
        match$4[3],
        newMeshes,
        SparseMapService$WonderCommonlib.set(mesh, true, hasMeshAddBeforeMap)
      ];
    }
