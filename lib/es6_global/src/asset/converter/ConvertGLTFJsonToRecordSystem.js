                                      ...
                                      /* extras */Json_decode$WonderBsJson.optimizedOptional((function (param) {
                                              return Json_decode$WonderBsJson.optimizedField("extras", (function (json) {
                                                            return /* record */[
                                                                    ...
                                                                    /* flyCameraController */Json_decode$WonderBsJson.optimizedOptional((function (param) {
                                                                            return Json_decode$WonderBsJson.optimizedField("flyCameraController", Json_decode$WonderBsJson.$$int, param);
                                                                          }), json),
                                                                    /* arcballCameraController */Json_decode$WonderBsJson.optimizedOptional((function (param) {
                                                                            return Json_decode$WonderBsJson.optimizedField("arcballCameraController", Json_decode$WonderBsJson.$$int, param);
                                                                          }), json),
