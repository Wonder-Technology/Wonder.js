                              ...
                              return /* record */[
                                      ...
                                      /* extras */Json_decode$WonderBsJson.optional((function (param) {
                                              return Json_decode$WonderBsJson.field("extras", (function (json) {
                                                            return /* record */[/* imgui */Json_decode$WonderBsJson.optional((function (param) {
...
function _convertExtras(json) {
  return Json_decode$WonderBsJson.optional((function (param) {
                return Json_decode$WonderBsJson.field("extras", (function (json) {
                              return /* record */[/* arcballCameraControllers */Json_decode$WonderBsJson.optional((function (param) {
                              ...
                              return /* record */[
                                      ...
                                      /* extras */Json_decode$WonderBsJson.optimizedOptional((function (param) {
                                              return Json_decode$WonderBsJson.optimizedField("extras", (function (json) {
                                                            return /* record */[
                                                                    /* material */Json_decode$WonderBsJson.optimizedOptional((function (param) {
                                                                            return Json_decode$WonderBsJson.optimizedField("material", Json_decode$WonderBsJson.$$int, param);
                                                                          }), json),
