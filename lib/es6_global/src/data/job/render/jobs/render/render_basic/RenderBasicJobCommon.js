...
function render(gl, uid, state) {
  var materialIndex = GameObjectAdmin$Wonderjs.unsafeGetBasicMaterialComponent(uid, state);
  return RenderJobUtils$Wonderjs.render(gl, /* tuple */[
              materialIndex,
              BasicMaterialAdmin$Wonderjs.unsafeGetShaderIndex(materialIndex, state),
              uid
            ], state);
}
