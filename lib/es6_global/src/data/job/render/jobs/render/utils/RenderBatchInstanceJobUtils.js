...
function render(gl, uid, renderFunc, state) {
  ...
  var state$1 = match[0];
  var uniformInstanceSendNoCachableData = GLSLSenderConfigDataHandleSystem$Wonderjs.unsafeGetUniformInstanceSendNoCachableData(match[1], state$1);
  ...
  return ArraySystem$Wonderjs.reduceState((function (state, uid) {
                var state$1 = ArraySystem$Wonderjs.reduceState((function (state, param) {
                        param[/* sendDataFunc */2](gl, param[/* pos */0], param[/* getDataFunc */1](GameObjectAdmin$Wonderjs.unsafeGetTransformComponent(uid, state), state));
                        return state;
