...
function render(gl, param, param$1, state) {
  ...
  var uid = param[0];
  var match = param$1[0](gl, uid, state);
  var state$1 = match[0];
  var extension = GPUDetectSystem$Wonderjs.unsafeGetInstanceExtension(state$1);
  ...
  var instanceDataTuple_002 = param[1];
  var instanceDataTuple_003 = param[2];
  var instanceDataTuple_004 = param[3];
  var instanceDataTuple = /* tuple */[
    uid,
    sourceInstance,
    instanceDataTuple_002,
    instanceDataTuple_003,
    instanceDataTuple_004,
    objectInstanceArray,
    instanceRenderListCount
  ];
  var matrixMapTuple = _geMatrixMapTuple(state$1);
  var dataTuple = /* tuple */[
    glDataTuple,
    instanceDataTuple,
    matrixMapTuple
  ];
  var match$1 = SourceInstanceAdmin$Wonderjs.isTransformStatic(sourceInstance, state$1);
  var state$2 = match$1 !== 0 ? _sendStaticTransformMatrixData(dataTuple, fillMatrixTypeArrFunc, state$1) : _sendDynamicTransformMatrixData(dataTuple, fillMatrixTypeArrFunc, state$1);
