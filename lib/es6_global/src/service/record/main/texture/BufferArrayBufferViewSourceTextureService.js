...
function getFlipYsLength(arrayBufferViewSourceTextureCount) {
  return Caml_int32.imul(arrayBufferViewSourceTextureCount, BufferSourceSizeTextureService$Wonderjs.getFlipYsSize(/* () */0));
}
...
function getWidthsOffset(basicSourceTextureCount, arrayBufferViewSourceTextureCount) {
  return getFlipYsOffset(basicSourceTextureCount, arrayBufferViewSourceTextureCount) + Caml_int32.imul(Caml_int32.imul(arrayBufferViewSourceTextureCount, BufferSourceSizeTextureService$Wonderjs.getFlipYsSize(/* () */0)), Uint8Array.BYTES_PER_ELEMENT) | 0;
}
