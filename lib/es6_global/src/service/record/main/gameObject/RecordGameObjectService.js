...
function deepCopyForRestore(record) {
  ...
  var disposedBasicMaterialDataMap = record[/* disposedBasicMaterialDataMap */15];
  var disposedLightMaterialDataMap = record[/* disposedLightMaterialDataMap */16];
  var disposedGeometryDataMap = record[/* disposedGeometryDataMap */17];
