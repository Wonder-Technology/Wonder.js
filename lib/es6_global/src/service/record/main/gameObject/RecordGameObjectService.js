...
function deepCopyForRestore(record) {
  ...
  var disposedBasicMaterialArray = record[/* disposedBasicMaterialArray */10];
  var disposedLightMaterialArray = record[/* disposedLightMaterialArray */11];
  var disposedBoxGeometryArray = record[/* disposedBoxGeometryArray */12];
  var disposedCustomGeometryArray = record[/* disposedCustomGeometryArray */13];
  var disposedSourceInstanceArray = record[/* disposedSourceInstanceArray */14];
  var disposedObjectInstanceArray = record[/* disposedObjectInstanceArray */15];
