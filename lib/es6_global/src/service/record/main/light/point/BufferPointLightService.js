...
function getIntensitiesOffset(count) {
  return Caml_int32.imul(Caml_int32.imul(count, 3), Float32Array.BYTES_PER_ELEMENT);
}
...
function getConstantsOffset(count) {
  return Caml_int32.imul(Caml_int32.imul(count, 3), Float32Array.BYTES_PER_ELEMENT) + Caml_int32.imul((count << 0), Float32Array.BYTES_PER_ELEMENT) | 0;
}
