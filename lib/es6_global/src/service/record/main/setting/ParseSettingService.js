  ...
  return /* record */[
          ...
          /* buffer */Json_decode$WonderBsJson.optional((function (param) {
                  return Json_decode$WonderBsJson.field("buffer", (function (json) {
                                return /* record */[
                                        /* customGeometryPointCount */Json_decode$WonderBsJson.field("custom_geometry_point_count", Json_decode$WonderBsJson.$$int, json),
                                        /* customGeometryCount */Json_decode$WonderBsJson.field("custom_geometry_count", Json_decode$WonderBsJson.$$int, json),
