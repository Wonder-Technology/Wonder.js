...
function _setAllNotActive(isActiveMap) {
  return MutableSparseMapService$WonderCommonlib.mapValid((function () {
                return false;
              }), isActiveMap);
}
...
function active(cameraView, record) {
  return /* record */[
          ...
          /* isActiveMap */MutableSparseMapService$WonderCommonlib.set(cameraView, true, MutableSparseMapService$WonderCommonlib.mapValid((function () {
                      return false;
