...
function getIsTransformStaticsOffset(sourceInstanceCount, objectInstanceCountPerSourceInstance) {
  return Caml_int32.imul(Caml_int32.imul(sourceInstanceCount, objectInstanceCountPerSourceInstance), Uint32Array.BYTES_PER_ELEMENT);
}
...
function createBuffer(sourceInstanceCount, objectInstanceCountPerSourceInstance) {
  return new SharedArrayBuffer(getTotalByteLength(sourceInstanceCount, objectInstanceCountPerSourceInstance));
}
