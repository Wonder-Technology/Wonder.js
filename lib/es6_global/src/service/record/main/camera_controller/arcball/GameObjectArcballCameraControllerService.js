...
function getGameObject(cameraController, param) {
  return GameObjectMapService$Wonderjs.getGameObject(cameraController, param[/* gameObjectMap */17]);
}

function unsafeGetGameObject(cameraController, param) {
  return GameObjectMapService$Wonderjs.unsafeGetGameObject(cameraController, param[/* gameObjectMap */17]);
}
