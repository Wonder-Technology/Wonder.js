...
function unsafeGetDistance(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* distanceMap */7]));
}

function unsafeGetWheelSpeed(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* wheelSpeedMap */16]));
}
...
function setWheelSpeed(cameraController, wheelSpeed, record) {
  return /* record */[
          ...
          /* wheelSpeedMap */SparseMapService$WonderCommonlib.set(cameraController, wheelSpeed, record[/* wheelSpeedMap */16]),
...
function unsafeGetMinDistance(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* minDistanceMap */8]));
}
...
function setDistance(cameraController, distance, record) {
  return /* record */[
          ...
          /* distanceMap */SparseMapService$WonderCommonlib.set(cameraController, NumberService$Wonderjs.bigThan(distance, unsafeGetMinDistance(cameraController, record)), record[/* distanceMap */7]),
          /* minDistanceMap */record[/* minDistanceMap */8],
          /* phiMap */record[/* phiMap */9],
          /* thetaMap */record[/* thetaMap */10],
          /* thetaMarginMap */record[/* thetaMarginMap */11],
...
function setMinDistance(cameraController, minDistance, record) {
  ...
  var record_008 = /* minDistanceMap */SparseMapService$WonderCommonlib.set(cameraController, minDistance, record[/* minDistanceMap */8]);
...
function unsafeGetPhi(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* phiMap */9]));
}
...
function setPhi(cameraController, phi, record) {
  return /* record */[
          ...
          /* distanceMap */record[/* distanceMap */7],
          /* minDistanceMap */record[/* minDistanceMap */8],
          /* phiMap */SparseMapService$WonderCommonlib.set(cameraController, phi, record[/* phiMap */9]),
          /* thetaMap */record[/* thetaMap */10],
          /* thetaMarginMap */record[/* thetaMarginMap */11],
          /* targetMap */record[/* targetMap */12],
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
...
function unsafeGetTheta(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* thetaMap */10]));
}

function unsafeGetThetaMargin(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* thetaMarginMap */11]));
}
...
function setThetaMargin(cameraController, thetaMargin, record) {
  return /* record */[
          ...
          /* minDistanceMap */record[/* minDistanceMap */8],
          /* phiMap */record[/* phiMap */9],
          /* thetaMap */SparseMapService$WonderCommonlib.set(cameraController, _constrainTheta(unsafeGetTheta(cameraController, record), thetaMargin), record[/* thetaMap */10]),
          /* thetaMarginMap */SparseMapService$WonderCommonlib.set(cameraController, thetaMargin, record[/* thetaMarginMap */11]),
          /* targetMap */record[/* targetMap */12],
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
          /* moveSpeedYMap */record[/* moveSpeedYMap */14],
          /* rotateSpeedMap */record[/* rotateSpeedMap */15],
...
function setTheta(cameraController, theta, record) {
  ...
  return /* record */[
          ...
          /* minDistanceMap */record[/* minDistanceMap */8],
          /* phiMap */record[/* phiMap */9],
          /* thetaMap */SparseMapService$WonderCommonlib.set(cameraController, _constrainTheta(theta, thetaMargin), record[/* thetaMap */10]),
          /* thetaMarginMap */record[/* thetaMarginMap */11],
          /* targetMap */record[/* targetMap */12],
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
          /* moveSpeedYMap */record[/* moveSpeedYMap */14],
...
function unsafeGetTarget(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* targetMap */12]));
}
...
function setTarget(cameraController, target, record) {
  return /* record */[
          ...
          /* thetaMap */record[/* thetaMap */10],
          /* thetaMarginMap */record[/* thetaMarginMap */11],
          /* targetMap */SparseMapService$WonderCommonlib.set(cameraController, target, record[/* targetMap */12]),
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
          /* moveSpeedYMap */record[/* moveSpeedYMap */14],
          /* rotateSpeedMap */record[/* rotateSpeedMap */15],
          /* wheelSpeedMap */record[/* wheelSpeedMap */16],
...
function unsafeGetMoveSpeedX(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* moveSpeedXMap */13]));
}
...
function setMoveSpeedX(cameraController, moveSpeedX, record) {
  return /* record */[
          ...
          /* thetaMarginMap */record[/* thetaMarginMap */11],
          /* targetMap */record[/* targetMap */12],
          /* moveSpeedXMap */SparseMapService$WonderCommonlib.set(cameraController, moveSpeedX, record[/* moveSpeedXMap */13]),
          /* moveSpeedYMap */record[/* moveSpeedYMap */14],
          /* rotateSpeedMap */record[/* rotateSpeedMap */15],
          /* wheelSpeedMap */record[/* wheelSpeedMap */16],
          /* gameObjectMap */record[/* gameObjectMap */17],
...
function unsafeGetMoveSpeedY(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* moveSpeedYMap */14]));
}
...
function setMoveSpeedY(cameraController, moveSpeedY, record) {
  return /* record */[
          ...
          /* targetMap */record[/* targetMap */12],
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
          /* moveSpeedYMap */SparseMapService$WonderCommonlib.set(cameraController, moveSpeedY, record[/* moveSpeedYMap */14]),
          /* rotateSpeedMap */record[/* rotateSpeedMap */15],
          /* wheelSpeedMap */record[/* wheelSpeedMap */16],
          /* gameObjectMap */record[/* gameObjectMap */17],
          /* disposedIndexArray */record[/* disposedIndexArray */18]
...
function unsafeGetRotateSpeed(cameraController, record) {
  return OptionService$Wonderjs.unsafeGet(SparseMapService$WonderCommonlib.get(cameraController, record[/* rotateSpeedMap */15]));
}
...
function setRotateSpeed(cameraController, rotateSpeed, record) {
  return /* record */[
          ...
          /* moveSpeedXMap */record[/* moveSpeedXMap */13],
          /* moveSpeedYMap */record[/* moveSpeedYMap */14],
          /* rotateSpeedMap */SparseMapService$WonderCommonlib.set(cameraController, rotateSpeed, record[/* rotateSpeedMap */15]),
          /* wheelSpeedMap */record[/* wheelSpeedMap */16],
          /* gameObjectMap */record[/* gameObjectMap */17],
          /* disposedIndexArray */record[/* disposedIndexArray */18]
        ];
