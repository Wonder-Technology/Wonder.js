...
function _setDefaultValue(index, record) {
  return /* record */[
          ...
          /* directionArrayMap */MutableSparseMapService$WonderCommonlib.set(index, /* array */[], record[/* directionArrayMap */17]),
...
function create(record) {
  var match = IndexComponentService$Wonderjs.generateIndex(record[/* index */0], record[/* disposedIndexArray */19]);
  var index = match[0];
  ...
  return /* tuple */[
          /* record */[
            ...
            /* directionArrayMap */record$1[/* directionArrayMap */17],
            /* gameObjectMap */record$1[/* gameObjectMap */18],
