...
function removeFromParentMap(child, record) {
  ...
  newrecord[/* parentMap */9] = SparseMapService$WonderCommonlib.deleteVal(child, record[/* parentMap */9]);
  return newrecord;
}
...
function _setChildren(record, parent, children) {
  var newrecord = record.slice();
  newrecord[/* childMap */10] = SparseMapService$WonderCommonlib.set(parent, children, record[/* childMap */10]);
  return newrecord;
}
...
function _setParent(parent, child, record) {
  var newrecord = record.slice();
  newrecord[/* parentMap */9] = SparseMapService$WonderCommonlib.set(child, parent, record[/* parentMap */9]);
  return newrecord;
}
