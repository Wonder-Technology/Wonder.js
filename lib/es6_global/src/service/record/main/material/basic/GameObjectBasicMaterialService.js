...
function getGameObject(material, param) {
  return GameObjectMapService$Wonderjs.getGameObject(material, param[/* gameObjectMap */6]);
}

function unsafeGetGameObject(material, param) {
  return GameObjectMapService$Wonderjs.unsafeGetGameObject(material, param[/* gameObjectMap */6]);
}
