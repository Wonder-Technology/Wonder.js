...
function getGameObjects(material, param) {
  return GameObjectsMapService$Wonderjs.getGameObjects(material, param[/* gameObjectsMap */8]);
}

function unsafeGetGameObjects(material, param) {
  return GameObjectsMapService$Wonderjs.unsafeGetGameObjects(material, param[/* gameObjectsMap */8]);
}
