...
function increaseGroupCount(material, record) {
  ...
  newrecord[/* groupCountMap */9] = GroupService$Wonderjs.increaseGroupCount(material, record[/* groupCountMap */9]);
  return newrecord;
}

function decreaseGroupCount(material, record) {
  var newrecord = record.slice();
  newrecord[/* groupCountMap */9] = GroupService$Wonderjs.decreaseGroupCount(material, record[/* groupCountMap */9]);
  return newrecord;
}
