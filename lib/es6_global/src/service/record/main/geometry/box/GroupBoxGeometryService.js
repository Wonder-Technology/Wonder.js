...
function increaseGroupCount(geometry, record) {
  ...
  newrecord[/* groupCountMap */6] = GroupService$Wonderjs.increaseGroupCount(geometry, record[/* groupCountMap */6]);
  return newrecord;
}

function decreaseGroupCount(geometry, record) {
  var newrecord = record.slice();
  newrecord[/* groupCountMap */6] = GroupService$Wonderjs.decreaseGroupCount(geometry, record[/* groupCountMap */6]);
  return newrecord;
}
