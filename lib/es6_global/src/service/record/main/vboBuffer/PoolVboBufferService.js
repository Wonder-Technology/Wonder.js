...
function addBoxGeometryBufferToPool(geometryIndex, record) {
  ...
  newrecord[/* vertexArrayBufferPool */9] = _addBufferToPool(geometryIndex, record[/* boxGeometryNormalBufferMap */2], _addBufferToPool(geometryIndex, record[/* boxGeometryTexCoordBufferMap */1], _addBufferToPool(geometryIndex, record[/* boxGeometryVertexBufferMap */0], record[/* vertexArrayBufferPool */9])));
  newrecord[/* elementArrayBufferPool */10] = _addBufferToPool(geometryIndex, record[/* boxGeometryElementArrayBufferMap */3], record[/* elementArrayBufferPool */10]);
  return newrecord;
}

function addCustomGeometryBufferToPool(geometryIndex, record) {
  var newrecord = record.slice();
  newrecord[/* vertexArrayBufferPool */9] = _addBufferToPool(geometryIndex, record[/* customGeometryNormalBufferMap */6], _addBufferToPool(geometryIndex, record[/* customGeometryTexCoordBufferMap */5], _addBufferToPool(geometryIndex, record[/* customGeometryVertexBufferMap */4], record[/* vertexArrayBufferPool */9])));
  newrecord[/* elementArrayBufferPool */10] = _addBufferToPool(geometryIndex, record[/* customGeometryElementArrayBufferMap */7], record[/* elementArrayBufferPool */10]);
  return newrecord;
}
...
function addInstanceBufferToPool(sourceInstanceIndex, record) {
  ...
  if (match) {
    var newrecord = record.slice();
    newrecord[/* matrixInstanceBufferPool */11] = ArrayService$Wonderjs.push(match[0], record[/* matrixInstanceBufferPool */11]);
    return newrecord;
  } else {
    return record;
  }
