...
function getGameObject(material, param) {
  return GameObjectMapService$Wonderjs.getGameObject(material, param[/* gameObjectMap */5]);
}

function unsafeGetGameObject(material, param) {
  return GameObjectMapService$Wonderjs.unsafeGetGameObject(material, param[/* gameObjectMap */5]);
}
