...
function getColor(mappedIndex, param) {
  return RecordDirectionLightMainService$Wonderjs.getColor(mappedIndex, param[/* colors */1]);
}

function getIntensity(mappedIndex, param) {
  return RecordDirectionLightMainService$Wonderjs.getIntensity(mappedIndex, param[/* intensities */2]);
}
