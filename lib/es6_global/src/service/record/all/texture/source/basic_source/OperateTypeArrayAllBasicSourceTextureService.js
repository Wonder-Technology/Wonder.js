...
import * as BufferBasicSourceTextureService$Wonderjs from "../../../../main/texture/source/basic_source/BufferBasicSourceTextureService.js";
...
function isFlipY(index, typeArr) {
  return TypeArrayService$Wonderjs.getUint8_1(BufferBasicSourceTextureService$Wonderjs.getFlipYIndex(index), typeArr) === BufferTextureService$Wonderjs.getFlipY(/* () */0);
}
