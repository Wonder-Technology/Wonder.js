...
import * as BufferArrayBufferViewSourceTextureService$Wonderjs from "../../../../main/texture/source/arrayBufferView_source/BufferArrayBufferViewSourceTextureService.js";
...
function isFlipY(index, typeArr) {
  return TypeArrayService$Wonderjs.getUint8_1(BufferArrayBufferViewSourceTextureService$Wonderjs.getFlipYIndex(index), typeArr) === BufferTextureService$Wonderjs.getFlipY(/* () */0);
}
