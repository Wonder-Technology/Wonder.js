...
function checkNotExceedMaxCount(count, _) {
  Contract$WonderLog.requireCheck((function () {
          var maxCount = BufferDirectionLightService$Wonderjs.getBufferMaxCount(/* () */0);
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("light count: " + (String(count) + (" <= max count: " + (String(maxCount) + ""))), "not"), (function () {
