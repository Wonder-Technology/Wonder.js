...
function setStencilFunc(gl, targetStencilFunc, targetStencilRef, targetStencilMask, record) {
  gl.stencilFunc(targetStencilFunc, targetStencilRef, targetStencilMask);
  return record;
}

function setStencilOp(gl, targetStencilSFail, targetStencilDPFail, targetStencilDPPass, record) {
  gl.stencilOp(targetStencilSFail, targetStencilDPFail, targetStencilDPPass);
  return record;
}
