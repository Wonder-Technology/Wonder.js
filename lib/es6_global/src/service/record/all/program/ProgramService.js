...
function getProgram(shaderIndex, param) {
  return SparseMapService$WonderCommonlib.get(shaderIndex, param[/* programMap */0]);
}
...
function unsafeGetProgram(shaderIndex, param) {
  return Contract$WonderLog.ensureCheck((function (program) {
              ...
              }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData), SparseMapService$WonderCommonlib.unsafeGet(shaderIndex, param[/* programMap */0]));
}

function registerProgram(shaderIndex, param, program) {
  SparseMapService$WonderCommonlib.set(shaderIndex, program, param[/* programMap */0]);
  return program;
}
