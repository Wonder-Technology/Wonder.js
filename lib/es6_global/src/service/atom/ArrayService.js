...
function _includeInSourceArr(targetItem, resultArr, _posInSourceArr, sourceArr, sourceArrLength) {
  while(true) {
    var posInSourceArr = _posInSourceArr;
    ...
    if (match) {
      ...
      if (match$1) {
        _posInSourceArr = posInSourceArr + 1 | 0;
        continue ;
      } else {
        return /* tuple */[
...
function _excludeInSourceArr(targetItem, _resultArr, _posInSourceArr, sourceArr, sourceArrLength) {
  while(true) {
    var posInSourceArr = _posInSourceArr;
...
function _fastHandleRelation(targetArr, sourceArr, handleLengthEqualFunc, handleInSourceArrFunc, handleResultArrFunc) {
  Contract$WonderLog.requireCheck((function (param) {
  ...
  if (match) {
    ...
    return Curry._2(handleLengthEqualFunc, targetArr, sourceArr);
  } else {
    ...
    var match$1 = ArrayService$WonderCommonlib.reduceOneParam((function (param, targetItem) {
            return Curry._5(handleInSourceArrFunc, targetItem, param[0], param[1], sourceArr, sourceArrLength);
          }), /* tuple */[
          /* array */[],
          0
        ], targetArr);
    return Curry._3(handleResultArrFunc, match$1[1], sourceArr, match$1[0]);
  }
}

function fastExclude(targetArr, sourceArr) {
  return _fastHandleRelation(targetArr, sourceArr, (function (param, param$1) {
                return /* array */[];
              }), _excludeInSourceArr, (function (posInSourceArr, sourceArr, resultArr) {
                return fastConcat(resultArr, sourceArr.slice(posInSourceArr));
              }));
}

function fastIntersect(targetArr, sourceArr) {
  return _fastHandleRelation(targetArr, sourceArr, (function (targetArr, param) {
                return targetArr;
              }), _includeInSourceArr, (function (posInSourceArr, sourceArr, resultArr) {
                return resultArr;
              }));
}
