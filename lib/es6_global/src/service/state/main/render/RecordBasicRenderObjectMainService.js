...
function _initBufferData(count) {
  var buffer = new SharedArrayBuffer(Caml_int32.imul(count, Caml_int32.imul(Uint32Array.BYTES_PER_ELEMENT, (RenderObjectBufferTypeArrayService$Wonderjs.getComponentSize(/* () */0) << 2)) + Caml_int32.imul(Uint8Array.BYTES_PER_ELEMENT, RenderObjectBufferTypeArrayService$Wonderjs.getGeometryTypeSize(/* () */0)) | 0));
  return /* tuple */[
          buffer,
...
function create(state) {
  ...
  var match = _initBufferData(basicMaterialDataBufferCount);
  var match$1 = match[1];
  return /* Some */[/* record */[
            /* buffer */match[0],
