...
function unsafeGetSource(texture, state) {
  ...
  return TextureSourceMapService$Wonderjs.unsafeGetSource(IndexSourceTextureService$Wonderjs.getArrayBufferViewSourceTextureIndexInTypeArray(texture, IndexSourceTextureMainService$Wonderjs.getArrayBufferViewSourceTextureIndexOffset(state)), match[/* sourceMap */11]);
}
...
function setSource(texture, source, state) {
  ...
  if (match) {
    ...
    TextureSourceMapService$Wonderjs.setSource(IndexSourceTextureService$Wonderjs.getArrayBufferViewSourceTextureIndexInTypeArray(texture, IndexSourceTextureMainService$Wonderjs.getArrayBufferViewSourceTextureIndexOffset(state)), source, match$1[/* sourceMap */11]);
    ...
    TextureSourceMapService$Wonderjs.setSource(IndexSourceTextureService$Wonderjs.getArrayBufferViewSourceTextureIndexInTypeArray(texture, IndexSourceTextureMainService$Wonderjs.getArrayBufferViewSourceTextureIndexOffset(state)), source, match$2[/* sourceMap */11]);
    return state;
  }
}
