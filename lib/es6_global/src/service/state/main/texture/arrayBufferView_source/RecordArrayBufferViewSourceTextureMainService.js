...
function _setAllTypeArrDataToDefault(arrayBufferViewSourceTextureCount, arrayBufferViewSourceTextureIndexOffset, param) {
...
function _initBufferData(basicSourceTextureCount, arrayBufferViewSourceTextureCount, buffer, arrayBufferViewSourceTextureIndexOffset) {
  ...
  return _setAllTypeArrDataToDefault(arrayBufferViewSourceTextureCount, arrayBufferViewSourceTextureIndexOffset, /* tuple */[
              match[0],
              match[1],
              match[2],
              match[3],
