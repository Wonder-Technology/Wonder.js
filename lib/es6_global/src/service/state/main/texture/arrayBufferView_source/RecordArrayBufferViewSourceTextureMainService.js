...
function deepCopyForRestore(state) {
  ...
  newrecord[/* arrayBufferViewSourceTextureRecord */19] = /* record */[
    ...
    /* sourceMap */SparseMapService$Wonderjs.copy(record[/* sourceMap */11]),
    /* glTextureMap */SparseMapService$Wonderjs.copy(record[/* glTextureMap */12]),
    /* bindTextureUnitCacheMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
    ...
    /* nameMap */SparseMapService$Wonderjs.copy(record[/* nameMap */17])
  ];
  return newrecord;
}
