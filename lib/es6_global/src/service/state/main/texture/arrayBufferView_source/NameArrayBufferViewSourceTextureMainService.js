...
function getName(texture, state) {
  return NameService$Wonderjs.getName(texture, RecordArrayBufferViewSourceTextureMainService$Wonderjs.getRecord(state)[/* nameMap */18]);
}

function unsafeGetName(texture, state) {
  return NameService$Wonderjs.unsafeGetName(texture, RecordArrayBufferViewSourceTextureMainService$Wonderjs.getRecord(state)[/* nameMap */18]);
}
...
function setName(texture, name, state) {
  ...
  newrecord[/* arrayBufferViewSourceTextureRecord */19] = /* record */[
    ...
    /* nameMap */NameService$Wonderjs.setName(texture, name, record[/* nameMap */18]),
    /* materialsMap */record[/* materialsMap */19]
  ];
  return newrecord;
}
