...
function create(state) {
  ...
  state[/* sourceTextureRecord */17] = /* Some */[/* record */[/* buffer */BufferSourceTextureService$Wonderjs.createBuffer(basicSourceTextureCount, arrayBufferViewSourceTextureCount)]];
  return state;
}
