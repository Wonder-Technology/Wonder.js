...
function getWidth(texture, state) {
  ...
  if (match$1 !== undefined) {
    return TextureSizeService$Wonderjs.getWidth(Js_primitive.valFromOption(match$1));
  } else {
...
function getHeight(texture, state) {
  ...
  var match$1 = TextureSourceMapService$Wonderjs.getSource(texture, match[/* sourceMap */9]);
  if (match$1 !== undefined) {
    return TextureSizeService$Wonderjs.getHeight(Js_primitive.valFromOption(match$1));
  } else {
