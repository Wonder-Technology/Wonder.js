...
function _setAllTypeArrDataToDefault(basicSourceTextureCount, param) {
...
function _initBufferData(basicSourceTextureCount, buffer) {
  ...
  return _setAllTypeArrDataToDefault(basicSourceTextureCount, /* tuple */[
              match[0],
              match[1],
              match[2],
              match[3],
...
function deepCopyForRestore(state) {
  ...
  newrecord[/* basicSourceTextureRecord */18] = /* Some */[/* record */[
      ...
      /* sourceMap */SparseMapService$Wonderjs.copy(record[/* sourceMap */8]),
      /* glTextureMap */SparseMapService$Wonderjs.copy(record[/* glTextureMap */9]),
      /* bindTextureUnitCacheMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
