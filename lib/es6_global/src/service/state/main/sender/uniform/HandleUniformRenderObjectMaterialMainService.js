...
function unsafeGetUniformSendData(shaderIndex, state) {
  return HandleUniformConfigDataMapService$Wonderjs.unsafeGetUniformSendData(shaderIndex, state[/* glslSenderRecord */26][/* uniformRenderObjectSendMaterialDataMap */4]);
}
