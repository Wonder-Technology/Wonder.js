...
import * as CreateTypeArrayMeshRendererService$Wonderjs from "../../../record/all/meshRenderer/CreateTypeArrayMeshRendererService.js";
...
function getRecord(param) {
  return OptionService$Wonderjs.unsafeGet(param[/* meshRendererRecord */23]);
}

function setAllTypeArrDataToDefault(meshRendererCount, defaultDrawMode, defaultIsRender, drawModes, isRenders) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (param, index) {
                return /* tuple */[
                        OperateTypeArrayMeshRendererService$Wonderjs.setDrawMode(index, defaultDrawMode, param[0]),
                        OperateTypeArrayMeshRendererService$Wonderjs.setIsRender(index, defaultIsRender, param[1])
                      ];
              }), /* tuple */[
              drawModes,
              isRenders
...
function _setAllTypeArrDataToDefault(meshRendererCount, defaultDrawMode, defaultIsRender, param) {
  return /* tuple */[
          param[0],
          setAllTypeArrDataToDefault(meshRendererCount, defaultDrawMode, defaultIsRender, param[1], param[2])
        ];
}
...
function deepCopyForRestore(state) {
  ...
  newrecord[/* meshRendererRecord */23] = /* record */[
    ...
    /* basicMaterialRenderGameObjectMap */SparseMapService$Wonderjs.copy(record[/* basicMaterialRenderGameObjectMap */4]),
    /* lightMaterialRenderGameObjectMap */SparseMapService$Wonderjs.copy(record[/* lightMaterialRenderGameObjectMap */5]),
