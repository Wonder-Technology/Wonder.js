...
function addToRenderGameObjectMap(meshRenderer, gameObjectUid, meshRendererRecord, gameObjectRecord) {
  ...
  return /* record */[
          ...
          /* basicMaterialRenderGameObjectMap */match ? SparseMapService$WonderCommonlib.set(meshRenderer, gameObjectUid, basicMaterialRenderGameObjectMap) : basicMaterialRenderGameObjectMap,
          /* lightMaterialRenderGameObjectMap */match$1 ? SparseMapService$WonderCommonlib.set(meshRenderer, gameObjectUid, lightMaterialRenderGameObjectMap) : lightMaterialRenderGameObjectMap,
