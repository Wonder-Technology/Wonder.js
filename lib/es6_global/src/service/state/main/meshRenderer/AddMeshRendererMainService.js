...
function handleAddComponent(meshRenderer, gameObjectUid, state) {
  ...
  Contract$WonderLog.requireCheck((function (param) {
          Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("isRender is true", "is false"), (function (param) {
                  return Contract$WonderLog.assertTrue(OperateMeshRendererMainService$Wonderjs.getIsRender(meshRenderer, state));
                }));
  ...
  var meshRendererRecord$1 = RenderArrayMeshRendererMainService$Wonderjs.addToRenderGameObjectMap(meshRenderer, gameObjectUid, meshRendererRecord, gameObjectRecord);
