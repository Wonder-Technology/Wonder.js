...
function batchAddCustomGeometryComponentForClone(uidArr, componentArr, state) {
  var gameObjectRecord = state[/* gameObjectRecord */10];
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* customGeometryRecord */24] = /* Some */[_batchAddSharableGeometryComponent(/* tuple */[
          uidArr,
          componentArr,
          /* tuple */[
            gameObjectRecord[/* currentGeometryDataMap */21],
...
function _batchAddMaterialComponentForClone(isShareMaterial, param, param$1, record) {
  var componentMap = param[2];
  var componentArr = param[1];
  var uidArr = param[0];
  if (isShareMaterial) {
...
function batchAddAmbientLightComponentForClone(uidArr, componentArr, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* ambientLightRecord */20] = _batchAddComponent(/* tuple */[
        uidArr,
        componentArr,
...
function batchAddTransformComponentForCreate(uidArr, componentArr, state) {
  var gameObjectRecord = state[/* gameObjectRecord */10];
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* transformRecord */11] = /* Some */[_batchAddComponent(/* tuple */[
          uidArr,
...
function _batchAddCustomGeometryComponentDataForCreate(param, component, uid) {
  return CurrentComponentDataMapRenderService$Wonderjs.addToMap(uid, /* tuple */[
              component,
              param[1]
            ], param[0]);
...
function batchAddCustomGeometryComponentForCreate(uidArr, componentArr, state) {
  var gameObjectRecord = state[/* gameObjectRecord */10];
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* customGeometryRecord */24] = /* Some */[_batchAddSharableGeometryComponent(/* tuple */[
          uidArr,
        ...
        ], GroupCustomGeometryService$Wonderjs.increaseGroupCount, _batchAddCustomGeometryComponentDataForCreate, RecordCustomGeometryMainService$Wonderjs.getRecord(state))];
  return newrecord;
}
