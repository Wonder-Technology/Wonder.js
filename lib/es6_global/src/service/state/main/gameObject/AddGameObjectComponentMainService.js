...
function addBoxGeometryComponent(uid, component, state) {
  ...
  state[/* boxGeometryRecord */20] = _addSharableGeometryComponent(/* tuple */[
        uid,
        component,
...
function addCustomGeometryComponent(uid, component, state) {
  ...
  state[/* customGeometryRecord */21] = /* Some */[_addSharableGeometryComponent(/* tuple */[
          uid,
          component,
...
function addAmbientLightComponent(uid, component, state) {
  ...
  state[/* ambientLightRecord */17] = _addComponent(/* tuple */[
        uid,
        component,
...
function addDirectionLightComponent(uid, component, state) {
  ...
  state[/* directionLightRecord */18] = _addComponent(/* tuple */[
        uid,
        component,
...
function addPointLightComponent(uid, component, state) {
  ...
  state[/* pointLightRecord */19] = _addComponent(/* tuple */[
        uid,
        component,
