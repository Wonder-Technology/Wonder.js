...
function batchDisposeBasicMaterialComponentForWorker(state, componentArray) {
  ...
  newrecord[/* basicMaterialRecord */15] = /* Some */[(newrecord$1[/* materialArrayForWorkerInit */11] = MaterialArrayForWorkerInitService$Wonderjs.removeDisposedOnesFromMaterialArrayForWorkerInit(componentArray, materialArrayForWorkerInit), newrecord$1)];
  return newrecord;
}
...
function batchDisposeLightMaterialComponentForWorker(state, componentArray) {
  ...
  var newrecord = state$1.slice();
  var newrecord$1 = record.slice();
  newrecord[/* lightMaterialRecord */16] = /* Some */[(newrecord$1[/* materialArrayForWorkerInit */16] = MaterialArrayForWorkerInitService$Wonderjs.removeDisposedOnesFromMaterialArrayForWorkerInit(componentArray, materialArrayForWorkerInit), newrecord$1)];
  return newrecord;
}
