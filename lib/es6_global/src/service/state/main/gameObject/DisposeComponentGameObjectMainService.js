...
function batchDisposeBasicMaterialComponent(state, compnentDataMap) {
  return DisposeBasicMaterialMainService$Wonderjs.handleBatchDisposeComponent(compnentDataMap, state);
}

function batchDisposeBasicMaterialComponentForWorker(state, componentDataMap) {
  var state$1 = DisposeBasicMaterialMainService$Wonderjs.handleBatchDisposeComponent(componentDataMap, state);
...
function batchDisposeLightMaterialComponent(state, componentDataMap) {
  return DisposeLightMaterialMainService$Wonderjs.handleBatchDisposeComponent(componentDataMap, state);
}

function batchDisposeLightMaterialComponentForWorker(state, componentDataMap) {
  var state$1 = DisposeLightMaterialMainService$Wonderjs.handleBatchDisposeComponent(componentDataMap, state);
