...
function deferDisposeBasicMaterialComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedBasicMaterialArray */10] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedBasicMaterialArray */10]);
  newrecord$1[/* basicMaterialMap */26] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* basicMaterialMap */26]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeLightMaterialComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedLightMaterialArray */11] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedLightMaterialArray */11]);
  newrecord$1[/* lightMaterialMap */27] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* lightMaterialMap */27]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeBoxGeometryComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedBoxGeometryArray */12] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedBoxGeometryArray */12]);
...
function deferDisposeCustomGeometryComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedCustomGeometryArray */13] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedCustomGeometryArray */13]);
  newrecord$1[/* geometryDataMap */21] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* geometryDataMap */21]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeSourceInstanceComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedSourceInstanceArray */14] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedSourceInstanceArray */14]);
  newrecord$1[/* sourceInstanceMap */28] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* sourceInstanceMap */28]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeObjectInstanceComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedObjectInstanceArray */15] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedObjectInstanceArray */15]);
  newrecord$1[/* objectInstanceMap */29] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* objectInstanceMap */29]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeDirectionLightComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedDirectionLightArray */16] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedDirectionLightArray */16]);
  newrecord$1[/* directionLightMap */30] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* directionLightMap */30]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposePointLightComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedPointLightArray */17] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedPointLightArray */17]);
  newrecord$1[/* pointLightMap */31] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* pointLightMap */31]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeMeshRendererComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedMeshRendererComponentArray */18] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedMeshRendererComponentArray */18]);
  newrecord$1[/* disposedMeshRendererUidArray */19] = ArrayService$Wonderjs.push(uid, gameObjectRecord[/* disposedMeshRendererUidArray */19]);
  newrecord$1[/* meshRendererMap */25] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* meshRendererMap */25]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
