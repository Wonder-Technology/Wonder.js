...
function deferDisposeBasicCameraViewComponent(uid, component, state) {
  ...
  newrecord$1[/* basicCameraViewMap */25] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* basicCameraViewMap */25]);
...
function deferDisposePerspectiveCameraProjectionComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedPerspectiveCameraProjectionArray */12] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedPerspectiveCameraProjectionArray */12]);
  newrecord$1[/* perspectiveCameraProjectionMap */26] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* perspectiveCameraProjectionMap */26]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeArcballCameraControllerComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedArcballCameraControllerArray */13] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedArcballCameraControllerArray */13]);
  newrecord$1[/* arcballCameraControllerMap */27] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* arcballCameraControllerMap */27]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeTransformComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedTransformArray */10] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedTransformArray */10]);
  newrecord$1[/* transformMap */24] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* transformMap */24]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeTransformComponentForKeepOrder(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedTransformArrayForKeepOrder */11] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedTransformArrayForKeepOrder */11]);
  newrecord$1[/* transformMap */24] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* transformMap */24]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeBasicMaterialComponent(uid, component, state) {
  ...
  newrecord$1[/* disposedBasicMaterialDataArray */14] = ArrayService$Wonderjs.push(/* tuple */[
        uid,
        component
      ], gameObjectRecord[/* disposedBasicMaterialDataArray */14]);
  newrecord$1[/* basicMaterialMap */29] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* basicMaterialMap */29]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeLightMaterialComponent(uid, component, state) {
  ...
  newrecord$1[/* disposedLightMaterialDataArray */15] = ArrayService$Wonderjs.push(/* tuple */[
        uid,
        component
      ], gameObjectRecord[/* disposedLightMaterialDataArray */15]);
  newrecord$1[/* lightMaterialMap */30] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* lightMaterialMap */30]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeGeometryComponent(uid, component, state) {
  ...
  newrecord$1[/* disposedGeometryDataArray */16] = ArrayService$Wonderjs.push(/* tuple */[
        uid,
        component
      ], gameObjectRecord[/* disposedGeometryDataArray */16]);
  newrecord$1[/* geometryMap */23] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* geometryMap */23]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeSourceInstanceComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedSourceInstanceArray */17] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedSourceInstanceArray */17]);
  newrecord$1[/* sourceInstanceMap */31] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* sourceInstanceMap */31]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeObjectInstanceComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedObjectInstanceArray */18] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedObjectInstanceArray */18]);
  newrecord$1[/* objectInstanceMap */32] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* objectInstanceMap */32]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeDirectionLightComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedDirectionLightArray */19] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedDirectionLightArray */19]);
  newrecord$1[/* directionLightMap */33] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* directionLightMap */33]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposePointLightComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedPointLightArray */20] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedPointLightArray */20]);
  newrecord$1[/* pointLightMap */34] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* pointLightMap */34]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
...
function deferDisposeMeshRendererComponent(uid, component, state) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var newrecord$1 = Caml_array.caml_array_dup(gameObjectRecord);
  newrecord$1[/* disposedMeshRendererComponentArray */21] = ArrayService$Wonderjs.push(component, gameObjectRecord[/* disposedMeshRendererComponentArray */21]);
  newrecord$1[/* meshRendererMap */28] = ComponentMapService$Wonderjs.removeComponent(uid, gameObjectRecord[/* meshRendererMap */28]);
  newrecord[/* gameObjectRecord */10] = newrecord$1;
  return newrecord;
}
