...
function _batchDisposeSharableComponents(uidArray, param, param$1, state) {
  ...
  var state$2 = isRemoveMaterial ? RemoveComponentGameObjectMainService$Wonderjs.batchRemoveBasicMaterialComponent(state$1, basicMaterialDataMap) : Curry._2(param$1[0], state$1, basicMaterialDataMap);
  ...
  var state$3 = isRemoveMaterial ? RemoveComponentGameObjectMainService$Wonderjs.batchRemoveLightMaterialComponent(state$2, lightMaterialDataMap) : Curry._2(param$1[1], state$2, lightMaterialDataMap);
  return /* tuple */[
          state$3,
          match[1]
        ];
