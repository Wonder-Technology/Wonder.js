...
function batchDispose(param, param$1, state) {
  ...
  var state$5 = DisposeComponentGameObjectMainService$Wonderjs.batchDisposeMeshRendererComponent(param[1], state$4, BatchGetComponentGameObjectMainService$Wonderjs.batchGetMeshRendererComponent(uidArray, state$4));
  var state$6 = Curry._2(batchDisposeBasicMaterialComponentFunc, state$5, BatchGetComponentGameObjectMainService$Wonderjs.batchGetBasicMaterialComponent(uidArray, state$5));
  var state$7 = Curry._2(batchDisposeLightMaterialComponentFunc, state$6, BatchGetComponentGameObjectMainService$Wonderjs.batchGetLightMaterialComponent(uidArray, state$6));
  var state$8 = DisposeComponentGameObjectMainService$Wonderjs.batchDisposeAmbientLightComponent(state$7, BatchGetComponentGameObjectMainService$Wonderjs.batchGetAmbientLightComponent(uidArray, state$7));
