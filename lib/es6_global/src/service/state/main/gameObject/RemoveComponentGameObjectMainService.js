...
function batchRemoveGeometryComponent(state, geometryDataArray) {
  return RemoveGeometryMainService$Wonderjs.handleBatchRemoveComponent(geometryDataArray, state);
}
...
function batchRemoveBasicMaterialComponent(state, basicMaterialDataArray) {
  return RemoveBasicMaterialMainService$Wonderjs.handleBatchRemoveComponent(basicMaterialDataArray, state);
}
...
function batchRemoveLightMaterialComponent(state, lightMaterialDataArray) {
  return RemoveLightMaterialMainService$Wonderjs.handleBatchRemoveComponent(lightMaterialDataArray, state);
}
