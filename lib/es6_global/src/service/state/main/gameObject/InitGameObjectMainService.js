...
function initGameObject(uid, state) {
  ...
  var state$2 = match ? InitPerspectiveCameraProjectionMainService$Wonderjs.initPerspepctiveCameraProjection(match[0], state$1) : state$1;
  var match$1 = GetComponentGameObjectService$Wonderjs.getArcballCameraControllerComponent(uid, gameObjectRecord);
  if (match$1) {
    return InitArcballCameraControllerMainService$Wonderjs.initArcballCameraController(match$1[0], state$2);
  } else {
    return state$2;
  }
}
