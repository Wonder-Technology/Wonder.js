...
function initMaterials(materialIndexArr, gl, param, param$1, state) {
...
function reInitComponents(materialIndices, param, param$1, state) {
  ...
  var state$1 = ClearShaderMainService$Wonderjs.clearShaderCache(state);
  return ArrayService$WonderCommonlib.reduceOneParam((function (state, materialIndex) {
                ...
                ShaderIndexShaderService$Wonderjs.unuseShaderIndex(currentShaderIndex, materialIndex, state[/* shaderRecord */25]);
                ...
                if (match) {
                  ...
                  reInitMaterialFunc(gl, /* tuple */[
                        ...
                        JudgeInstanceMainService$Wonderjs.isSourceInstance(materialIndex, gameObjectsMap, gameObjectRecord),
                        isSupportInstance
                      ], Curry._2(createInitMaterialStateFunc, /* tuple */[
                            index,
                            disposedIndexArray
                          ], state));
                  return state;
