...
function _handleDispose(disposedIndexArray, material, textureCountPerMaterial, basicMaterialRecord) {
  ...
  if (match !== 0) {
    ...
    var newrecord = _disposeData(material, textureCountPerMaterial, basicMaterialRecord).slice();
    newrecord[/* disposedIndexArray */10] = DisposeMaterialService$Wonderjs.addDisposeIndex(material, disposedIndexArray);
    return newrecord;
  }
}
