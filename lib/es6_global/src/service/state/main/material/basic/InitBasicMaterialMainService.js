...
import * as InitInitBasicMaterialService$Wonderjs from "../../../init_material/init_basicMaterial/material/InitInitBasicMaterialService.js";
...
function initMaterials(materialIndexArr, gl, state) {
  ...
  var gameObjectMap = RecordBasicMaterialMainService$Wonderjs.getRecord(state)[/* gameObjectMap */8];
