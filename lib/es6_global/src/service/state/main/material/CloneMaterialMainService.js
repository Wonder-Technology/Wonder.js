...
function _handleNotShareMaterial(sourceComponent, countRangeArr, param, param$1) {
  ...
  var hasShaderIndex = ShaderIndexMapService$Wonderjs.hasShaderIndex(sourceComponent, shaderIndexMap);
  var shaderIndex = hasShaderIndex !== 0 ? ShaderIndexMapService$Wonderjs.unsafeGetShaderIndex(sourceComponent, shaderIndexMap) : -1;
