...
function getName(material, state) {
  return NameService$Wonderjs.getName(material, RecordLightMaterialMainService$Wonderjs.getRecord(state)[/* nameMap */16]);
}

function unsafeGetName(material, state) {
  return NameService$Wonderjs.unsafeGetName(material, RecordLightMaterialMainService$Wonderjs.getRecord(state)[/* nameMap */16]);
}
...
function setName(material, name, state) {
  ...
  newrecord[/* lightMaterialRecord */16] = /* record */[
    ...
    /* nameMap */NameService$Wonderjs.setName(material, name, record[/* nameMap */16]),
