...
function _getData(sourceComponent, state) {
  return /* tuple */[
          OperateLightMaterialMainService$Wonderjs.unsafeGetDiffuseColor(sourceComponent, state),
          OperateLightMaterialMainService$Wonderjs.unsafeGetSpecularColor(sourceComponent, state),
          OperateLightMaterialMainService$Wonderjs.unsafeGetShininess(sourceComponent, state)
        ];
}
...
function handleCloneComponent(sourceComponent, countRangeArr, isShareMaterial, state) {
  return CloneMaterialMainService$Wonderjs.handleCloneComponent(/* tuple */[
              ...
              state[/* lightMaterialRecord */16][/* shaderIndexMap */1],
              state
            ]);
}
