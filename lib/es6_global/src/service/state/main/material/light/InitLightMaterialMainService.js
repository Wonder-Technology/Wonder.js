...
function initMaterials(materialIndexArr, gl, state) {
  ...
  var gameObjectMap = RecordLightMaterialMainService$Wonderjs.getRecord(state)[/* gameObjectMap */10];
...
function handleInitComponent(materialIndex, state) {
  ...
  if (match$1 !== 0) {
    ...
    if (match$2 !== 0) {
      ...
      var materialArrayForWorkerInit = match$3[/* materialArrayForWorkerInit */13];
