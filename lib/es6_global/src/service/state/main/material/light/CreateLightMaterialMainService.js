...
function _initDataWhenCreate(index, lightMaterialRecord) {
  return /* record */[
          ...
          /* textureCountMap */TextureCountMapMaterialService$Wonderjs.setCount(index, TextureCountMapMaterialService$Wonderjs.getDefaultCount(/* () */0), lightMaterialRecord[/* textureCountMap */9]),
