...
function _handleDispose(gameObject, disposedIndexArray, material, textureCountPerMaterial, lightMaterialRecord) {
...
function handleBatchDisposeComponent(materialDataArray, state) {
  ...
  ArrayService$WonderCommonlib.reduceOneParam((function (lightMaterialRecord, param) {
          return _handleDispose(param[0], disposedIndexArray, param[1], textureCountPerMaterial, lightMaterialRecord);
