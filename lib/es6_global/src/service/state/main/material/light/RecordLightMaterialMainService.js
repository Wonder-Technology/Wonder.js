...
function create(state) {
  ...
  state[/* lightMaterialRecord */16] = /* record */[
    ...
    /* textureCountMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
...
function deepCopyForRestore(state) {
  ...
  newrecord[/* lightMaterialRecord */16] = /* record */[
    ...
    /* textureCountMap */SparseMapService$Wonderjs.copy(record[/* textureCountMap */9]),
    ...
    /* gameObjectMap */SparseMapService$Wonderjs.copy(record[/* gameObjectMap */13]),
    /* groupCountMap */SparseMapService$Wonderjs.copy(record[/* groupCountMap */14]),
    /* disposedIndexArray */record[/* disposedIndexArray */15].slice(),
    /* nameMap */SparseMapService$Wonderjs.copy(record[/* nameMap */16]),
