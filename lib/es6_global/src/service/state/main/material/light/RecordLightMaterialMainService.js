...
function deepCopyForRestore(state) {
  ...
  newrecord[/* lightMaterialRecord */16] = /* record */[
    ...
    /* emptyMapUnitArrayMap */CopyTypeArrayService$Wonderjs.deepCopyArrayArray(record[/* emptyMapUnitArrayMap */9]),
    ...
    /* gameObjectsMap */CopyTypeArrayService$Wonderjs.deepCopyArrayArray(record[/* gameObjectsMap */13]),
    /* disposedIndexArray */record[/* disposedIndexArray */14].slice(),
    /* nameMap */SparseMapService$Wonderjs.copy(record[/* nameMap */15]),
