...
function _allocateNewEachData(param, index, param$1) {
  ...
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("newIndicesOffset == newIndices32Offset", "not"), (function () {
...
function _setNewDataToState(_, geometryRecord, param) {
  var match = param[1];
  return /* record */[
...
function getAllAliveGeometrys(index, geometryRecord) {
  return ArrayService$Wonderjs.range(0, index - 1 | 0).filter((function (geometry) {
                return DisposeGeometryMainService$Wonderjs.isAlive(geometry, geometryRecord);
              }));
}
