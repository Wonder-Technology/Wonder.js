...
function deepCopyForRestore(state) {
  ...
  newrecord[/* shaderRecord */25] = RecordShaderService$Wonderjs.deepCopyForRestore(state$1[/* shaderRecord */25]);
  newrecord[/* glslRecord */26] = RecordGLSLService$Wonderjs.deepCopyForRestore(state$1[/* glslRecord */26]);
  newrecord[/* glslSenderRecord */29] = RecordGLSLSenderAllService$Wonderjs.deepCopyForRestore(state$1[/* glslSenderRecord */29]);
  newrecord[/* vboBufferRecord */33] = RecordVboBufferService$Wonderjs.deepCopyForRestore(state$1[/* vboBufferRecord */33]);
  newrecord[/* typeArrayPoolRecord */35] = RecordTypeArrayPoolService$Wonderjs.deepCopyForRestore(state$1[/* typeArrayPoolRecord */35]);
  return newrecord;
}
