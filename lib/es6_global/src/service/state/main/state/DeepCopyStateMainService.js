...
function deepCopyForRestore(state) {
  var state$1 = RecordPointLightMainService$Wonderjs.deepCopyForRestore(RecordDirectionLightMainService$Wonderjs.deepCopyForRestore(RecordAmbientLightMainService$Wonderjs.deepCopyForRestore(RecordSourceInstanceMainService$Wonderjs.deepCopyForRestore(RecordCustomGeometryMainService$Wonderjs.deepCopyForRestore(RecordBoxGeometryMainService$Wonderjs.deepCopyForRestore(RecordLightMaterialMainService$Wonderjs.deepCopyForRestore(RecordBasicMaterialMainService$Wonderjs.deepCopyForRestore(RecordTransformMainService$Wonderjs.deepCopyForRestore(state)))))))));
  ...
  newrecord[/* meshRendererRecord */22] = RecordMeshRendererService$Wonderjs.deepCopyForRestore(state$1[/* meshRendererRecord */22]);
  newrecord[/* shaderRecord */23] = RecordShaderService$Wonderjs.deepCopyForRestore(state$1[/* shaderRecord */23]);
  newrecord[/* glslRecord */24] = RecordGLSLService$Wonderjs.deepCopyForRestore(state$1[/* glslRecord */24]);
  newrecord[/* vboBufferRecord */31] = RecordVboBufferService$Wonderjs.deepCopyForRestore(state$1[/* vboBufferRecord */31]);
  newrecord[/* typeArrayPoolRecord */33] = RecordTypeArrayPoolService$Wonderjs.deepCopyForRestore(state$1[/* typeArrayPoolRecord */33]);
  return newrecord;
}
