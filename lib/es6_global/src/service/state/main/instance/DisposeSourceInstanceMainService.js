...
function handleBatchDisposeComponent(sourceInstanceArray, isKeepOrder, batchDisposeGameObjectFunc, state) {
  ...
  newrecord[/* sourceInstanceRecord */6] = /* Some */[(newrecord$1[/* disposedIndexArray */8] = sourceInstanceRecord[/* disposedIndexArray */8].concat(sourceInstanceArray), newrecord$1)];
  return /* tuple */[
