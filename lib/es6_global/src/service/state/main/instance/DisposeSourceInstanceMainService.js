...
function _disposeObjectInstanceGameObject(objectInstanceGameObjectArr, isKeepOrder, batchDisposeGameObjectFunc, state) {
  return Contract$WonderLog.ensureCheck((function (param) {
                ...
                Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("boxGeometryNeedDisposeVboBufferArr from object instance gameObject should be empty", "is " + (String(boxGeometryNeedDisposeVboBufferArr) + "")), (function () {
                        return Contract$WonderLog.Operators[/* = */0](boxGeometryNeedDisposeVboBufferArr.length, 0);
                      }));
                Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("customGeometryNeedDisposeVboBufferArr from object instance gameObject should be empty", "is " + (String(customGeometryNeedDisposeVboBufferArr) + "")), (function () {
                        return Contract$WonderLog.Operators[/* = */0](customGeometryNeedDisposeVboBufferArr.length, 0);
                      }));
                return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("sourceInstanceNeedDisposeVboBufferArr from object instance gameObject should be empty", "is " + (String(sourceInstanceNeedDisposeVboBufferArr) + "")), (function () {
                              return Contract$WonderLog.Operators[/* = */0](sourceInstanceNeedDisposeVboBufferArr.length, 0);
                            }));
              }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData), Curry._3(batchDisposeGameObjectFunc, objectInstanceGameObjectArr, isKeepOrder, state));
}

function _disposeData(sourceInstance, isKeepOrder, batchDisposeGameObjectFunc, state) {
  ...
  newrecord[/* sourceInstanceRecord */6] = /* record */[
    ...
    /* matrixFloat32ArrayMap */DisposeSourceInstanceAllService$Wonderjs.disposeMatrixFloat32ArrayMap(sourceInstance, MemorySettingService$Wonderjs.getMaxBigTypeArrayPoolSize(state[/* settingRecord */0]), record[/* matrixFloat32ArrayMap */6], state[/* typeArrayPoolRecord */36]),
...
function handleBatchDisposeComponent(sourceInstanceArray, isKeepOrder, batchDisposeGameObjectFunc, state) {
  ...
  return /* tuple */[
          ArrayService$WonderCommonlib.reduceOneParam((function (state, sourceInstance) {
                  return _disposeData(sourceInstance, isKeepOrder, batchDisposeGameObjectFunc, state);
