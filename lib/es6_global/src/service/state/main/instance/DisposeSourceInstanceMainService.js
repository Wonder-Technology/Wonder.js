...
function _disposeObjectInstanceGameObject(objectInstanceGameObjectArr, param, batchDisposeGameObjectFunc, state) {
  return Contract$WonderLog.ensureCheck((function (param) {
                ...
                Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("geometryNeedDisposeVboBufferArr from object instance gameObject should be empty", "is " + (String(geometryNeedDisposeVboBufferArr) + "")), (function () {
...
function _disposeData(sourceInstance, param, batchDisposeGameObjectFunc, state) {
  ...
  newrecord[/* sourceInstanceRecord */6] = /* record */[
    ...
    /* matrixFloat32ArrayMap */DisposeSourceInstanceAllService$Wonderjs.disposeMatrixFloat32ArrayMap(sourceInstance, MemorySettingService$Wonderjs.getMaxBigTypeArrayPoolSize(state[/* settingRecord */0]), record[/* matrixFloat32ArrayMap */6], state[/* typeArrayPoolRecord */35]),
