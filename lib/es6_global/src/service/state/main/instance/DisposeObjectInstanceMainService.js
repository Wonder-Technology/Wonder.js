...
function _unsafeGetSourceInstance(objectInstance, param) {
  return Contract$WonderLog.ensureCheck((function (sourceInstance) {
              ...
              }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData), SparseMapService$WonderCommonlib.unsafeGet(objectInstance, param[/* sourceInstanceMap */1]));
}
