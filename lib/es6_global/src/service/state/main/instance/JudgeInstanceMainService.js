...
function isSourceInstance(materialIndex, gameObjectsMap, gameObjectRecord) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("all gameObjects are or are not sourceInstance", "some are, the others are not"), (function () {
...
function buildMap(index, gameObjectsMap, gameObjectRecord) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (map, materialIndex) {
                return SparseMapService$WonderCommonlib.set(materialIndex, isSourceInstance(materialIndex, gameObjectsMap, gameObjectRecord), map);
