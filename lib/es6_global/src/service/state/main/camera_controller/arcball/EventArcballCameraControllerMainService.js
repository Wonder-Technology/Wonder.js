...
function bindEvent(cameraController, state) {
  ...
  return ManageEventMainService$Wonderjs.onKeyboardEvent(/* KeyDown */10, (function ($$event, state) {
                var match = !_isCombinedKey($$event);
                if (match) {
                  return keydownHandleFunc($$event, state);
                } else {
                  return state;
                }
              }), state$4, undefined, /* () */0);
...
function _disposePointDragStartEventHandleFuncMap(cameraController, state) {
  ...
  if (match !== undefined) {
    ...
    var state$1 = ManageEventMainService$Wonderjs.offCustomGlobalEventByHandleFunc(eventName, Caml_option.valFromOption(match), state);
...
function _disposeKeyDownEventHandleFuncMap(cameraController, state) {
  ...
  if (match !== undefined) {
    var state$1 = ManageEventMainService$Wonderjs.offKeyboardEventByHandleFunc(/* KeyDown */10, Caml_option.valFromOption(match), state);
    var newrecord = Caml_array.caml_array_dup(state$1);
    newrecord[/* arcballCameraControllerRecord */24] = /* record */[
      /* index */arcballCameraControllerRecord[/* index */0],
      /* pointDragStartEventHandleFuncMap */arcballCameraControllerRecord[/* pointDragStartEventHandleFuncMap */1],
