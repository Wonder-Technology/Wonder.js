...
function setTargetByKeyboardEvent(cameraController, keyboardEvent, state) {
  ...
  if (exit === 1) {
    ...
    newrecord[/* arcballCameraControllerRecord */25] = OperateArcballCameraControllerService$Wonderjs.setTarget(cameraController, _computeTarget(cameraController, /* tuple */[
              dx,
              dy
