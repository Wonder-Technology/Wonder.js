...
function initArcballCameraController(cameraController, state) {
  ...
  var state$1 = ManageEventMainService$Wonderjs.onCustomGlobalEvent(NameEventService$Wonderjs.getPointDragEventName(/* () */0), pointDragHandleFunc, newrecord, /* None */0, /* () */0);
  var state$2 = ManageEventMainService$Wonderjs.onCustomGlobalEvent(NameEventService$Wonderjs.getPointScaleEventName(/* () */0), pointScaleHandleFunc, state$1, /* None */0, /* () */0);
  return ManageEventMainService$Wonderjs.onKeyboardEvent(/* KeyDown */7, keydownHandleFunc, state$2, /* None */0, /* () */0);
}
