...
function getPosition(gameObject, state) {
  ...
  return UpdateTransformMainService$Wonderjs.updateAndGetPositionTuple(GetComponentGameObjectService$Wonderjs.unsafeGetTransformComponent(gameObject, gameObjectRecord), state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
}
