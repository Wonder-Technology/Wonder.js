...
function detect(state) {
  ...
  newrecord[/* workerDetectRecord */37] = /* record */[
...
function isSupportSharedArrayBuffer(state) {
  return state[/* workerDetectRecord */37][/* isSupportSharedArrayBuffer */0];
}

function isSupportRenderWorkerAndSharedArrayBuffer(state) {
  return state[/* workerDetectRecord */37][/* isSupportRenderWorkerAndSharedArrayBuffer */1];
}
