...
function _buildStreamArr(param, findFunc, getJobHandleFunc, state) {
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (streamArr, param) {
                ...
                if (match !== undefined) {
                  return OperateMainWorkerJobMainService$Wonderjs.addCustomJobHandleToStreamArr(subJobName, state[/* jobRecord */1][/* workerCustomMainLoopTargetJobMap */7], stateData, ArrayService$Wonderjs.push(Curry._3(findFunc, /* tuple */[
                                      match,
                                      pipelineJobs,
                                      jobHandleMap,
                                      jobs,
                  ...
                  return OperateMainWorkerJobMainService$Wonderjs.addCustomJobHandleToStreamArr(subJobName, state[/* jobRecord */1][/* workerCustomMainLoopTargetJobMap */7], stateData, ArrayService$Wonderjs.push(Curry._2(handleFunc, match$1[/* flags */1], stateData), streamArr));
                }
              }), /* array */[], param[2].filter((function (param) {
                    return !HashMapService$WonderCommonlib.has(param[/* name */0], state[/* jobRecord */1][/* workerCustomMainLoopRemovedDefaultJobMap */9]);
                  })));
}
...
function _getFrameJobName() {
  return "frame";
}

function _findFrameJob(jobs) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("frame job only has one", "not"), (function () {
