...
function addWorkerMainInitJob(param, action, targetHandleFunc, state) {
  ...
  newrecord[/* jobRecord */1] = /* record */[
    ...
    /* workerCustomMainInitSourceJobMap */HashMapService$WonderCommonlib.set(targetJobName, sourceJobName, state[/* jobRecord */1][/* workerCustomMainInitSourceJobMap */5]),
...
function removeWorkerMainInitJob(targetJobName, state) {
  var match = HashMapService$WonderCommonlib.get(targetJobName, state[/* jobRecord */1][/* workerCustomMainInitSourceJobMap */5]);
  if (match !== undefined) {
    var newrecord = Caml_array.caml_array_dup(state);
    var init = state[/* jobRecord */1];
    newrecord[/* jobRecord */1] = /* record */[
      ...
      /* noWorkerCustomInitJobHandleMap */init[/* noWorkerCustomInitJobHandleMap */2],
      /* noWorkerCustomLoopJobHandleMap */init[/* noWorkerCustomLoopJobHandleMap */3],
      /* workerCustomMainInitTargetJobMap */HashMapService$WonderCommonlib.deleteVal(match, state[/* jobRecord */1][/* workerCustomMainInitTargetJobMap */4]),
    ...
    newrecord$1[/* jobRecord */1] = /* record */[
      ...
      /* workerCustomMainInitRemovedDefaultJobMap */HashMapService$WonderCommonlib.set(targetJobName, true, state[/* jobRecord */1][/* workerCustomMainInitRemovedDefaultJobMap */6]),
...
function addWorkerMainLoopJob(param, action, targetHandleFunc, state) {
  ...
  newrecord[/* jobRecord */1] = /* record */[
    ...
    /* workerCustomMainLoopSourceJobMap */HashMapService$WonderCommonlib.set(targetJobName, sourceJobName, state[/* jobRecord */1][/* workerCustomMainLoopSourceJobMap */8]),
    /* workerCustomMainLoopRemovedDefaultJobMap */init[/* workerCustomMainLoopRemovedDefaultJobMap */9]
  ];
  return newrecord;
}
...
function removeWorkerMainLoopJob(targetJobName, state) {
  var match = HashMapService$WonderCommonlib.get(targetJobName, state[/* jobRecord */1][/* workerCustomMainLoopSourceJobMap */8]);
  if (match !== undefined) {
    var newrecord = Caml_array.caml_array_dup(state);
    var init = state[/* jobRecord */1];
    newrecord[/* jobRecord */1] = /* record */[
      ...
      /* workerCustomMainInitSourceJobMap */init[/* workerCustomMainInitSourceJobMap */5],
      /* workerCustomMainInitRemovedDefaultJobMap */init[/* workerCustomMainInitRemovedDefaultJobMap */6],
      /* workerCustomMainLoopTargetJobMap */HashMapService$WonderCommonlib.deleteVal(match, state[/* jobRecord */1][/* workerCustomMainLoopTargetJobMap */7]),
      /* workerCustomMainLoopSourceJobMap */init[/* workerCustomMainLoopSourceJobMap */8],
      /* workerCustomMainLoopRemovedDefaultJobMap */init[/* workerCustomMainLoopRemovedDefaultJobMap */9]
    ];
    return newrecord;
    ...
    newrecord$1[/* jobRecord */1] = /* record */[
      ...
      /* workerCustomMainLoopTargetJobMap */init$1[/* workerCustomMainLoopTargetJobMap */7],
      /* workerCustomMainLoopSourceJobMap */init$1[/* workerCustomMainLoopSourceJobMap */8],
      /* workerCustomMainLoopRemovedDefaultJobMap */HashMapService$WonderCommonlib.set(targetJobName, true, state[/* jobRecord */1][/* workerCustomMainLoopRemovedDefaultJobMap */9])
    ];
    return newrecord$1;
  }
}
