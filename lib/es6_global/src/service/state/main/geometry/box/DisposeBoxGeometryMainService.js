...
function _disposeData(geometry, boxGeometryRecord) {
  var disposedIndexArray = boxGeometryRecord[/* disposedIndexArray */6];
  return /* record */[
          ...
          /* gameObjectMap */DisposeComponentService$Wonderjs.disposeSparseMapData(geometry, boxGeometryRecord[/* gameObjectMap */4]),
          /* groupCountMap */DisposeComponentService$Wonderjs.disposeSparseMapData(geometry, boxGeometryRecord[/* groupCountMap */5]),
...
function handleBatchDisposeComponent(geometryArray, state) {
  ...
  return /* tuple */[
          (newrecord[/* boxGeometryRecord */20] = match[1], newrecord),
          match[0]
        ];
}
