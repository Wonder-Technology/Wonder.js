...
function getVertices(index, state) {
  ...
  return ReallocatedPointsGeometryService$Wonderjs.getFloat32PointData(BufferCustomGeometryService$Wonderjs.getInfoIndex(index), match[/* vertices */2], match[/* verticesInfos */5]);
}
...
function setVerticesByTypeArray(index, data, state) {
  ...
  record[/* verticesOffset */8] = ReallocatedPointsGeometryService$Wonderjs.setFloat32PointData(BufferCustomGeometryService$Wonderjs.getInfoIndex(index), record[/* verticesInfos */5], verticesOffset, data.length, (function (param) {
