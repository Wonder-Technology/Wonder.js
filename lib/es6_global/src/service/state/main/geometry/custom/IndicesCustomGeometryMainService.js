...
function setIndicesByTypeArray(index, data, state) {
  ...
  record[/* indicesOffset */10] = ReallocatedPointsGeometryService$Wonderjs.setUint16PointData(BufferCustomGeometryService$Wonderjs.getInfoIndex(index), record[/* indicesInfos */7], indicesOffset, data.length, (function (param) {
