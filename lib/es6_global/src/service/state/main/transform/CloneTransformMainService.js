...
function handleCloneComponent(sourceComponent, countRangeArr, state) {
  ...
  var match = ArrayService$WonderCommonlib.reduceOneParam((function (param, _) {
          ...
          var index = match[1];
          return /* tuple */[
                  DirtyTransformService$Wonderjs.mark(index, /* true */1, ModelMatrixTransformService$Wonderjs.setLocalPositionByTuple(index, localPosition, match[0])),
  ...
  state[/* transformRecord */11] = /* Some */[DirtyTransformService$Wonderjs.mark(sourceComponent, /* true */1, match[0])];
  return /* tuple */[
          state,
          match[1]
        ];
