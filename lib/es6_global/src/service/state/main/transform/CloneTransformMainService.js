...
function handleCloneComponent(sourceComponent, countRangeArr, state) {
  ...
  var match = ArrayService$WonderCommonlib.reduceOneParam((function (param, _) {
          ...
          var index = match[1];
          return /* tuple */[
                  DirtyTransformService$Wonderjs.mark(index, true, ModelMatrixTransformService$Wonderjs.setLocalScaleByTuple(index, localScale, ModelMatrixTransformService$Wonderjs.setLocalRotationByTuple(index, localRotation, ModelMatrixTransformService$Wonderjs.setLocalPositionByTuple(index, localPosition, match[0])))),
