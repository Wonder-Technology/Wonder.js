...
function setDefaultTypeArrData(count, defaultLocalToWorldMatrix, defaultLocalPosition, param) {
...
function _setDefaultTypeArrData(count, defaultLocalToWorldMatrix, defaultLocalPosition, param) {
  return /* tuple */[
          param[0],
          setDefaultTypeArrData(count, defaultLocalToWorldMatrix, defaultLocalPosition, /* tuple */[
                param[1],
                param[2]
              ])
        ];
