...
function _createForWorker(transformCount, defaultDataTuple, param, state) {
  ...
  state[/* transformRecord */11] = /* record */[
    ...
    /* localScales */param[4],
    /* copiedBuffer */Js_primitive.some(match[0]),
    /* copiedLocalToWorldMatrices */Js_primitive.some(match$1[0]),
    /* copiedLocalPositions */Js_primitive.some(match$1[1]),
    /* copiedLocalRotations */Js_primitive.some(match$1[2]),
    /* copiedLocalScales */Js_primitive.some(match$1[3]),
