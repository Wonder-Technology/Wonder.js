...
function setAllTypeArrDataToDefault(count, defaultLocalToWorldMatrix, defaultLocalPosition, param) {
...
function _setAllTypeArrDataToDefault(count, defaultLocalToWorldMatrix, defaultLocalPosition, param) {
  return /* tuple */[
          param[0],
          setAllTypeArrDataToDefault(count, defaultLocalToWorldMatrix, defaultLocalPosition, /* tuple */[
                param[1],
                param[2]
              ])
        ];
...
function _initBufferData(count, defaultLocalToWorldMatrix, defaultLocalPosition) {
  ...
  return _setAllTypeArrDataToDefault(count, defaultLocalToWorldMatrix, defaultLocalPosition, /* tuple */[
              buffer,
              match[0],
              match[1]
            ]);
...
function _createForWorker(transformCount, param, param$1, state) {
  var defaultLocalPosition = param[1];
  var defaultLocalToWorldMatrix = param[0];
  var match = _initBufferData(transformCount, defaultLocalToWorldMatrix, defaultLocalPosition);
  var match$1 = match[1];
...
function create(state) {
  ...
  if (match$2 !== 0) {
    return _createForWorker(transformCount, /* tuple */[
