...
function create(param) {
  return {
          ...
          assembleSAB: (function (sabRelativePath, sab, wholeDependencyRelationMap) {
              return AssembleABSystem$Wonderjs.SAB[/* assemble */7](sabRelativePath, sab, wholeDependencyRelationMap);
            }),
          ...
          getLoadedNeededABCount: (function (abRelativePath, wabRelativePath, state) {
              return ProgressABSystem$Wonderjs.RAB[/* getLoadedNeededABCount */1](abRelativePath, wabRelativePath, state);
            }),
