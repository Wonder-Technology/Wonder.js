...
function replaceMaterial(param, gameObject, param$1, state) {
  ...
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("sourceMeshRenderer === targetMeshRenderer", "not"), (function () {
  ...
  newrecord[/* meshRendererRecord */23] = RenderArrayMeshRendererMainService$Wonderjs.addToRenderGameObjectMap(targetMeshRenderer, gameObject, RecordMeshRendererMainService$Wonderjs.getRecord(state$1), state$1[/* gameObjectRecord */10]);
