...
function create() {
  return /* record */[
          ...
          /* mouseDomEventDataArrMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
          /* keyboardDomEventDataArrMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
          /* touchDomEventDataArrMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0),
          /* customGlobalEventArrMap */HashMapService$WonderCommonlib.createEmpty(/* () */0),
          /* customGameObjectEventArrMap */HashMapService$WonderCommonlib.createEmpty(/* () */0),
...
function _deepCopyDomEventArrMap(domEventArrMap) {
  return SparseMapService$Wonderjs.copy(domEventArrMap).map((function (arr) {
                return arr.slice();
              }));
}

function _deepCopyCustomGlobalEventArrMap(customGlobalEventArrMap) {
  return Js_dict.map(SparseMapService$Wonderjs.copy, customGlobalEventArrMap);
}

function _deepCopyCustomGameObjectEventArrMap(customGameObjectEventArrMap) {
  return Js_dict.map((function (eventArrMap) {
                return SparseMapService$Wonderjs.copy(eventArrMap).map((function (arr) {
                              return arr.slice();
                            }));
