...
function _restoreTypeArrays(currentMeshRecord, targetMeshRecord) {
  ...
  if (match) {
    ...
    RecordMeshRendererMainService$Wonderjs.setAllTypeArrDataToDefault(currentMeshRecord[/* index */0], BufferMeshRendererService$Wonderjs.getDefaultDrawMode(/* () */0), BufferMeshRendererService$Wonderjs.getDefaultIsRender(/* () */0), currentMeshRecord[/* drawModes */2], currentMeshRecord[/* isRenders */3]);
