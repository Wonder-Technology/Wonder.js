...
function restore(currentState, targetState) {
  ...
  newrecord[/* customGeometryRecord */24] = /* Some */[(newrecord$1[/* buffer */1] = currentCustomGeometryRecord$1[/* buffer */1], newrecord$1[/* vertices */2] = currentCustomGeometryRecord$1[/* vertices */2], newrecord$1[/* texCoords */3] = currentCustomGeometryRecord$1[/* texCoords */3], newrecord$1[/* normals */4] = currentCustomGeometryRecord$1[/* normals */4], newrecord$1[/* indices */5] = currentCustomGeometryRecord$1[/* indices */5], newrecord$1)];
  return newrecord;
}
