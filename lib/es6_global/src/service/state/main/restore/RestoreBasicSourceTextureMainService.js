...
function restore(currentState, targetState) {
  ...
  newrecord[/* basicSourceTextureRecord */18] = /* record */[
    ...
    /* needDisposedTextureIndexArray */targetTextureRecord$1[/* needDisposedTextureIndexArray */15],
    /* nameMap */targetTextureRecord$1[/* nameMap */16],
    /* materialsMap */targetTextureRecord$1[/* materialsMap */17]
  ];
  return newrecord;
}
