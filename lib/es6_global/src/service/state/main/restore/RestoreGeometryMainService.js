...
function _restoreTypeArrays(_, currentGeometryRecord, targetGeometryRecord) {
...
function restore(currentState, targetState) {
  ...
  newrecord[/* geometryRecord */22] = (newrecord$1[/* verticesInfos */7] = currentGeometryRecord$1[/* verticesInfos */7], newrecord$1[/* texCoordsInfos */8] = currentGeometryRecord$1[/* texCoordsInfos */8], newrecord$1[/* normalsInfos */9] = currentGeometryRecord$1[/* normalsInfos */9], newrecord$1[/* indicesInfos */10] = currentGeometryRecord$1[/* indicesInfos */10], newrecord$1);
  return newrecord;
}
