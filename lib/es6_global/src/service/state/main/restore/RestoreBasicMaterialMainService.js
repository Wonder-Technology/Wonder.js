...
function restore(gl, currentState, targetState) {
  ...
  var targetState$2 = InitBasicMaterialMainService$Wonderjs.initMaterials(AliveMaterialService$Wonderjs.getAllAliveMaterials(RecordBasicMaterialMainService$Wonderjs.getRecord(targetState$1)[/* gameObjectMap */8]), gl, targetState$1);
