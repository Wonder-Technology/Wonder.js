...
function _resetShaderIndices(state) {
  ...
  newrecord[/* basicMaterialRecord */15] = /* Some */[(newrecord$1[/* shaderIndices */2] = RestoreMaterialService$Wonderjs.resetShaderIndices(record[/* index */0], DefaultTypeArrayValueService$Wonderjs.getDefaultShaderIndex(/* () */0), record[/* shaderIndices */2]), newrecord$1)];
  return newrecord;
}
