...
function restore(currentState, targetState) {
  Contract$WonderLog.requireCheck((function () {
          var currentPrecision = currentState[/* glslRecord */24][/* precision */0];
          var targetPrecision = targetState[/* glslRecord */24][/* precision */0];
  ...
  var targetShaderData = targetState[/* shaderRecord */23];
