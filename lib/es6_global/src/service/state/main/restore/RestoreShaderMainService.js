...
function restore(currentState, targetState) {
  Contract$WonderLog.requireCheck((function () {
          ...
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("currentState->glslRecord->precision and targetState->glslRecord->precision be the same", "not"), (function () {
