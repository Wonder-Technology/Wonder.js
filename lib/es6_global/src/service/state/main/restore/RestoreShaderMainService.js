...
function restore(currentState, targetState) {
  Contract$WonderLog.requireCheck((function (param) {
          var currentPrecision = currentState[/* glslRecord */29][/* precision */0];
          var targetPrecision = targetState[/* glslRecord */29][/* precision */0];
  ...
  var match = currentState[/* shaderRecord */28];
  var currentIndex = match[/* index */0];
  var targetShaderData = targetState[/* shaderRecord */28];
