...
function getMaterialShaderLibDataArrByStaticBranchInstance(param, param$1, resultDataArr) {
  var value = param$1[1];
  return ArrayService$Wonderjs.push(findFirstShaderData(param[0] ? (
...
function getMaterialShaderLibDataArrByDynamicBranch(param, param$1, isPassFunc, resultDataArr) {
  ...
  if (match$1) {
    ...
    return ArrayService$Wonderjs.push(findFirstShaderData(OptionService$Wonderjs.unsafeGetJsonSerializedValue(dynamicBranchShaderLibNameOption), param$1[1]), resultDataArr);
  }
}
...
function getMaterialShaderLibDataArr(param, param$1, param$2, state) {
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (resultDataArr, param) {
                ...
                if (match) {
                  return ArrayService$Wonderjs.push(findFirstShaderData(name, shaderLibs), resultDataArr);
                } else {
