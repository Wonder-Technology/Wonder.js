...
function getMaterialShaderLibDataArrByDynamicBranch(param, param$1, isPassFunc, resultDataArr) {
  ...
  var dynamicBranchShaderLibNameOption = match !== 0 ? GetDataRenderConfigService$Wonderjs.getPass(dynamicBranchData) : GetDataRenderConfigService$Wonderjs.getFail(dynamicBranchData);
  if (dynamicBranchShaderLibNameOption) {
    return ArrayService$Wonderjs.push(findFirstShaderData(dynamicBranchShaderLibNameOption[0], param$1[1]), resultDataArr);
  } else {
