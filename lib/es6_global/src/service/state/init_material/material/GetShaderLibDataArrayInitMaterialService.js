...
function getMaterialShaderLibDataArrByDynamicBranch(param, param$1, isPassFunc, resultDataArr) {
  ...
  if (match$1) {
    ...
    return ArrayService$Wonderjs.push(findFirstShaderData(OptionService$Wonderjs.unsafeGet(dynamicBranchShaderLibNameOption), param$1[1]), resultDataArr);
  }
}
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (resultDataArr, param) {
                ...
                if (match) {
                  ...
                  return getMaterialShaderLibDataArrByType(/* tuple */[
                              materialIndex,
                              OptionService$Wonderjs.unsafeGet(type_),
                              groups,
                              name,
                              isSourceInstance,
                              isSupportInstance
