...
function _initMaterialShader(gl, param, param$1, param$2) {
  ...
  param$1[2](materialIndex, Curry._4(param$1[0], materialIndex, /* tuple */[
            gl,
            GetDataRenderConfigService$Wonderjs.getMaterialShaderLibDataArr(param[1], param[2], /* tuple */[
                  shaders,
                  Curry._1(param$1[3], shaders),
                  GetDataRenderConfigService$Wonderjs.getShaderLibs(renderConfigRecord)
                ])
          ], param$1[1], state), param$2[0][/* shaderIndices */2]);
  return state;
}
...
function init(gl, param, initMaterialFunc, param$1) {
  ...
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("not dispose any material before init", "do"), (function () {
                        return Contract$WonderLog.assertTrue(DisposeMaterialService$Wonderjs.isNotDisposed(materialRecord[/* disposedIndexArray */1]));
                      }));
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (state, materialIndex) {
              ...
              }), param$1[1], ArrayService$Wonderjs.range(0, materialRecord[/* index */0] - 1 | 0));
}
