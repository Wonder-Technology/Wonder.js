...
function _buildVsAndFsByType(param, type_, name, execHandleFunc, glslChunkRecord) {
  var fs = param[1];
  var vs = param[0];
  switch (type_) {
    case "fs" : 
...
function _buildVsAndFs(vs, fs, shaderLibDataArr, execHandleFunc, glslChunkRecord) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (glslTuple, param) {
                ...
                if (glsls) {
                  return ArrayService$WonderCommonlib.reduceOneParam((function (sourceTuple, param) {
                                return _buildVsAndFsByType(sourceTuple, param[/* type_ */0], param[/* name */1], execHandleFunc, glslChunkRecord);
                              }), glslTuple, glsls[0]);
                } else {
                  return glslTuple;
                }
...
function buildGLSLSource(_, shaderLibDataArr, execHandleFunc, param) {
  ...
  var match = _buildVsAndFs(vs, fs, shaderLibDataArr, execHandleFunc, param[1]);
  var fs$1 = match[1];
  var vs$1 = match[0];
