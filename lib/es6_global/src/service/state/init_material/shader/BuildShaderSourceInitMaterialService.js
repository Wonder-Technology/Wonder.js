...
function _generateAttributeSource(shaderLibDataArr) {
  return shaderLibDataArr.reduce((function (result, param) {
                ...
                if (match) {
                  ...
                  var optionalAttributes = OptionService$Wonderjs.unsafeGet(variables)[/* attributes */1];
                  var match$1 = OptionService$Wonderjs.isJsonSerializedValueNone(optionalAttributes);
                  if (match$1) {
                    return result;
                  } else {
                    return result + OptionService$Wonderjs.unsafeGet(optionalAttributes).reduce((function (result, param) {
                                  var type_ = param[/* type_ */2];
                                  var name = param[/* name */0];
                                  if (name !== undefined && type_ !== undefined) {
                                    return result + ("attribute " + (String(type_) + (" " + (String(name) + ";\n  "))));
                                  } else {
                                    return result;
                                  }
                                }), "");
...
function _generateUniformSource(shaderLibDataArr, sourceVarDeclare, sourceFuncDefine, sourceBody) {
  return shaderLibDataArr.reduce((function (result, param) {
                ...
                if (match) {
                  ...
                  var optionalUniforms = OptionService$Wonderjs.unsafeGet(variables)[/* uniforms */0];
                  var match$1 = OptionService$Wonderjs.isJsonSerializedValueNone(optionalUniforms);
                  if (match$1) {
                    return result;
                  } else {
                    return result + OptionService$Wonderjs.unsafeGet(optionalUniforms).filter((function (param) {
                                    var name = param[/* name */0];
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (glslTuple, param) {
                ...
                if (match) {
                  ...
                  return ArrayService$WonderCommonlib.reduceOneParam((function (sourceTuple, param) {
                              ...
                              }), glslTuple, OptionService$Wonderjs.unsafeGet(glsls));
                }
              }), /* tuple */[
              param[0],
              param[1]
