...
function _initNewShader(param, param$1, param$2, param$3) {
  ...
  ShaderIndexShaderService$Wonderjs.setShaderIndex(param[2], shaderIndex, ShaderIndexShaderService$Wonderjs.useShaderIndex(shaderIndex, param$3[0]));
...
function _initShader(materialIndex, param, param$1, param$2) {
  ...
  var match = ShaderIndexShaderService$Wonderjs.getShaderIndex(key, shaderRecord);
  if (match !== undefined) {
