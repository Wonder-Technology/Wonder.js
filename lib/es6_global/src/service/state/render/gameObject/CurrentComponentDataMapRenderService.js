...
function getCurrentGeometryBufferMapAndGetPointsFuncs(type_, vboBufferRecord) {
  if (type_) {
    if (type_ === 1) {
      return /* tuple */[
              /* tuple */[
                vboBufferRecord[/* customGeometryVertexBufferMap */3],
                vboBufferRecord[/* customGeometryNormalBufferMap */4],
                vboBufferRecord[/* customGeometryElementArrayBufferMap */5]
              ],
              /* tuple */[
    ...
    return /* tuple */[
            /* tuple */[
              ...
              vboBufferRecord[/* boxGeometryNormalBufferMap */1],
              vboBufferRecord[/* boxGeometryElementArrayBufferMap */2]
            ],
            /* tuple */[
