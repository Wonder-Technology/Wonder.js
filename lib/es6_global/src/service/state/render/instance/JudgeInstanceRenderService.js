...
function isSupportInstance(state) {
  return JudgeInstanceService$Wonderjs.isSupportInstance(OperateRenderSettingService$Wonderjs.unsafeGetGPU(state[/* settingRecord */18])[/* useHardwareInstance */0], state[/* gpuDetectRecord */14]);
}
