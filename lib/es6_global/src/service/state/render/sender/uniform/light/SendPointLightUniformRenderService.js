...
function _sendAttenuation(index, param, param$1, pointLightRecord) {
  ...
  SendGLSLDataService$Wonderjs.sendFloat(gl, uniformCacheMap, /* tuple */[
        constant,
        GLSLLocationService$Wonderjs.getUniformLocation(program, constant, uniformLocationMap, gl)
      ], GetDataRenderPointLightService$Wonderjs.getConstant(index, pointLightRecord));
  SendGLSLDataService$Wonderjs.sendFloat(gl, uniformCacheMap, /* tuple */[
        linear,
        GLSLLocationService$Wonderjs.getUniformLocation(program, linear, uniformLocationMap, gl)
      ], GetDataRenderPointLightService$Wonderjs.getLiear(index, pointLightRecord));
  SendGLSLDataService$Wonderjs.sendFloat(gl, uniformCacheMap, /* tuple */[
        quadratic,
        GLSLLocationService$Wonderjs.getUniformLocation(program, quadratic, uniformLocationMap, gl)
      ], GetDataRenderPointLightService$Wonderjs.getQuadratic(index, pointLightRecord));
  SendGLSLDataService$Wonderjs.sendFloat(gl, uniformCacheMap, /* tuple */[
        range,
        GLSLLocationService$Wonderjs.getUniformLocation(program, range, uniformLocationMap, gl)
      ], GetDataRenderPointLightService$Wonderjs.getRange(index, pointLightRecord));
...
function send(gl, param, param$1) {
  ...
  ArrayService$WonderCommonlib.reduceOneParam((function (pointLightRecord, index) {
          ...
          SendGLSLDataService$Wonderjs.sendFloat3(gl, uniformCacheMap, /* tuple */[
              ...
              ], GetDataRenderPointLightService$Wonderjs.getColor(index, pointLightRecord));
          SendGLSLDataService$Wonderjs.sendFloat(gl, uniformCacheMap, /* tuple */[
                intensity,
                GLSLLocationService$Wonderjs.getUniformLocation(program, intensity, uniformLocationMap, gl)
              ], GetDataRenderPointLightService$Wonderjs.getIntensity(index, pointLightRecord));
        ...
        }), pointLightRecord, ArrayService$WonderCommonlib.range(0, pointLightRecord[/* index */0] - 1 | 0));
  return /* () */0;
}
