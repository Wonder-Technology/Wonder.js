...
import * as OperateTypeArraySourceTextureService$Wonderjs from "../../../record/all/texture/OperateTypeArraySourceTextureService.js";
...
function update(param, param$1, param$2, param$3) {
  ...
  OperateTypeArraySourceTextureService$Wonderjs.setIsNeedUpdate(param[1], BufferSourceTextureService$Wonderjs.getNotNeedUpdate(/* () */0), param$2[0]);
  return /* () */0;
}

function isNeedUpdate(textureInTypeArray, _, isNeedUpdates, getIsNeedUpdateFunc) {
  return getIsNeedUpdateFunc(textureInTypeArray, isNeedUpdates) === BufferSourceTextureService$Wonderjs.getDefaultIsNeedUpdate(/* () */0);
}
