...
function update(gl, textureInTypeArray, param) {
  ...
  var match = TextureSourceMapService$Wonderjs.getSource(textureInTypeArray, arrayBufferViewSourceTextureRecord[/* sourceMap */9]);
  if (match) {
    var width = OperateTypeArrayArrayBufferViewSourceTextureService$Wonderjs.getWidth(textureInTypeArray, arrayBufferViewSourceTextureRecord[/* widths */7]);
    var height = OperateTypeArrayArrayBufferViewSourceTextureService$Wonderjs.getHeight(textureInTypeArray, arrayBufferViewSourceTextureRecord[/* heights */8]);
    ...
    var flipY = OperateTypeArrayArrayBufferViewSourceTextureService$Wonderjs.getFlipY(/* () */0);
