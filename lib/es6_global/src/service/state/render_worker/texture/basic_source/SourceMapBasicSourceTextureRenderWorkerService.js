...
function _createImageBitmap(_, imageData, state) {
  ...
  var match$1 = DetectBrowserService$Wonderjs.isChrome(browser);
  if (match$1 !== 0) {
    ...
    return Curry._2(_createImageBitmapForChrome, imageData, {
                imageOrientation: match$2 !== 0 ? "flipY" : "none"
              });
  } else {
    var match$3 = DetectBrowserService$Wonderjs.isFirefox(browser);
    if (match$3 !== 0) {
