...
import * as GetDataRenderDirectionLightService$Wonderjs from "../../../../../record/all/light/direction/GetDataRenderDirectionLightService.js";
...
function send(gl, param, param$1) {
  ...
  ArrayService$WonderCommonlib.reduceOneParami((function (directionLightRecord, light, index) {
          ...
          SendGLSLDataService$Wonderjs.sendVec3(gl, uniformCacheMap, /* tuple */[
                direction,
                GLSLLocationService$Wonderjs.getUniformLocationAndCache(program, direction, uniformLocationMap, gl)
