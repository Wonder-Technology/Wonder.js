  ...
  var _compute = function (_index, _normals) {
    while(true) {
      ...
      if (match) {
        ...
        var va = Caml_int32.imul(Curry._2(getIndexFunc, indices, index), 3);
        var vb = Caml_int32.imul(Curry._2(getIndexFunc, indices, index + 1 | 0), 3);
        var vc = Caml_int32.imul(Curry._2(getIndexFunc, indices, index + 2 | 0), 3);
