...
function _checkNotExceedBound(index, typeArray, getLengthFunc) {
  return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("not exceed bound", "exceed"), (function () {
...
function setFloat3(index, record, typeArray) {
  Contract$WonderLog.requireCheck((function () {
          ...
          Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("record.length === 3", "is " + (String(len) + "")), (function () {
...
function setFloat4(index, record, typeArray) {
  Contract$WonderLog.requireCheck((function () {
          var len = record.length;
          Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("record.length === 4", "is " + (String(len) + "")), (function () {
...
function setFloat16(index, record, typeArray) {
  Contract$WonderLog.requireCheck((function () {
          var len = record.length;
          Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("record.length === 16", "is " + (String(len) + "")), (function () {
...
function fillFloat32ArrayWithOffset(targetTypeArr, sourceTypeArr, offset) {
  Contract$WonderLog.requireCheck((function () {
          ...
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("sourceTypeArr.length:" + (String(sourceTypeArrLen) + (" + offset:" + (String(offset) + (" <= targetTypeArr.length:" + (String(targetTypeArrLen) + ""))))), "not"), (function () {
...
export {
  ...
  getFloat32ArraySubarray ,
  fillUint16ArrayWithOffset ,
  fillUint32ArrayWithOffset ,
  getUint16ArraySubarray ,
  getUint32ArraySubarray ,
