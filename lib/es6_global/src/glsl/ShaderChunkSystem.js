...
function _getGLSLChunkMap(state) {
  return state[/* glslChunkRecord */27][/* chunkMap */0];
}

function getChunk(name, state) {
  return Js_option.getExn(HashMapService$WonderCommonlib.get(name, state[/* glslChunkRecord */27][/* chunkMap */0]));
}
...
function create() {
  return /* record */[/* chunkMap */HashMapService$WonderCommonlib.set("webgl1_basic_end_fragment", _buildChunk(/* tuple */[
                    "\n\n",
                    "\n\n"
                  ], "\n\n", /* tuple */[
                    "\n\n",
                    "\n\n"
                  ], "\ngl_FragColor = vec4(totalColor.rgb, totalColor.a);\n"), HashMapService$WonderCommonlib.set("webgl1_basic_fragment", _buildChunk(/* tuple */[
                        "\n\n",
                        "\n\n"
                      ], "\n\n", /* tuple */[
                        "\n\n",
                                                                        ...
                                                                        "\n\n"
                                                                            ...
                                                                            "\n\n"
                                                                                ...
                                                                                "\n\n"
                                                                                    ...
                                                                                    "\n\n",
                                                                                    "\n\n"
                                                                                  ], "\nmat3 normalMatrix = u_normalMatrix;\n"), HashMapService$WonderCommonlib.set("webgl1_noDiffuseMap_fragment", _buildChunk(/* tuple */[
                                                                                        "\n\n",
                                                                                        "\n\n"
                                                                                      ], "\n\n", /* tuple */[
                                                                                        "\n\n",
                                                                                        "\nvec3 getMaterialDiffuse() {\n        return u_diffuse;\n    }\n"
                                                                                      ], "\n\n"), HashMapService$WonderCommonlib.set("webgl1_noEmissionMap_fragment", _buildChunk(/* tuple */[
                                                                                            "\n\n",
                                                                                            "\n\n"
                                                                                          ], "\n\n", /* tuple */[
                                                                                            "\n\n",
                                                                                            "\nvec3 getMaterialEmission() {\n        return vec3(0.0);\n    }\n"
                                                                                          ], "\n\n"), HashMapService$WonderCommonlib.set("webgl1_noLightMap_fragment", _buildChunk(/* tuple */[
                                                                                                "\n\n",
                                                                                                "\n\n"
                                                                                              ], "\n\n", /* tuple */[
                                                                                                "\n\n",
                                                                                                "\nvec3 getMaterialLight() {\n        return vec3(0.0);\n    }\n"
                                                                                              ], "\n\n"), HashMapService$WonderCommonlib.set("webgl1_noNormalMap_fragment", _buildChunk(/* tuple */[
                                                                                                    "\n\n",
                                                                                                    "\n\n"
                                                                                                  ], "\nvarying vec3 v_normal;\n", /* tuple */[
                                                                                                    "\nvec3 getNormal();\n",
                                                                                                    "\nvec3 getNormal(){\n    return v_normal;\n}\n\n#if POINT_LIGHTS_COUNT > 0\nvec3 getPointLightDir(int index){\n    //workaround '[] : Index expression must be constant' error\n    for (int x = 0; x <= POINT_LIGHTS_COUNT; x++) {\n        if(x == index){\n            return getPointLightDirByLightPos(u_pointLights[x].position);\n        }\n    }\n    /*!\n    solve error in window7 chrome/firefox:\n    not all control paths return a value.\n    failed to create d3d shaders\n    */\n    return vec3(0.0);\n}\n#endif\n\n#if DIRECTION_LIGHTS_COUNT > 0\nvec3 getDirectionLightDir(int index){\n    //workaround '[] : Index expression must be constant' error\n    for (int x = 0; x <= DIRECTION_LIGHTS_COUNT; x++) {\n        if(x == index){\n            return getDirectionLightDirByLightPos(u_directionLights[x].position);\n        }\n    }\n\n    /*!\n    solve error in window7 chrome/firefox:\n    not all control paths return a value.\n    failed to create d3d shaders\n    */\n    return vec3(0.0);\n}\n#endif\n\n\nvec3 getViewDir(){\n    return normalize(u_cameraPos - v_worldPosition);\n}\n"
                                                                                                  ], "\n\n"), HashMapService$WonderCommonlib.set("webgl1_noNormalMap_vertex", _buildChunk(/* tuple */[
                                                                                                        "\n\n",
                                                                                                        "\n\n"
                                                                                                      ], "\nvarying vec3 v_normal;\n", /* tuple */[
                                                                                                        "\n\n",
                                                                                                        "\n\n"
                                                                                                      ], "\nv_normal = normalize(normalMatrix * a_normal);\n"), HashMapService$WonderCommonlib.set("webgl1_noShadowMap_fragment", _buildChunk(/* tuple */[
                                                                                                            "\n\n",
                                                                                                            "\n\n"
                                                                                                          ], "\n\n", /* tuple */[
                                                                                                            "\n\n",
                                                                                                            "\nfloat getShadowVisibility() {\n        return 1.0;\n    }\n"
                                                                                                          ], "\n\n"), HashMapService$WonderCommonlib.set("webgl1_noSpecularMap_fragment", _buildChunk(/* tuple */[
                                                                                                                "\n\n",
                                                                                                                "\n\n"
                                                                                                              ], "\n\n", /* tuple */[
                                                                                                                "\n\n",
