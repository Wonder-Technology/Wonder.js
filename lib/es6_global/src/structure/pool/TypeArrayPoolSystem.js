...
function getTypeArrayPoolData(state) {
  return state[/* typeArrayPoolData */31];
}

function getFloat32ArrayPoolMap(state) {
  return state[/* typeArrayPoolData */31][/* float32ArrayPoolMap */0];
}

function getUint16ArrayPoolMap(state) {
  return state[/* typeArrayPoolData */31][/* uint16ArrayPoolMap */1];
}
...
function getFloat32TypeArrayFromPool(count, state) {
  return _getTypeArrayFromPool(count, state[/* typeArrayPoolData */31][/* float32ArrayPoolMap */0]);
}

function getUint16TypeArrayFromPool(count, state) {
  return _getTypeArrayFromPool(count, state[/* typeArrayPoolData */31][/* uint16ArrayPoolMap */1]);
}
...
function deepCopyStateForRestore(state) {
  ...
  newrecord[/* typeArrayPoolData */31] = /* record */[
