...
function getGameTime(state) {
  return TimeControllerService$Wonderjs.getGameTime(state[/* timeControllerRecord */30]);
}

function getFps(state) {
  return TimeControllerService$Wonderjs.getFps(state[/* timeControllerRecord */30]);
}
