...
function getGeometryVertices(geometry, state) {
  Contract$WonderLog.requireCheck((function () {
          return AliveComponentService$Wonderjs.checkComponentShouldAlive(geometry, DisposeGeometryMainService$Wonderjs.isAlive, RecordGeometryMainService$Wonderjs.getRecord(state));
...
function _getAllComponents(disposedUidMap, componentMap) {
  return componentMap.filter((function (component, uid) {
                if (SparseMapService$WonderCommonlib.has(uid, disposedUidMap)) {
                  return false;
                } else {
