...
function disposeGameObjectBasicCameraViewComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeBasicCameraViewComponent(component, state);
}
...
function disposeGameObjectPerspectiveCameraProjectionComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposePerspectiveCameraProjectionComponent(component, state);
}
...
function disposeGameObjectTransformComponent(gameObject, component, isKeepOrder, state) {
  ...
  if (isKeepOrder) {
    return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeTransformComponentForKeepOrder(component, state);
  } else {
    return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeTransformComponent(component, state);
  }
}
...
function disposeGameObjectBoxGeometryComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeBoxGeometryComponent(component, state);
}
...
function disposeGameObjectCustomGeometryComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeCustomGeometryComponent(component, state);
}

function unsafeGetGameObjectCustomGeometryComponent(gameObject, state) {
  Contract$WonderLog.requireCheck((function () {
          return _checkGameObjectShouldAlive(gameObject, state);
        }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData));
  return GetComponentGameObjectService$Wonderjs.unsafeGetCustomGeometryComponent(gameObject, state[/* gameObjectRecord */10]);
}

function hasGameObjectCustomGeometryComponent(gameObject, state) {
  Contract$WonderLog.requireCheck((function () {
          return _checkGameObjectShouldAlive(gameObject, state);
        }), IsDebugMainService$Wonderjs.getIsDebug(StateDataMain$Wonderjs.stateData));
  return HasComponentGameObjectService$Wonderjs.hasCustomGeometryComponent(gameObject, state[/* gameObjectRecord */10]);
}
...
function disposeGameObjectBasicMaterialComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeBasicMaterialComponent(component, state);
}
...
function disposeGameObjectLightMaterialComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeLightMaterialComponent(component, state);
}
...
function disposeGameObjectAmbientLightComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeAmbientLightComponent(component, state);
}
...
function disposeGameObjectDirectionLightComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeDirectionLightComponent(component, state);
}
...
function disposeGameObjectPointLightComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposePointLightComponent(component, state);
}
...
function disposeGameObjectSourceInstanceComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeSourceInstanceComponent(component, state);
}
...
function disposeGameObjectObjectInstanceComponent(gameObject, component, state) {
  ...
  return DisposeComponentGameObjectMainService$Wonderjs.deferDisposeObjectInstanceComponent(component, state);
}
