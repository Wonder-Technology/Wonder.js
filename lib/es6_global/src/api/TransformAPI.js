...
function setTransformParent(parent, child, state) {
  ...
  state[/* transformRecord */11] = /* Some */[HierachyTransformService$Wonderjs.setParent((parent == null) ? /* None */0 : [parent], child, RecordTransformMainService$Wonderjs.getRecord(state))];
  return state;
}

function setTransformParentKeepOrder(parent, child, state) {
  _checkParentAndChildTransformShouldAlive(parent, child, state);
  state[/* transformRecord */11] = /* Some */[HierachyTransformService$Wonderjs.setParentKeepOrder((parent == null) ? /* None */0 : [parent], child, RecordTransformMainService$Wonderjs.getRecord(state))];
  return state;
}
...
function getTransformPosition(transform, state) {
  ...
  return UpdateTransformMainService$Wonderjs.updateAndGetPositionTuple(transform, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state));
}
...
function setTransformPosition(transform, position, state) {
  ...
  state[/* transformRecord */11] = /* Some */[UpdateTransformMainService$Wonderjs.updateAndSetPositionByTuple(transform, position, state[/* globalTempRecord */32], RecordTransformMainService$Wonderjs.getRecord(state))];
  return state;
}
