...
function _setTransformParent(parent, child, setParentFunc, state) {
  ...
  state[/* transformRecord */11] = setParentFunc((parent == null) ? undefined : Js_primitive.some(parent), child, RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}
...
function setTransformPosition(transform, position, state) {
  ...
  state[/* transformRecord */11] = UpdateTransformMainService$Wonderjs.updateAndSetPositionByTuple(transform, position, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}
...
function setTransformRotation(transform, rotation, state) {
  ...
  state[/* transformRecord */11] = UpdateTransformMainService$Wonderjs.updateAndSetRotationByTuple(transform, rotation, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}
...
function setTransformScale(transform, scale, state) {
  ...
  state[/* transformRecord */11] = UpdateTransformMainService$Wonderjs.updateAndSetScaleByTuple(transform, scale, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}
...
function getTransformEulerAngles(transform, state) {
  ...
  return UpdateTransformMainService$Wonderjs.updateAndGetEulerAnglesTuple(transform, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
}
...
function setTransformEulerAngles(transform, eulerAngles, state) {
  ...
  state[/* transformRecord */11] = UpdateTransformMainService$Wonderjs.updateAndSetEulerAnglesByTuple(transform, eulerAngles, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
  return state;
}
...
function getTransformLocalToWorldMatrixTypeArray(transform, state) {
  return UpdateTransformMainService$Wonderjs.updateAndGetLocalToWorldMatrixTypeArray(transform, state[/* globalTempRecord */34], RecordTransformMainService$Wonderjs.getRecord(state));
}
