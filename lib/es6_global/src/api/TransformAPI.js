...
function setTransformRotation(transform, rotation, state) {
  ...
  state[/* transformRecord */11] = /* Some */[UpdateTransformMainService$Wonderjs.updateAndSetRotationByTuple(transform, rotation, state[/* globalTempRecord */35], RecordTransformMainService$Wonderjs.getRecord(state))];
  return state;
}
...
function setTransformScale(transform, scale, state) {
  ...
  state[/* transformRecord */11] = /* Some */[UpdateTransformMainService$Wonderjs.updateAndSetScaleByTuple(transform, scale, state[/* globalTempRecord */35], RecordTransformMainService$Wonderjs.getRecord(state))];
  return state;
}
...
function lookAt(transform, target, state) {
  ...
  return LookAtTransfromMainService$Wonderjs.lookAt(transform, target, state, /* None */0, /* () */0);
}
...
function lookAtWithUp(transform, target, up, state) {
  ...
  return LookAtTransfromMainService$Wonderjs.lookAt(transform, target, state, /* Some */[up], /* () */0);
}
