...
function setStencilFunc(targetStencilFunc, targetStencilRef, targetStencilMask, state) {
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* deviceManagerRecord */9] = DeviceManagerService$Wonderjs.setStencilFunc(DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */9]), targetStencilFunc, targetStencilRef, targetStencilMask, state[/* deviceManagerRecord */9]);
  return newrecord;
}

function setStencilOp(targetStencilSFail, targetStencilDPFail, targetStencilDPPass, state) {
  var newrecord = Caml_array.caml_array_dup(state);
  newrecord[/* deviceManagerRecord */9] = DeviceManagerService$Wonderjs.setStencilOp(DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */9]), targetStencilSFail, targetStencilDPFail, targetStencilDPPass, state[/* deviceManagerRecord */9]);
  return newrecord;
}
