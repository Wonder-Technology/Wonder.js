...
function _removeImageDuplicateBufferData(param, param$1, buffer) {
  var bufferViews = param$1[/* bufferViews */7];
...
function _removeGeometryDuplicateBufferData(param, param$1, param$2, buffer) {
  var bufferViews = param$2[/* bufferViews */7];
...
function removeRABDuplicateBufferData(dependencyRelation, param, param$1) {
  ...
  var jsonUint8Array = BuildSingleRABJsonDataSystem$Wonderjs.buildJsonUint8Array(/* record */[
        /* textures */resourceAssetBundleContent[/* textures */0],
        /* images */match$1[0],
        /* basicMaterials */resourceAssetBundleContent[/* basicMaterials */2],
        /* lightMaterials */resourceAssetBundleContent[/* lightMaterials */3],
        /* geometrys */match$2[0],
        /* scriptEventFunctions */resourceAssetBundleContent[/* scriptEventFunctions */5],
        /* scriptAttributes */resourceAssetBundleContent[/* scriptAttributes */6],
  ...
  if (images !== undefined) {
    ...
    var match = ArrayService$WonderCommonlib.reduceOneParam((function (param, imageData) {
            ...
            if (match) {
              ...
              var arrayBuffer = _getArrayBufferFromBufferViews(buffer, imageData[/* bufferView */1], bufferViews);
              var byteLength = arrayBuffer.byteLength;
              var alignedByteLength = BufferUtils$Wonderjs.alignedLength(byteLength);
...
function _removeGeometryDuplicateBufferData$1(param, param$1, sceneAssetBundleContent, buffer) {
  ...
  var match = ArrayService$WonderCommonlib.reduceOneParam((function (param, geometryData) {
          ...
          if (match) {
            ...
            var name = geometry[/* name */0];
            var match$1 = BuildGeometryDataUtils$Wonderjs.getPointSize(/* () */0);
            ...
            var match$4 = _buildGeometryAttributeBufferData(/* tuple */[
                  name,
                  sabRelativePath,
                  dependencyRelation,
                  allRabGeometryNameMap
            ...
            var match$5 = _buildGeometryIndexBufferData(/* tuple */[
                  name,
                  sabRelativePath,
                  dependencyRelation,
                  allRabGeometryNameMap
                ], dataViewArr, match$1[3], sceneAssetBundleContent, /* tuple */[
                  imageBufferViewIndex,
                  geometry[/* index */4],
                  match$4[1],
                  match$4[2],
        ...
        /* array */[],
        imageAlignedByteLength
      ], sceneAssetBundleContent[/* geometrys */16]);
...
function removeSABDuplicateBufferData(dependencyRelation, param, param$1) {
  ...
  var jsonUint8Array = BuildSingleSABJsonDataSystem$Wonderjs.buildJsonUint8Array((newrecord[/* bufferViews */8] = imageBufferViewArr.concat(geometryBufferViewArr), newrecord[/* accessors */9] = match$2[2], newrecord[/* geometrys */16] = match$2[0], newrecord));
