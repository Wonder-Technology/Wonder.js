...
function _getLoadedSABCount(abRelativePath, state) {
...
function getLoadedNeededABCount(abRelativePath, wabRelativePath, state) {
  return _getLoadedDependencyRABCount(abRelativePath, wabRelativePath, state) + _getLoadedSABCount(abRelativePath, state) | 0;
}

var RAB = /* module */[
  /* getAllNeededABCount */getAllNeededABCount,
  /* _getLoadedDependencyRABCount */_getLoadedDependencyRABCount,
  /* _getLoadedSABCount */_getLoadedSABCount,
