...
function sendUniformRenderObjectModelData(gl, shaderIndex, transformIndex, getRenderDataSubState, state) {
  ArrayService$WonderCommonlib.forEach((function (param) {
          var pos = param[/* pos */0];
...
function sendUniformRenderObjectMaterialData(gl, shaderIndex, materialIndex, getRenderDataSubState, state) {
  ArrayService$WonderCommonlib.forEach((function (param) {
          return param[/* sendDataFunc */4](gl, param[/* shaderCacheMap */0], /* tuple */[
                      param[/* name */1],
                      param[/* pos */2]
                    ], param[/* getDataFunc */3](materialIndex, getRenderDataSubState));
        }), HandleUniformRenderObjectMaterialService$Wonderjs.unsafeGetUniformSendData(shaderIndex, state[/* glslSenderRecord */3]));
  return state;
}
...
function render(gl, param, bindAndUpdateFunc, state) {
  ...
  sendUniformRenderObjectModelData(gl, shaderIndex, param[0], getRenderDataSubState, state$2);
  ...
  if (exit === 1) {
    ...
    var state$3 = sendUniformRenderObjectMaterialData(gl, shaderIndex, materialIndex, getRenderDataSubState$1, state$2);
