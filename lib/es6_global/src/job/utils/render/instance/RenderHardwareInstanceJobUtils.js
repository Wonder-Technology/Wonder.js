...
function _sendStaticTransformMatrixData(componentTuple, dataTuple, fillMatrixTypeArrFunc, state) {
  ...
  if (match$3 !== 0) {
    ...
    newrecord[/* sourceInstanceRecord */15] = StaticRenderSourceInstanceService$Wonderjs.markIsSendTransformMatrixData(sourceInstance, /* true */1, state$1[/* sourceInstanceRecord */15]);
    return newrecord;
  }
}
...
function _sendDynamicTransformMatrixData(componentTuple, dataTuple, fillMatrixTypeArrFunc, state) {
  ...
  return _sendTransformMatrixData(componentTuple, dataTuple, fillMatrixTypeArrFunc, (newrecord[/* sourceInstanceRecord */15] = StaticRenderSourceInstanceService$Wonderjs.markIsSendTransformMatrixData(componentTuple[1], /* false */0, state[/* sourceInstanceRecord */15]), newrecord));
}
...
function _unbind(shaderIndex, extension, state) {
  ArrayService$WonderCommonlib.forEach((function (param) {
          ...
          return /* () */0;
        }), HandleAttributeConfigDataService$Wonderjs.unsafeGetInstanceAttributeSendData(shaderIndex, state[/* glslSenderRecord */2]));
  return state;
}
