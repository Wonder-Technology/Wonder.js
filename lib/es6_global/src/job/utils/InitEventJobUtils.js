...
function _fromPCDomEventArr(state) {
  return /* array */[
          ...
          Most.tap((function ($$event) {
                  return _execMouseChangePositionEventHandle(/* MouseDrag */6, $$event, HandleMouseEventMainService$Wonderjs.setLastXYByLocation);
...
function _fromMobileDomEventArr(state) {
  return /* array */[
          ...
          Most.tap((function ($$event) {
                  return _execTouchChangePositionEventHandle(/* TouchMove */12, $$event, HandleTouchEventMainService$Wonderjs.setLastXYWhenTouchMove);
                }), _fromPointDomEvent("touchmove", state)),
          Most.tap((function ($$event) {
                  return _execTouchChangePositionEventHandle(/* TouchDrag */14, $$event, HandleTouchEventMainService$Wonderjs.setLastXYByLocation);
                }), Most.flatMap((function () {
                      return Most.until(Most.tap((function () {
