...
function _bindDomEventToTriggerPointEvent(param, param$1, state) {
  ...
  return Curry._4(param$1[0], param[0], (function (mouseEvent, state) {
                return ManageEventMainService$Wonderjs.triggerCustomGlobalEvent(CreateCustomEventMainService$Wonderjs.create(customEventName, /* Some */[Curry._2(convertDomEventToPointEventFunc, pointEventName, mouseEvent)]), state);
              }), state, /* () */0);
}
  ...
  return _bindDomEventToTriggerPointEvent(/* tuple */[
              ...
              (function (param) {
                  ...
                  return (function (param) {
                      ...
                      return (function (param) {
                          return Curry._2(func$1, param, /* Some */[0]);
                        });
                    });
                }),
