  ...
  return /* array */[
          ...
          Most.tap((function ($$event) {
                  return _execMouseChangePositionEventHandle(/* MouseDragOver */7, $$event, HandleMouseEventMainService$Wonderjs.setLastXYByLocation);
                      ...
                      return Most.until(Most.tap(_execMouseDragDropEventHandle, _fromPointDomEvent("mouseup", state)), _fromPointDomEvent("mousemove", state));
  ...
  return /* array */[
          ...
          Most.tap((function ($$event) {
                  return _execTouchChangePositionEventHandle(/* TouchDragOver */17, $$event, HandleTouchEventMainService$Wonderjs.setLastXYByLocation);
                      ...
                      return Most.until(Most.tap(_execTouchDragDropEventHandle, _fromPointDomEvent("touchend", state)), _fromPointDomEvent("touchmove", state));
                    }), Most.tap(_execTouchDragStartEventHandle, _fromPointDomEvent("touchstart", state))))
        ];
}
