...
function execJob(renderState) {
  var gl = DeviceManagerService$Wonderjs.unsafeGetGl(renderState[/* deviceManagerRecord */16]);
  return ArrayService$WonderCommonlib.reduceOneParam((function (renderState, shaderIndex) {
                var program = ProgramService$Wonderjs.unsafeGetProgram(shaderIndex, renderState[/* programRecord */3]);
                ...
                var renderState$2 = ArrayService$WonderCommonlib.reduceOneParam((function (renderState, param) {
                        param[/* sendDataFunc */2](gl, param[/* pos */0], param[/* getDataFunc */1](renderState));
                        return renderState;
                      }), renderState$1, HandleUniformShaderNoCachableService$Wonderjs.unsafeGetUniformSendData(shaderIndex, renderState$1[/* glslSenderRecord */2]));
                var renderState$3 = ArrayService$WonderCommonlib.reduceOneParam((function (renderState, param) {
                        ...
                        return renderState;
                      }), renderState$2, HandleUniformShaderCachableService$Wonderjs.unsafeGetUniformSendData(shaderIndex, renderState$2[/* glslSenderRecord */2]));
                return ArrayService$WonderCommonlib.reduceOneParam((function (renderState, param) {
                              ...
                              return renderState;
                            }), renderState$3, HandleUniformShaderCachableFunctionService$Wonderjs.unsafeGetUniformSendData(shaderIndex, renderState$3[/* glslSenderRecord */2]));
              }), renderState, ShaderIndexRenderShaderService$Wonderjs.getAllShaderIndexArray(renderState[/* shaderRecord */17]));
}
