...
function execJob(state) {
  ...
  return SetRenderObjectBufferDataMainService$Wonderjs.setData(RenderArrayMeshRendererService$Wonderjs.getLightMaterialRenderArray(meshRendererRecord), GetComponentGameObjectService$Wonderjs.unsafeGetLightMaterialComponent, RecordLightRenderObjectMainService$Wonderjs.getRecord(RecordRenderMainService$Wonderjs.getRecord(state)), state);
}
