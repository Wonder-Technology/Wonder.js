...
function _reallocateCustomGeometryByDisposeCount(state) {
  ...
  newrecord[/* customGeometryRecord */23] = /* Some */[QueryCPUMemoryService$Wonderjs.isDisposeTooMany(customGeometryRecord[/* disposeCount */14], state[/* settingRecord */0]) ? (customGeometryRecord[/* disposeCount */14] = 0, ReallocateCustomGeometryCPUMemoryService$Wonderjs.reAllocate(customGeometryRecord)) : customGeometryRecord];
  return newrecord;
}
