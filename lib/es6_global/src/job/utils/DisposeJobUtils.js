...
function _disposeComponents(batchDisposeBasicMaterialComponentFunc, batchDisposeLightMaterialComponentFunc, state) {
  ...
  var disposedBasicMaterialDataArray = gameObjectRecord[/* disposedBasicMaterialDataArray */15];
  var disposedLightMaterialDataArray = gameObjectRecord[/* disposedLightMaterialDataArray */16];
  var disposedGeometryDataArray = gameObjectRecord[/* disposedGeometryDataArray */17];
