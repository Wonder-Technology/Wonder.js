...
function execJob(param, state) {
  ...
  newrecord[/* deviceManagerRecord */9] = DeviceManagerService$Wonderjs.setGl(GlService$Wonderjs.createGl(ContextConfigSettingService$Wonderjs.convertContextConfigDataToJsObj(OperateSettingService$Wonderjs.unsafeGetContext(state[/* settingRecord */0])), ViewService$Wonderjs.unsafeGetCanvas(state[/* viewRecord */8])), state[/* deviceManagerRecord */9]);
  return newrecord;
}
