...
function execJob(_, state) {
  ...
  newrecord[/* arrayBufferViewSourceTextureRecord */19] = /* record */[
    ...
    /* glTextureMap */InitTextureService$Wonderjs.initTextures(DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */9]), ArrayService$Wonderjs.range(0, arrayBufferViewSourceTextureRecord[/* index */0] - 1 | 0), arrayBufferViewSourceTextureRecord[/* glTextureMap */12]),
