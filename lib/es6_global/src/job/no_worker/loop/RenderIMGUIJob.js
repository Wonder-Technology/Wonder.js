...
function execJob(flags, state) {
  return IOIMGUIMainService$Wonderjs.resetPointEventStateWhenPointUp(ManageIMGUIService$WonderImgui.render(DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */9]), RecordIMGUIMainService$Wonderjs.getIOData(state), RecordIMGUIAPIMainService$Wonderjs.getIMGUIAPIJsObj(state), /* tuple */[
