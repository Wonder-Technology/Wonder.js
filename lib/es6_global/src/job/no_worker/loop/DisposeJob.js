...
function execJob(flags, state) {
  ...
  newrecord[/* vboBufferRecord */34] = DisposeVboBufferService$Wonderjs.disposeSourceInstanceVboBuffer(match[2], DisposeVboBufferService$Wonderjs.disposeGeometryVboBuffer(match[1], state$1[/* vboBufferRecord */34]));
  return newrecord;
}
