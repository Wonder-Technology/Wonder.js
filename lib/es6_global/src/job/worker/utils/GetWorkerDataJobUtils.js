...
function execJob(flags, stateData) {
  return GetWorkerDataUtils$Wonderjs.createGetOtherWorkerDataStream(flags, WorkerInstanceService$Wonderjs.unsafeGetRenderWorker(StateDataMainService$Wonderjs.unsafeGetState(stateData)[/* workerInstanceRecord */34]));
}
