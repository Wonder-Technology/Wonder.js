...
function execNoDataJob(flags, stateData) {
  return GetWorkerDataUtils$Wonderjs.createGetOtherWorkerNoDataStream(flags, WorkerInstanceService$Wonderjs.unsafeGetRenderWorker(StateDataMainService$Wonderjs.unsafeGetState(stateData)[/* workerInstanceRecord */36]));
}

function createGetOtherWorkerDataStream(flags, stateData) {
  return GetWorkerDataUtils$Wonderjs.createGetOtherWorkerDataStream(flags, WorkerInstanceService$Wonderjs.unsafeGetRenderWorker(StateDataMainService$Wonderjs.unsafeGetState(stateData)[/* workerInstanceRecord */36]));
}
