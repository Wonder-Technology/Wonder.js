...
function execNoDataJob(flags, stateData) {
  return GetWorkerDataUtils$Wonderjs.createGetOtherWorkerNoDataStream(flags, WorkerInstanceService$Wonderjs.unsafeGetRenderWorker(StateDataMainService$Wonderjs.unsafeGetState(stateData)[/* workerInstanceRecord */37]));
}
