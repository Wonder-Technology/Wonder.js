...
function execJob(_, stateData) {
  return MostUtils$Wonderjs.callFunc((function () {
                ...
                state[/* viewRecord */8] = ViewService$Wonderjs.setCanvas(ScreenService$Wonderjs.setToFullScreen(ScreenService$Wonderjs.queryFullScreenData(/* () */0), ViewService$Wonderjs.getCanvas(viewRecord)), state[/* viewRecord */8]);
