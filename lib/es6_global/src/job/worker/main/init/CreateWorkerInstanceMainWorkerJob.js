...
function execJob(param, stateData) {
  ...
  state[/* workerInstanceRecord */37] = WorkerInstanceService$Wonderjs.initWorkInstances(OperateRenderWorkerJobService$Wonderjs.getSetting(state[/* workerJobRecord */3])[/* workerFileDir */0], state[/* workerInstanceRecord */37]);
