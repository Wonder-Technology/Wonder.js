...
function _buildData(operateType, canvas, stateData) {
  ...
  return {
          ...
          basicMaterialData: {
            ...
            isSourceInstanceMap: JudgeInstanceMainService$Wonderjs.buildMap(basicMaterialRecord[/* index */0], RecordBasicMaterialMainService$Wonderjs.getRecord(state)[/* gameObjectMap */6], gameObjectRecord)
          },
          lightMaterialData: {
            ...
            isSourceInstanceMap: JudgeInstanceMainService$Wonderjs.buildMap(lightMaterialRecord[/* index */0], RecordLightMaterialMainService$Wonderjs.getRecord(state)[/* gameObjectMap */10], gameObjectRecord)
          },
          customGeometryData: {
