...
function execJob(_, stateData) {
  return MostUtils$Wonderjs.callFunc((function () {
                ...
                state[/* transformRecord */11] = /* Some */[(newrecord[/* copiedBuffer */4] = /* Some */[CopyArrayBufferService$Wonderjs.copyArrayBufferSpecificData(transformRecord[/* buffer */1], CopyTransformService$Wonderjs.unsafeGetCopiedBuffer(transformRecord), BufferTransformService$Wonderjs.getTotalByteLength(index))], newrecord)];
