...
function _sendDisposeData(operateType, needDisposeVboBufferArrTuple, state) {
  return WorkerService$Wonderjs.postMessage(_buildData(operateType, needDisposeVboBufferArrTuple), WorkerInstanceService$Wonderjs.unsafeGetRenderWorker(state[/* workerInstanceRecord */34]));
}
