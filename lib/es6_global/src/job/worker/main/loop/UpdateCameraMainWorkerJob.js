...
function execJob(flags, stateData) {
  return MostUtils$Wonderjs.callFunc((function (param) {
                ...
                var state$1 = UpdateFlyCameraControllerMainService$Wonderjs.update(UpdateArcballCameraControllerMainService$Wonderjs.update(UpdatePerspectiveCameraProjectionMainService$Wonderjs.update(state)));
