...
function _buildData(operateType, stateData) {
  ...
  return {
          ...
          initData: {
            materialData: {
              basicMaterialData: {
                materialDataForWorkerInit: ArrayService$WonderCommonlib.removeDuplicateItems(basicMaterialRecord[/* materialArrayForWorkerInit */9]).reduce((function (arr, materialIndex) {
                        return ArrayService$Wonderjs.push(/* tuple */[
                                    materialIndex,
                                    JudgeInstanceMainService$Wonderjs.isSourceInstance(materialIndex, basicMaterialRecord[/* gameObjectMap */6], gameObjectRecord)
                                  ], arr);
                      }), /* array */[])
              },
              lightMaterialData: {
                materialDataForWorkerInit: ArrayService$WonderCommonlib.removeDuplicateItems(lightMaterialRecord[/* materialArrayForWorkerInit */13]).reduce((function (arr, materialIndex) {
                        return ArrayService$Wonderjs.push(/* tuple */[
                                    materialIndex,
                                    JudgeInstanceMainService$Wonderjs.isSourceInstance(materialIndex, lightMaterialRecord[/* gameObjectMap */10], gameObjectRecord)
                                  ], arr);
                      }), /* array */[])
              }
            }
          ...
          renderData: {
            ...
            basic: {
              ...
              bufferCount: BufferSettingService$Wonderjs.getBasicMaterialDataBufferCount(settingRecord)
            },
            light: {
              buffer: lightRenderObjectRecord[/* buffer */0],
              count: lightRenderObjectRecord[/* count */1],
              bufferCount: BufferSettingService$Wonderjs.getLightMaterialDataBufferCount(settingRecord)
            },
            sourceInstance: {
