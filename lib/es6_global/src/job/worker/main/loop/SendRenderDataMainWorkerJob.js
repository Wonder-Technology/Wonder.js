...
function _buildData(operateType, stateData) {
  ...
  return {
          ...
          initData: {
            materialData: {
              basicMaterialData: {
                materialDataForWorkerInit: _buildMaterialData(basicMaterialRecord[/* materialArrayForWorkerInit */9], basicMaterialRecord[/* gameObjectMap */6], gameObjectRecord)
              },
              lightMaterialData: {
                materialDataForWorkerInit: _buildMaterialData(lightMaterialRecord[/* materialArrayForWorkerInit */13], lightMaterialRecord[/* gameObjectMap */10], gameObjectRecord)
              }
            }
          },
          renderData: {
