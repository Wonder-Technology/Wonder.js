...
function _buildIMGUIData(state) {
  ...
  if (match) {
    ...
    return /* tuple */[
            ...
            {
              ioData: ioData,
              customData: match$1 !== undefined ? Js_primitive.some(SerializeService$Wonderjs.serializeValueWithFunction(Js_primitive.valFromOption(match$1))) : undefined,
              imguiFunc: match$2 !== undefined ? Js_primitive.some(SerializeService$Wonderjs.serializeFunction(Js_primitive.valFromOption(match$2))) : undefined
            }
          ];
  }
}
  ...
  return /* tuple */[
          state$1,
          {
            ...
            initData: {
              materialData: {
                basicMaterialData: {
                  materialDataForWorkerInit: _buildMaterialData(basicMaterialRecord[/* materialArrayForWorkerInit */11], basicMaterialRecord[/* gameObjectsMap */8], gameObjectRecord)
                },
                lightMaterialData: {
