...
import * as CreateTypeArrayAllTransformService$Wonderjs from "../../../../service/record/all/transform/CreateTypeArrayAllTransformService.js";

function _createTypeArrays(buffer, count, state) {
  var match = CreateTypeArrayAllTransformService$Wonderjs.createTypeArrays(buffer, count);
  state[/* transformRecord */19] = /* record */[
