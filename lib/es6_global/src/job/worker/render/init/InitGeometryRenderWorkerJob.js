...
import * as CreateTypeArrayGeometryService$Wonderjs from "../../../../service/record/all/geometry/CreateTypeArrayGeometryService.js";

function _createTypeArrays(buffer, geometryPointCount, geometryCount, indicesTypeMap, state) {
...
function execJob(_, e, stateData) {
  return MostUtils$Wonderjs.callFunc((function () {
                ...
                StateRenderWorkerService$Wonderjs.setState(stateData, _createTypeArrays(buffer, geometryPointCount, geometryCount, indicesTypeMap, state));
                return e;
              }));
}
