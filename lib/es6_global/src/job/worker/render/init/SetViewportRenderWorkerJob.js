...
function execJob(_, e, stateData) {
  return MostUtils$Wonderjs.callFunc((function () {
                ...
                state[/* deviceManagerRecord */4] = DeviceManagerService$Wonderjs.setViewportData(viewportData, DeviceManagerService$Wonderjs.setViewportOfGl(DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */4]), viewportData, state[/* deviceManagerRecord */4]));
