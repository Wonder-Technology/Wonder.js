...
function execJob(param, e, stateData) {
  return MostUtils$Wonderjs.callFunc((function (param) {
                ...
                if (match) {
                  ...
                  var match$1 = CreateTypeArrayAllRenderObjectService$Wonderjs.createTypeArrays(basicRenderData.buffer, basicRenderData.bufferCount);
                  state[/* renderRecord */23][/* basicRenderObjectRecord */0] = /* record */[
