...
function execJob(flags, e, stateData) {
  return MostUtils$Wonderjs.callFunc((function () {
                ...
                var gl = DeviceManagerService$Wonderjs.unsafeGetGl(state[/* deviceManagerRecord */3]);
                state[/* deviceManagerRecord */3] = DeviceManagerService$Wonderjs.clearBuffer(gl, ClearBufferJobUtils$Wonderjs.getBit(gl, JobConfigService$Wonderjs.unsafeGetFlags(flags)), state[/* deviceManagerRecord */3]);
