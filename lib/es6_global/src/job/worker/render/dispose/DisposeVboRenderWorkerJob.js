...
function execJob(flags, e, stateData) {
  return MostUtils$Wonderjs.callFunc((function (param) {
                ...
                state[/* vboBufferRecord */23] = DisposeVboBufferService$Wonderjs.disposeSourceInstanceVboBuffer(data.sourceInstanceNeedDisposeVboBufferArr, DisposeVboBufferService$Wonderjs.disposeGeometryVboBuffer(data.geometryNeedDisposeVboBufferArr, state[/* vboBufferRecord */23]));
