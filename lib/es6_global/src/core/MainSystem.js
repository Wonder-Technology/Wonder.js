...
function _changeConfigToRecord(config) {
  ...
  return /* record */[
          ...
          /* isTest */+JsObjUtils$Wonderjs.getValueFromJsObj(config.isTest, false),
...
function setConfig(config, state) {
  ...
  InitConfigSystem$Wonderjs.setIsTest(config$1[/* isTest */1], StateData$Wonderjs.stateData);
  return /* tuple */[
          config$1,
          state
        ];
...
function init(param) {
  ...
  var gl = DeviceManagerSystem$Wonderjs.createGL(canvas, config[/* contextConfig */2]);
  return GameObjectAdmin$Wonderjs.initDataFromState(GPUDetectSystem$Wonderjs.detect(gl, GpuConfigSystem$Wonderjs.setConfig(config[/* gpuConfig */4], BufferConfigSystem$Wonderjs.setConfig(config[/* bufferConfig */3], ViewSystem$Wonderjs.setContextConfig(config[/* contextConfig */2], ViewSystem$Wonderjs.setCanvas(canvas, DeviceManagerSystem$Wonderjs.setGl(gl, param[1])))))));
}
