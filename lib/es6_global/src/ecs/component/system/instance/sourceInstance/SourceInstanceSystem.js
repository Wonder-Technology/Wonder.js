...
import * as GameObjectComponentCommon$Wonderjs               from "../../../../admin/GameObjectComponentCommon.js";
...
function createInstance(sourceInstance, state) {
  ...
  var state$2 = GameObjectComponentCommon$Wonderjs.addObjectInstanceComponent(uid, match$2[1], GameObjectComponentCommon$Wonderjs.addTransformComponent(uid, match$1[1], match$2[0]));
  return /* tuple */[
          state$2,
          uid
        ];
