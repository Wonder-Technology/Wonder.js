...
import * as RenderJobConfigSystem$Wonderjs     from "../../../../job/render/RenderJobConfigSystem.js";
...
function _initMaterialShader(gl, materialIndex, initShaderFuncTuple, state) {
  ...
  var shaderLibs = RenderJobConfigSystem$Wonderjs.getShaderLibs(state);
  ...
  if (match !== 0) {
    ...
    var shaderIndex = ShaderSystem$Wonderjs.initMaterialShader(materialIndex, /* tuple */[
          gl,
          RenderJobConfigSystem$Wonderjs.getMaterialShaderLibDataArr(gameObject, /* tuple */[
                shaderData,
                shader_libs,
                shaderLibs
              ], state)
