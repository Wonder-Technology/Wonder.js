...
function _initMaterialShader(gl, materialIndex, initShaderFuncTuple, state) {
  ...
  if (match !== 0) {
    ...
    var shaderIndex = ShaderSystem$Wonderjs.initMaterialShader(gl, materialIndex, RenderConfigSystem$Wonderjs.getMaterialShaderLibDataArr(shaderData, gameObject, shader_libs, shaderLibs, state), initShaderFuncTuple, state);
