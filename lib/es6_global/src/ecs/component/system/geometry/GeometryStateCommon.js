...
function restore(currentState, sharedData, targetState) {
  ...
  var match$1 = GeometryTypeArrayPoolCommon$Wonderjs.addAllTypeArrayToPool(MemoryConfigSystem$Wonderjs.getMaxTypeArrayPoolSize(targetState), match[/* verticesMap */1], match[/* indicesMap */2], sharedData[/* float32ArrayPoolMap */1], sharedData[/* uint16ArrayPoolMap */2]);
  return /* tuple */[
          targetState,
          /* record */[
            /* gl */sharedData[/* gl */0],
