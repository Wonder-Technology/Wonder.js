...
var getNormals = GeometryOperateNormalsCommon$Wonderjs.getNormals;

var unsafeGetNormals = GeometryOperateNormalsCommon$Wonderjs.unsafeGetNormals;

var setNormals = GeometryOperateNormalsCommon$Wonderjs.setNormals;
...
function init(state) {
  ...
  return ArraySystem$Wonderjs.reduceState((function (state, geometryIndex) {
                return GeometryInitComponentCommon$Wonderjs.initGeometry(geometryIndex, state);
              }), state, ArraySystem$Wonderjs.range(0, match[/* index */0] - 1 | 0));
}
