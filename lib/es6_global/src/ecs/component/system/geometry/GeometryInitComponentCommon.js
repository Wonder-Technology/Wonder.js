...
function initGeometry(index, state) {
  if (_isInit(index, state)) {
    ...
    if (match$1) {
      ...
      return _markIsInit(index, /* true */1, GeometryOperateIndicesCommon$Wonderjs.setIndicesWithArray(index, match$2[/* indices */1], GeometryOperateVerticesCommon$Wonderjs.setVerticesWithArray(index, match$2[/* vertices */0], state)));
    } else {
      return state;
    }
  }
