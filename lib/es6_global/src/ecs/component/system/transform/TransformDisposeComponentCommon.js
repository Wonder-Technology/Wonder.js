...
function _disposeData(transform, state) {
  ...
  var state$1 = TransformTypeArrayPoolCommon$Wonderjs.addTypeArrayToPool(transform, MemoryConfigSystem$Wonderjs.getMaxTypeArrayPoolSize(state), localToWorldMatrixMap, localPositionMap, state);
