...
function setParent(parent, child, state) {
  _setParent(parent, child, /* false */0, TransformStateCommon$Wonderjs.getTransformData(state));
  return state;
}

function setParentKeepOrder(parent, child, state) {
  _setParent(parent, child, /* true */1, TransformStateCommon$Wonderjs.getTransformData(state));
  return state;
}
