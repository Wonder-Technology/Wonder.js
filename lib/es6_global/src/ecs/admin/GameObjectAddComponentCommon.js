...
function batchAddBasicMaterialComponentForClone(isShareBasicMaterial, uidArr, componentArr, state) {
  ...
  if (isShareBasicMaterial !== 0) {
    return _batchAddSharableComponent(/* tuple */[
                ...
                componentArr,
                componentMap
              ], BasicMaterialGroupCommon$Wonderjs.increaseGroupCount, state);
  } else {
    return _batchAddComponent(/* tuple */[
                uidArr,
                componentArr,
                componentMap
              ], BasicMaterialAddComponentCommon$Wonderjs.handleAddComponent, state);
  }
}

function batchAddLightMaterialComponentForClone(isShareLightMaterial, uidArr, componentArr, state) {
  var componentMap = GameObjectStateCommon$Wonderjs.getGameObjectData(state)[/* lightMaterialMap */9];
  if (isShareLightMaterial !== 0) {
    return _batchAddSharableComponent(/* tuple */[
                uidArr,
                componentArr,
                componentMap
              ], LightMaterialGroupCommon$Wonderjs.increaseGroupCount, state);
  } else {
    return _batchAddComponent(/* tuple */[
                uidArr,
                componentArr,
                componentMap
              ], LightMaterialAddComponentCommon$Wonderjs.handleAddComponent, state);
  }
}
