...
let rec postOrderCata = (
  ~nodeFunc: (WonderEngineCoreType.IWorkForJs.pluginName, TreeType.nodeData, list<TreeType.tree>) => TreeType.tree,
  ~tree: TreeType.tree,
  (),
): TreeType.tree => {
...
//   ~nodeFunc: (option<TreeType.tree>, 'acc, WonderEngineCoreType.IWorkForJs.pluginName, TreeType.nodeData) => 'acc,
//   ~acc: 'acc,
//   ~tree: TreeType.tree,
...
let rec postOrderCataWithParentNode = (
  ~nodeFunc: (
    ...
    WonderEngineCoreType.IWorkForJs.pluginName,
    TreeType.nodeData,
    list<TreeType.tree>,
