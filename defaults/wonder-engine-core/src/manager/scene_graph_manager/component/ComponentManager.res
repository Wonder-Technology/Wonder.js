...
let setComponentData = (
  ...
  dataValue: WonderEngineCoreType.IComponentForJs.dataValue,
): RegisterComponentType.usedComponentData => {
...
let addComponent = (
  data: RegisterComponentType.usedComponentData,
  gameObject: WonderEngineCoreType.IGameObjectForJs.gameObject,
  component: RegisterComponentType.component,
): RegisterComponentType.usedComponentData => {
...
let getComponentData = (
  ...
  component: RegisterComponentType.component,
  dataName: RegisterComponentType.dataName,
): Js.Nullable.t<WonderEngineCoreType.IComponentForJs.dataValue> => {
...
let getComponentGameObjects = (
  data: RegisterComponentType.usedComponentData,
  component: RegisterComponentType.component,
): array<WonderEngineCoreType.IGameObjectForJs.gameObject> => {
  data.getGameObjectsFunc(. data.state, component)
}

let getState = (po: POType.po, componentName: WonderEngineCoreType.IComponentForJs.componentName) => {
