...
declare module 'wonder-commonlib/dist/es2015' {
    ...
    export { assert, describe, it, requireFunc, ensureFunc } from "wonder-commonlib/dist/es2015/typescript/decorator/contract";
...
declare module 'wonder-commonlib/dist/es2015/typescript/decorator/contract' {
    ...
    export function requireFunc(checkFunc: Function, bodyFunc: Function, compileIsTest: boolean, runtimeIsTestFunc: Function): Function;
    export function ensureFunc(checkFunc: Function, bodyFunc: Function, compileIsTest: boolean, runtimeIsTestFunc: Function): Function;
}
...
declare module 'wonder-commonlib/dist/es2015/utils/ExtendUtils' {
    export class ExtendUtils {
        ...
        static assign(source: any, target: any): any;
