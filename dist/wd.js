...
(function (global, factory) {
	...
	exports.JudgeUtils = (function (_super) {
	...
	function cloneAttributeAsBasicType(configData) {
	    return generateCloneableMember(exports.CloneType.BASIC, ExtendUtils.extend({
	        order: 0
	    }, configData));
	}
	function cloneAttributeAsCloneable(configData) {
	    return generateCloneableMember(exports.CloneType.CLONEABLE, ExtendUtils.extend({
	        order: 0
	    }, configData));
	}
	function cloneAttributeAsCustomType(cloneFunc, configData) {
	    return generateCloneableMember(exports.CloneType.CUSTOM, cloneFunc, ExtendUtils.extend({
	        order: 0
	    }, configData));
	}
	exports.CloneUtils = (function () {
	    function CloneUtils() {
	    }
	    CloneUtils.clone = function (sourceInstance, cloneData, createDataArr, target) {
	        ...
	        cloneAttributeMembers.forEach(function (memberData) {
	            ...
	            switch (cloneType) {
	                case exports.CloneType.CLONEABLE:
	                    ...
	                    break;
	                case exports.CloneType.BASIC:
	                    target[memberName] = sourceInstance[memberName];
	                    break;
	                case exports.CloneType.CUSTOM:
	...
	__decorate([
	    requireCheck(function (source, cloneData, createDataArr) {
	        ...
	        if (createDataArr === void 0) { createDataArr = null; }
	        if (createDataArr) {
	            assert(exports.JudgeUtils.isArrayExactly(createDataArr), Log$$1.info.FUNC_MUST_BE("param:createDataArr", "be arr"));
	        }
	    })
	], exports.CloneUtils, "clone", null);
	exports.CloneUtils = __decorate([
	...
	})(exports.CloneType || (exports.CloneType = {}));
	...
	var Camera = (function () {
	    function Camera() {
	        ...
	        this._near = null;
	        this._far = null;
	        this._pMatrix = exports.Matrix4.create();
	    ...
	    Camera.prototype.clone = function () {
	        return exports.CloneUtils.clone(this);
	    };
	...
	})(exports.ETransformState || (exports.ETransformState = {}));
	...
	})(exports.EEngineEvent || (exports.EEngineEvent = {}));
	...
	var Transform = (function (_super) {
	    ...
	    Object.defineProperty(Transform.prototype, "isTranslate", {
	        ...
	        set: function (isTranslate) {
	            this._setGlobalTransformState(exports.ETransformState.ISTRANSLATE, isTranslate);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Transform.prototype, "isRotate", {
	        ...
	        set: function (isRotate) {
	            this._setGlobalTransformState(exports.ETransformState.ISROTATE, isRotate);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Transform.prototype, "isScale", {
	        ...
	        set: function (isScale) {
	            this._setGlobalTransformState(exports.ETransformState.ISSCALE, isScale);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Transform.prototype, "isLocalTranslate", {
	        set: function (isTranslate) {
	            this._setLocalTransformState(exports.ETransformState.ISLOCALTRANSLATE, isTranslate);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Transform.prototype, "isLocalRotate", {
	        set: function (isRotate) {
	            this._setLocalTransformState(exports.ETransformState.ISLOCALROTATE, isRotate);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Transform.prototype, "isLocalScale", {
	        set: function (isScale) {
	            this._setLocalTransformState(exports.ETransformState.ISLOCALSCALE, isScale);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Transform.prototype.init = function () {
	        var self = this;
	        this.clearCache();
	        this._endLoopSubscription = exports.EventManager.fromEvent(exports.EEngineEvent.ENDLOOP)
	            .subscribe(function () {
	...
	if (exports.JudgeUtils.isNodeJs() && typeof global != "undefined") {
	    exports.root = global;
	}
	else {
	    exports.root = window;
	...
	exports.DeviceManager = (function () {
	    function DeviceManager() {
	        ...
	        this._scissorRegion = exports.RectRegion.create();
	        this._viewport = exports.RectRegion.create();
	        ...
	        set: function (polygonOffsetMode) {
	            ...
	            if (this._polygonOffsetMode !== polygonOffsetMode) {
	                switch (polygonOffsetMode) {
	                    case exports.EPolygonOffsetMode.NONE:
	                        gl.polygonOffset(0.0, 0.0);
	                        gl.disable(gl.POLYGON_OFFSET_FILL);
	                        break;
	                    case exports.EPolygonOffsetMode.IN:
	                        gl.enable(gl.POLYGON_OFFSET_FILL);
	                        gl.polygonOffset(1.0, 1.0);
	                        break;
	                    case exports.EPolygonOffsetMode.OUT:
	                        gl.enable(gl.POLYGON_OFFSET_FILL);
	                        gl.polygonOffset(-1.0, -1.0);
	                        break;
	                    case exports.EPolygonOffsetMode.CUSTOM:
	                        gl.enable(gl.POLYGON_OFFSET_FILL);
	    ...
	    DeviceManager.prototype.createGL = function (canvasId, contextConfig, useDevicePixelRatio) {
	        ...
	        this.view = exports.ViewWebGL.create(canvas);
	        if (useDevicePixelRatio) {
	            this.setPixelRatio(exports.root.devicePixelRatio);
	        }
	    ...
	    DeviceManager.prototype.setScreen = function () {
	        ...
	        if (screenSize === exports.EScreenSize.FULL) {
	            x = 0;
	            y = 0;
	            width = exports.root.innerWidth;
	            height = exports.root.innerHeight;
	            styleWidth = "100%";
	            styleHeight = "100%";
	            ...
	            x = screenSize.x || 0;
	            y = screenSize.y || 0;
	            width = screenSize.width || exports.root.innerWidth;
	            height = screenSize.height || exports.root.innerHeight;
	            styleWidth = width + "px";
	...
	], exports.DeviceManager.prototype, "setHardwareScaling", null);
	__decorate([
	    ensure(function (id) {
	...
	], exports.DeviceManager.prototype, "_getCanvasId", null);
	...
	})(exports.EDepthFunction || (exports.EDepthFunction = {}));
	...
	})(exports.EPolygonOffsetMode || (exports.EPolygonOffsetMode = {}));
	...
	})(exports.EBlendFunc || (exports.EBlendFunc = {}));
	...
	})(exports.EBlendType || (exports.EBlendType = {}));

	(function (ECanvasType) {
	    ECanvasType[ECanvasType["TwoDUI"] = "TwoDUI"] = "TwoDUI";
	})(exports.ECanvasType || (exports.ECanvasType = {}));
	...
	var Buffer$1 = (function (_super) {
	    ...
	    Buffer.prototype.dispose = function () {
	        exports.DeviceManager.getInstance().gl.deleteBuffer(this.buffer);
	        delete this.buffer;
	    };
	    return Buffer;
	}(Entity$1));
	...
	})(exports.EBufferUsage || (exports.EBufferUsage = {}));
	...
	var CommonBuffer = (function (_super) {
	    ...
	    CommonBuffer.prototype.resetBufferData = function (glBufferTargetStr, typedData, offset) {
	        if (offset === void 0) { offset = 0; }
	        var gl = exports.DeviceManager.getInstance().gl;
	        if (this.usage === exports.EBufferUsage.STATIC_DRAW && offset === 0) {
	...
	exports.BufferTable = (function () {
	    ...
	    BufferTable.bindIndexBuffer = function (indexBuffer) {
	        ...
	        gl = exports.DeviceManager.getInstance().gl;
	...
	exports.BufferTable.lastBindedArrayBufferListUidStr = null;
	exports.BufferTable.lastBindedElementBuffer = null;
	exports.BufferTable._table = Hash.create();
	exports.BufferTable = __decorate([
	...
	})(exports.BufferTableKey || (exports.BufferTableKey = {}));
	...
	exports.GPUDetector = (function () {
	    ...
	    Object.defineProperty(GPUDetector.prototype, "gl", {
	        get: function () {
	            return exports.DeviceManager.getInstance().gl;
	        },
	        enumerable: true,
	        configurable: true
	    });
	...
	exports.ElementBuffer = (function (_super) {
	    ...
	    ElementBuffer.create = function (data, type, usage) {
	        ...
	        if (usage === void 0) { usage = exports.EBufferUsage.STATIC_DRAW; }
	        var obj = new this();
	    ...
	    ElementBuffer.prototype.initWhenCreate = function (data, type, usage) {
	        var gl = exports.DeviceManager.getInstance().gl, isNeed32Bits = null, typedData = null;
	        ...
	        exports.BufferTable.resetBindedElementBuffer();
	    ...
	    ElementBuffer.prototype.resetData = function (data, type, offset) {
	        if (type === void 0) { type = null; }
	        if (offset === void 0) { offset = 0; }
	        var gl = exports.DeviceManager.getInstance().gl, isNeed32Bits = this._checkIsNeed32Bits(data, type), typedData = this._convertToTypedArray(isNeed32Bits, data);
	        gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, this.buffer);
	        this.resetBufferData("ELEMENT_ARRAY_BUFFER", typedData, offset);
	        this._saveData(typedData, this._getType(isNeed32Bits, type), exports.EBufferUsage.DYNAMIC_DRAW);
	        return this;
	    };
	    ...
	    ElementBuffer.prototype._checkIsNeed32Bits = function (indices, type) {
	        ...
	        if (type !== null) {
	            if (type === exports.EBufferType.UNSIGNED_INT) {
	                return true;
	            }
	            return false;
	        }
	        if (exports.GPUDetector.getInstance().extensionUintIndices) {
	    ...
	    ElementBuffer.prototype._getType = function (isNeed32Bits, type) {
	        return type === null ? (isNeed32Bits ? exports.EBufferType.UNSIGNED_INT : exports.EBufferType.UNSIGNED_SHORT) : type;
	    };
	...
	], exports.ElementBuffer.prototype, "typeSize", null);
	__decorate([
	...
	], exports.ElementBuffer.prototype, "resetData", null);
	__decorate([
	    requireCheck(function (isNeed32Bits, type) {
	        if (type !== null) {
	            if (isNeed32Bits) {
	                assert(type === exports.EBufferType.UNSIGNED_INT, Log$$1.info.FUNC_MUST_BE("type", "UNSIGNED_SHORT, but actual is " + type));
	            }
	            else {
	                assert(type === exports.EBufferType.UNSIGNED_SHORT || type === exports.EBufferType.UNSIGNED_INT, Log$$1.info.FUNC_MUST_BE("type", "UNSIGNED_SHORT or UNSIGNED_INT, but actual is " + type));
	            }
	        }
	    })
	], exports.ElementBuffer.prototype, "_getType", null);
	exports.ElementBuffer = __decorate([
	    registerClass("ElementBuffer")
	], exports.ElementBuffer);
	...
	exports.ArrayBuffer = (function (_super) {
	    ...
	    ArrayBuffer.prototype.initWhenCreate = function (data, size, type, usage) {
	        var gl = exports.DeviceManager.getInstance().gl, typedData = null;
	        this.buffer = gl.createBuffer();
	        if (!this.buffer) {
	            Log$$1.warn('Failed to create the this.buffer object');
	            return null;
	        ...
	        exports.BufferTable.resetBindedArrayBuffer();
	    ...
	    ArrayBuffer.prototype.resetData = function (data, size, type, offset) {
	        ...
	        if (offset === void 0) { offset = 0; }
	        var gl = exports.DeviceManager.getInstance().gl, typedData = this._convertToTypedArray(data, type);
	        gl.bindBuffer(gl.ARRAY_BUFFER, this.buffer);
	        this.resetBufferData("ARRAY_BUFFER", typedData, offset);
	        this._saveData(typedData, size, type, exports.EBufferUsage.DYNAMIC_DRAW);
	        return this;
	    };
	...
	], exports.ArrayBuffer.prototype, "resetData", null);
	exports.ArrayBuffer = __decorate([
	    registerClass("ArrayBuffer")
	], exports.ArrayBuffer);

	var _table = Hash.create();
	_table.addChild(exports.EBufferDataType.VERTICE, "vertices");
	_table.addChild(exports.EBufferDataType.INDICE, "indices");
	exports.BufferDataTable = (function () {
	...
	], exports.BufferDataTable, "getGeometryDataName", null);
	exports.BufferDataTable = __decorate([
	    registerClass("BufferDataTable")
	], exports.BufferDataTable);
	...
	var BufferContainer = (function () {
	    ...
	    BufferContainer.prototype.createOnlyOnceAndUpdateArrayBuffer = function (bufferAttriName, data, size, type, offset, usage) {
	        ...
	        this[bufferAttriName] = exports.ArrayBuffer.create(data, size, type, usage);
	    };
	    BufferContainer.prototype.createOnlyOnceAndUpdateElememntBuffer = function (bufferAttriName, data, type, offset, usage) {
	        ...
	        this[bufferAttriName] = exports.ElementBuffer.create(data, type, usage);
	    };
	    ...
	    BufferContainer.prototype._getIndice = function (type) {
	        ...
	        geometryData = this.geometryData[exports.BufferDataTable.getGeometryDataName(type)];
	...
	var CommonBufferContainer = (function (_super) {
	    ...
	    CommonBufferContainer.prototype.getVertice = function (type) {
	        var geometryData = this.geometryData[exports.BufferDataTable.getGeometryDataName(type)];
	        if (!this.hasData(geometryData)) {
	            return null;
	        }
	...
	exports.BasicBufferContainer = (function (_super) {
	...
	exports.BasicBufferContainer = __decorate([
	    registerClass("BasicBufferContainer")
	], exports.BasicBufferContainer);
	...
	var GeometryData = (function () {
	    ...
	    Object.defineProperty(GeometryData.prototype, "vertices", {
	        ...
	        set: function (vertices) {
	            ...
	            this.geometry.buffers.removeCache(exports.EBufferDataType.VERTICE);
	        },
	        enumerable: true,
	        configurable: true
	    });
	    ...
	    Object.defineProperty(GeometryData.prototype, "faces", {
	        ...
	        set: function (faces) {
	            this._faces = faces;
	            this.geometry.buffers.removeCache(exports.EBufferDataType.INDICE);
	            this.onChangeFace();
	        },
	        enumerable: true,
	        configurable: true
	...
	exports.BasicGeometryData = (function (_super) {
	...
	exports.BasicGeometryData = __decorate([
	    registerClass("BasicGeometryData")
	], exports.BasicGeometryData);
	...
	var Geometry = (function (_super) {
	    ...
	    function Geometry() {
	        ...
	        _this.buffers = null;
	        _this.drawMode = exports.EDrawMode.TRIANGLES;
	        return _this;
	    }
	    Object.defineProperty(Geometry.prototype, "material", {
	        ...
	        set: function (material) {
	            if (!exports.JudgeUtils.isEqual(material, this._material)) {
	    ...
	    Geometry.prototype.createBufferContainer = function () {
	        return exports.BasicBufferContainer.create(this.entityObject);
	    };
	    ...
	    Geometry.prototype.createBasicGeometryData = function (computedData) {
	        var vertices = computedData.vertices, _a = computedData.faces, faces = _a === void 0 ? [] : _a, geometryData = exports.BasicGeometryData.create(this);
	...
	exports.SortUtils = __decorate([
	    registerClass("SortUtils")
	], exports.SortUtils);

	exports.ComponentInitOrderTable = (function () {
	...
	exports.ComponentInitOrderTable = __decorate([
	    registerClass("ComponentInitOrderTable")
	], exports.ComponentInitOrderTable);

	exports.ComponentManager = (function () {
	    ...
	    ComponentManager.prototype.init = function () {
	        for (var _i = 0, _a = exports.SortUtils.insertSort(this._components.getChildren(), function (a, b) {
	            return exports.ComponentInitOrderTable.getOrder(a) < exports.ComponentInitOrderTable.getOrder(b);
	        }); _i < _a.length; _i++) {
	            var component = _a[_i];
	            component.init();
	        }
	    ...
	    ComponentManager.prototype.hasComponent = function () {
	        ...
	        var result = null;
	        if (exports.JudgeUtils.isComponenet(args[0])) {
	...
	], exports.ComponentManager.prototype, "addComponent", null);
	__decorate([
	    requireCheck(function () {
	        var _this = this;
	...
	], exports.ComponentManager.prototype, "getGeometry", null);
	__decorate([
	    requireCheck(function () {
	        var _this = this;
	...
	], exports.ComponentManager.prototype, "getRendererComponent", null);
	exports.ComponentManager = __decorate([
	    registerClass("ComponentManager")
	], exports.ComponentManager);

	exports.EntityObjectManager = (function () {
	    ...
	    EntityObjectManager.prototype.addChildren = function () {
	        ...
	        if (exports.JudgeUtils.isArray(args[0])) {
	            var children = args[0];
	        ...
	        else if (exports.JudgeUtils.isCollection(args[0])) {
	            var children = args[0];
	...
	exports.EntityObjectManager = __decorate([
	    registerClass("EntityObjectManager")
	], exports.EntityObjectManager);
	...
	var EntityObject = (function (_super) {
	    ...
	    function EntityObject() {
	        ...
	        _this.componentManager = exports.ComponentManager.create(_this);
	        _this._hasComponentCache = Hash.create();
	        _this._getComponentCache = Hash.create();
	        _this._componentChangeSubscription = null;
	        _this._entityObjectManager = exports.EntityObjectManager.create(_this);
	        return _this;
	    }
	    ...
	    EntityObject.prototype.clone = function (config) {
	        ...
	        var result = null;
	        if (exports.CloneUtils.isNotClone((this))) {
	            return null;
	        }
	        ...
	        result = exports.CloneUtils.clone(this);
	...
	__decorate([
	        ...
	        it("key:" + key + " be string", function () {
	            index(exports.JudgeUtils.isString(key)).true;
	        });
	    })
	...
	})(exports.EEventName || (exports.EEventName = {}));
	var EVENTNAME_SPLITTER = '|';
	var BROWSER_IDENTIFIER = '*';
	exports.EventNameHandler = (function () {
	...
	exports.EventNameHandler = __decorate([
	    registerClass("EventNameHandler")
	], exports.EventNameHandler);

	var _table$1 = Hash.create();
	_table$1.addChild(exports.EEventName.CLICK, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEMOVE, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEDOWN, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEDRAG, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEOUT, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEOVER, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEUP, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.MOUSEWHEEL, exports.EEventType.MOUSE);
	_table$1.addChild(exports.EEventName.TOUCHMOVE, exports.EEventType.TOUCH);
	_table$1.addChild(exports.EEventName.TOUCHDOWN, exports.EEventType.TOUCH);
	_table$1.addChild(exports.EEventName.TOUCHUP, exports.EEventType.TOUCH);
	_table$1.addChild(exports.EEngineEvent.POINT_TAP, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_OVER, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_OUT, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_MOVE, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_DOWN, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_UP, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_SCALE, exports.EEventType.POINT);
	_table$1.addChild(exports.EEngineEvent.POINT_DRAG, exports.EEventType.POINT);
	_table$1.addChild(exports.EEventName.KEYDOWN, exports.EEventType.KEYBOARD);
	_table$1.addChild(exports.EEventName.KEYPRESS, exports.EEventType.KEYBOARD);
	_table$1.addChild(exports.EEventName.KEYUP, exports.EEventType.KEYBOARD);
	exports.EventTable = (function () {
	    function EventTable() {
	    }
	    EventTable.getEventType = function (eventName) {
	        var result = _table$1.getChild(eventName);
	        if (result === void 0) {
	            result = exports.EEventType.CUSTOM;
	        }
	        return result;
	    };
	    return EventTable;
	}());
	exports.EventTable = __decorate([
	...
	exports.DomEventListenerMap = (function (_super) {
	    ...
	    DomEventListenerMap.prototype.removeChild = function () {
	        ...
	        var result = null;
	        if (args.length === 1 && exports.JudgeUtils.isString(args[0])) {
	        ...
	        else if (args.length === 2 && exports.JudgeUtils.isString(args[0])) {
	        ...
	        else if (args.length === 2 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventName = args[1], secondMap = null;
	            secondMap = this._targetListenerMap.getChild(this.buildFirstLevelKey(dom));
	            if (!secondMap) {
	        ...
	        else if (args.length === 3 && exports.JudgeUtils.isDom(args[0])) {
	...
	exports.DomEventListenerMap = __decorate([
	    registerClass("DomEventListenerMap")
	], exports.DomEventListenerMap);

	exports.DomEventRegister = (function (_super) {
	    __extends(DomEventRegister, _super);
	    function DomEventRegister() {
	        var _this = _super.call(this) || this;
	        _this.listenerMap = exports.DomEventListenerMap.create();
	        return _this;
	    }
	    ...
	    DomEventRegister.prototype.remove = function () {
	        ...
	        else if (args.length === 2 && exports.JudgeUtils.isFunction(args[1])) {
	            var eventName = args[0], handler = args[1];
	            result = this.listenerMap.removeChild(eventName, handler);
	        }
	        else if ((args.length === 2 && exports.JudgeUtils.isDom(args[0])) || args.length === 3) {
	...
	exports.DomEventRegister = __decorate([
	    singleton(),
	    registerClass("DomEventRegister")
	], exports.DomEventRegister);
	...
	var DomEventHandler = (function (_super) {
	    ...
	    DomEventHandler.prototype.off = function () {
	        ...
	        var self = this, eventName = null, dom = null, eventRegister = exports.DomEventRegister.getInstance(), eventOffDataList = null;
	        if (args.length === 1) {
	            eventName = args[0];
	    ...
	    DomEventHandler.prototype.trigger = function () {
	        ...
	        registerDataList = exports.DomEventRegister.getInstance().getEventRegisterDataList(dom, eventName);
	    ...
	    DomEventHandler.prototype.buildDomHandler = function (dom, eventName) {
	        var self = this, context = exports.root;
	    ...
	    DomEventHandler.prototype.handler = function (dom, eventName, handler, priority) {
	        ...
	        if (!exports.DomEventRegister.getInstance().isBinded(dom, eventName)) {
	            domHandler = this._bind(dom, eventName);
	        }
	        else {
	            domHandler = exports.DomEventRegister.getInstance().getDomHandler(dom, eventName);
	        }
	        exports.DomEventRegister.getInstance().register(dom, eventName, this.createEventData(), handler, originHandler, domHandler, priority);
	    };
	    DomEventHandler.prototype._bind = function (dom, eventName) {
	        var domHandler = null;
	        domHandler = this.buildDomHandler(dom, eventName);
	        EventUtils.addEvent(dom, exports.EventNameHandler.handleEventName(eventName), domHandler);
	        return domHandler;
	    };
	    DomEventHandler.prototype._unBind = function (dom, eventName, handler) {
	        EventUtils.removeEvent(dom, exports.EventNameHandler.handleEventName(eventName), handler);
	    };
	...
	var PointEventHandler = (function (_super) {
	    ...
	    PointEventHandler.prototype.triggerDomEvent = function (dom, event, eventName) {
	        ...
	        exports.EventManager.trigger(dom, eventObj);
	    };
	    ...
	    requireCheck(function () {
	        ...
	        if (args.length === 4) {
	            ...
	            it("first param should be HTMLElement", function () {
	                index(exports.JudgeUtils.isDom(dom_1)).true;
	            });
	        }
	    })
	...
	var DomEvent = (function (_super) {
	    ...
	    Object.defineProperty(DomEvent.prototype, "event", {
	        ...
	        set: function (event) {
	            this._event = event || exports.root.event;
	        },
	        enumerable: true,
	        configurable: true
	    });
	...
	})(exports.EMouseButton || (exports.EMouseButton = {}));

	exports.MouseEvent = MouseEvent_1 = (function (_super) {
	    ...
	    function MouseEvent() {
	        ...
	        _this._button = null;
	        _this.type = exports.EEventType.MOUSE;
	        _this.lastX = null;
	        _this.lastY = null;
	        return _this;
	    }
	    ...
	    Object.defineProperty(MouseEvent.prototype, "locationInView", {
	        get: function () {
	            ...
	            point = this.location;
	            viewOffset = exports.DeviceManager.getInstance().view.offset;
	            return exports.Point.create(point.x - viewOffset.x, point.y - viewOffset.y);
	        },
	    ...
	    Object.defineProperty(MouseEvent.prototype, "button", {
	        get: function () {
	            ...
	            if (bowser_3) {
	                switch (e.button) {
	                    case 1:
	                        mouseButton = exports.EMouseButton.LEFT;
	                        break;
	                    case 4:
	                        mouseButton = exports.EMouseButton.RIGHT;
	                        break;
	                    case 2:
	                        mouseButton = exports.EMouseButton.CENTER;
	                        break;
	                    default:
	...
	exports.MouseEvent = MouseEvent_1 = __decorate([
	    registerClass("MouseEvent")
	], exports.MouseEvent);
	var MouseEvent_1;

	exports.MouseEventHandler = (function (_super) {
	    ...
	    MouseEventHandler.prototype.addEngineHandler = function (eventName, handler) {
	        ...
	        switch (eventName) {
	            case exports.EEventName.MOUSEMOVE:
	    ...
	    MouseEventHandler.prototype.createEventObject = function (dom, event, eventName) {
	        var obj = exports.MouseEvent.create(event ? event : exports.root.event, eventName);
	        obj.target = dom;
	        return obj;
	    };
	    return MouseEventHandler;
	}(PointEventHandler));
	exports.MouseEventHandler = __decorate([
	    singleton(),
	    registerClass("MouseEventHandler")
	], exports.MouseEventHandler);

	exports.TouchEvent = TouchEvent_1 = (function (_super) {
	    __extends(TouchEvent, _super);
	    function TouchEvent() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this._location = null;
	        _this._locationInView = null;
	        _this.type = exports.EEventType.TOUCH;
	        _this.lastX = null;
	        _this.lastY = null;
	        return _this;
	    }
	...
	], exports.TouchEvent.prototype, "touchData", null);
	exports.TouchEvent = TouchEvent_1 = __decorate([
	    registerClass("TouchEvent")
	], exports.TouchEvent);
	var TouchEvent_1;

	exports.TouchEventHandler = (function (_super) {
	    ...
	    TouchEventHandler.prototype.addEngineHandler = function (eventName, handler) {
	        var resultHandler = null;
	        switch (eventName) {
	            case exports.EEventName.TOUCHMOVE:
	                resultHandler = this.handleMove(handler);
	                break;
	            default:
	                resultHandler = handler;
	    ...
	    TouchEventHandler.prototype.createEventObject = function (dom, event, eventName) {
	        var obj = exports.TouchEvent.create(event ? event : exports.root.event, eventName);
	        obj.target = dom;
	        return obj;
	    };
	    return TouchEventHandler;
	}(PointEventHandler));
	exports.TouchEventHandler = __decorate([
	    singleton(),
	    registerClass("TouchEventHandler")
	], exports.TouchEventHandler);
	...
	exports.KeyboardEvent = KeyboardEvent_1 = (function (_super) {
	    __extends(KeyboardEvent, _super);
	    function KeyboardEvent() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = exports.EEventType.KEYBOARD;
	        _this.keyState = null;
	        return _this;
	    }
	...
	exports.KeyboardEvent = KeyboardEvent_1 = __decorate([
	    registerClass("KeyboardEvent")
	], exports.KeyboardEvent);
	var KeyboardEvent_1;

	exports.KeyboardEventHandler = (function (_super) {
	    ...
	    KeyboardEventHandler.prototype.addEngineHandler = function (eventName, handler) {
	        var resultHandler = null;
	        switch (eventName) {
	            case exports.EEventName.KEYDOWN:
	                resultHandler = this._handleKeyDown(handler);
	                break;
	            case exports.EEventName.KEYUP:
	    ...
	    KeyboardEventHandler.prototype._createEventObject = function (dom, event, eventName) {
	        var obj = exports.KeyboardEvent.create(event ? event : exports.root.event, eventName);
	        obj.target = dom;
	        return obj;
	    };
	    return KeyboardEventHandler;
	}(DomEventHandler));
	exports.KeyboardEventHandler = __decorate([
	    singleton(),
	    registerClass("KeyboardEventHandler")
	], exports.KeyboardEventHandler);

	exports.CustomEventListenerMap = (function (_super) {
	    ...
	    CustomEventListenerMap.prototype.removeChild = function () {
	        ...
	        else if (args.length === 2 && exports.JudgeUtils.isNumber(args[0])) {
	...
	exports.CustomEventListenerMap = __decorate([
	    registerClass("CustomEventListenerMap")
	], exports.CustomEventListenerMap);

	exports.CustomEventRegister = (function (_super) {
	    __extends(CustomEventRegister, _super);
	    function CustomEventRegister() {
	        var _this = _super.call(this) || this;
	        _this.listenerMap = exports.CustomEventListenerMap.create();
	        return _this;
	    }
	...
	exports.CustomEventRegister = __decorate([
	    singleton(),
	    registerClass("CustomEventRegister")
	], exports.CustomEventRegister);

	exports.CustomEventHandler = (function (_super) {
	    ...
	    CustomEventHandler.prototype.on = function () {
	        ...
	        if (args.length === 3) {
	            ...
	            exports.CustomEventRegister.getInstance().register(eventName, handler, originHandler, null, priority);
	        }
	        else if (args.length === 4) {
	            var target = args[0], eventName = args[1], handler = args[2], originHandler = handler, priority = args[3];
	            exports.CustomEventRegister.getInstance().register(target, eventName, handler, originHandler, null, priority);
	        }
	    };
	    CustomEventHandler.prototype.off = function () {
	        ...
	        var eventRegister = exports.CustomEventRegister.getInstance();
	    ...
	    CustomEventHandler.prototype._triggerEventHandler = function (event, userData) {
	        ...
	        registerDataList = exports.CustomEventRegister.getInstance().getEventRegisterDataList(event.name);
	        if (registerDataList === null || registerDataList.getCount() === 0) {
	            return false;
	        }
	        registerDataList.forEach(function (registerData) {
	    ...
	    CustomEventHandler.prototype._triggerTargetAndEventHandler = function (target, event, userData, notSetTarget) {
	        ...
	        registerDataList = exports.CustomEventRegister.getInstance().getEventRegisterDataList(target, event.name);
	        if (registerDataList === null || registerDataList.getCount() === 0) {
	            return false;
	        }
	        registerDataList.forEach(function (registerData) {
	...
	exports.CustomEventHandler = __decorate([
	    singleton(),
	    registerClass("CustomEventHandler")
	], exports.CustomEventHandler);

	exports.EventHandlerFactory = (function () {
	    function EventHandlerFactory() {
	    }
	    EventHandlerFactory.createEventHandler = function (eventType) {
	        var handler = null;
	        switch (eventType) {
	            case exports.EEventType.MOUSE:
	                handler = exports.MouseEventHandler.getInstance();
	                break;
	            case exports.EEventType.TOUCH:
	                handler = exports.TouchEventHandler.getInstance();
	                break;
	            case exports.EEventType.KEYBOARD:
	                handler = exports.KeyboardEventHandler.getInstance();
	                break;
	            case exports.EEventType.CUSTOM:
	            case exports.EEventType.POINT:
	                handler = exports.CustomEventHandler.getInstance();
	                break;
	            default:
	...
	exports.EventHandlerFactory = __decorate([
	    registerClass("EventHandlerFactory")
	], exports.EventHandlerFactory);

	exports.DomEventBinder = (function (_super) {
	    ...
	    DomEventBinder.prototype.on = function () {
	        ...
	        if (args.length === 2 && exports.JudgeUtils.isString(args[0])) {
	            var eventName = args[0], handler = args[1];
	            exports.EventHandlerFactory.createEventHandler(exports.EventTable.getEventType(eventName))
	                .on(eventName, handler);
	        }
	        else if (args.length === 3 && exports.JudgeUtils.isString(args[0])) {
	    ...
	    DomEventBinder.prototype.off = function () {
	        ...
	        var eventRegister = exports.DomEventRegister.getInstance();
	        if (args.length === 0) {
	        ...
	        else if (args.length === 1 && exports.JudgeUtils.isString(args[0])) {
	            var eventName_1 = args[0];
	            eventRegister.forEachEventName(function (list, registeredEventName) {
	                if (registeredEventName === eventName_1) {
	                    exports.EventHandlerFactory.createEventHandler(exports.EventTable.getEventType(eventName_1))
	                        .off(eventName_1);
	                }
	            });
	        }
	        else if (args.length === 1 && exports.JudgeUtils.isDom(args[0])) {
	...
	exports.DomEventBinder = __decorate([
	    singleton(),
	    registerClass("DomEventBinder")
	], exports.DomEventBinder);

	exports.CustomEventBinder = (function (_super) {
	...
	exports.CustomEventBinder = __decorate([
	    singleton(),
	    registerClass("CustomEventBinder")
	], exports.CustomEventBinder);

	exports.EventBinderFactory = (function () {
	    function EventBinderFactory() {
	    }
	    EventBinderFactory.createEventBinder = function (eventName) {
	        var binder = null, eventType = exports.EventTable.getEventType(eventName);
	        switch (eventType) {
	            case exports.EEventType.MOUSE:
	            case exports.EEventType.TOUCH:
	            case exports.EEventType.KEYBOARD:
	                binder = exports.DomEventBinder.getInstance();
	                break;
	            case exports.EEventType.CUSTOM:
	            case exports.EEventType.POINT:
	                binder = exports.CustomEventBinder.getInstance();
	                break;
	            default:
	...
	exports.EventBinderFactory = __decorate([
	    registerClass("EventBinderFactory")
	], exports.EventBinderFactory);

	exports.CustomEvent = CustomEvent_1 = (function (_super) {
	    ...
	    function CustomEvent() {
	        ...
	        _this.type = exports.EEventType.CUSTOM;
	        _this.userData = null;
	        if (args.length === 2) {
	            var userData = args[1];
	    ...
	    CustomEvent.prototype.copyPublicAttri = function (destination, source) {
	        ...
	        ExtendUtils.extend(destination, function (item, property) {
	            return property.slice(0, 1) !== "_"
	                && !exports.JudgeUtils.isFunction(item);
	        });
	        return destination;
	    };
	...
	exports.CustomEvent = CustomEvent_1 = __decorate([
	...
	exports.DomEventDispatcher = (function (_super) {
	    ...
	    DomEventDispatcher.prototype.trigger = function () {
	        ...
	        if (args.length === 1) {
	            ...
	            exports.EventHandlerFactory.createEventHandler(eventType)
	                .trigger(event);
	        }
	        else if (args.length === 2) {
	...
	exports.DomEventDispatcher = __decorate([
	    singleton(),
	    registerClass("DomEventDispatcher")
	], exports.DomEventDispatcher);
	...
	], exports.EventUtils, "isEntityObject", null);
	exports.EventUtils = __decorate([
	...
	})(exports.EEventPhase || (exports.EEventPhase = {}));

	exports.CustomEventDispatcher = (function (_super) {
	    ...
	    CustomEventDispatcher.prototype.trigger = function () {
	        ...
	        if (length === 1) {
	            var event = args[0], eventType = event.type;
	            return exports.EventHandlerFactory.createEventHandler(eventType)
	                .trigger(event);
	        }
	        else if (length === 2 && exports.EventUtils.isEvent(args[0])) {
	            var event = args[0], userData = args[1], eventType = event.type;
	            return exports.EventHandlerFactory.createEventHandler(eventType)
	                .trigger(event, userData);
	        }
	        else if ((length === 2 && exports.EventUtils.isEntityObject(args[0])) || (length === 3 && exports.JudgeUtils.isBoolean(args[2]))) {
	    ...
	    CustomEventDispatcher.prototype.emit = function (target, eventObject, userData) {
	        ...
	        eventObject.phase = exports.EEventPhase.EMIT;
	    ...
	    CustomEventDispatcher.prototype.broadcast = function (target, eventObject, userData) {
	        ...
	        eventObject.phase = exports.EEventPhase.BROADCAST;
	        eventObject.target = target;
	...
	exports.CustomEventDispatcher = __decorate([
	    singleton(),
	    registerClass("CustomEventDispatcher")
	], exports.CustomEventDispatcher);

	exports.EventDispatcherFactory = (function () {
	    ...
	    EventDispatcherFactory.createEventDispatcher = function (event) {
	        ...
	        switch (eventType) {
	            ...
	            case exports.EEventType.TOUCH:
	            case exports.EEventType.KEYBOARD:
	                dispatcher = exports.DomEventDispatcher.getInstance();
	                break;
	            case exports.EEventType.CUSTOM:
	            case exports.EEventType.POINT:
	                dispatcher = exports.CustomEventDispatcher.getInstance();
	                break;
	            default:
	...
	exports.EventDispatcherFactory = __decorate([
	    registerClass("EventDispatcherFactory")
	], exports.EventDispatcherFactory);

	exports.EventManager = EventManager_1 = (function () {
	    ...
	    EventManager.on = function () {
	        ...
	        if (args.length === 2 && exports.JudgeUtils.isString(args[0])) {
	            var eventName = args[0], handler = args[1], priority = 1, eventBinder = exports.EventBinderFactory.createEventBinder(eventName);
	            eventBinder.on(eventName, handler, priority);
	        }
	        else if (args.length === 3 && exports.JudgeUtils.isString(args[0])) {
	            var eventName = args[0], handler = args[1], priority = args[2], eventBinder = exports.EventBinderFactory.createEventBinder(eventName);
	            eventBinder.on(eventName, handler, priority);
	        }
	        else if (args.length === 3 && args[0] instanceof EntityObject) {
	            var target = args[0], eventName = args[1], handler = args[2], priority = 1, eventBinder = exports.CustomEventBinder.getInstance();
	            eventBinder.on(target, eventName, handler, priority);
	        }
	        else if (args.length === 3 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventName = args[1], handler = args[2], priority = 1, eventBinder = exports.DomEventBinder.getInstance();
	            eventBinder.on(dom, eventName, handler, priority);
	        }
	        else if (args.length === 4 && args[0] instanceof EntityObject) {
	            var target = args[0], eventName = args[1], handler = args[2], priority = args[3], eventBinder = exports.CustomEventBinder.getInstance();
	            eventBinder.on(target, eventName, handler, priority);
	        }
	        else if (args.length === 4 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventName = args[1], handler = args[2], priority = args[3], eventBinder = exports.DomEventBinder.getInstance();
	            eventBinder.on(dom, eventName, handler, priority);
	        }
	    };
	    EventManager.off = function () {
	        ...
	        if (args.length === 0) {
	            var customEventBinder = exports.CustomEventBinder.getInstance(), domEventBinder = exports.DomEventBinder.getInstance();
	            customEventBinder.off();
	            domEventBinder.off();
	        }
	        else if (args.length === 1 && exports.JudgeUtils.isString(args[0])) {
	            var eventName = args[0], eventBinder = exports.EventBinderFactory.createEventBinder(eventName);
	            eventBinder.off(eventName);
	        }
	        else if (args.length === 1 && args[0] instanceof EntityObject) {
	            var target = args[0], eventBinder = exports.CustomEventBinder.getInstance();
	            eventBinder.off(target);
	        }
	        else if (args.length === 1 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventBinder = exports.DomEventBinder.getInstance();
	            eventBinder.off(dom);
	        }
	        else if (args.length === 2 && exports.JudgeUtils.isString(args[0])) {
	            var eventName = args[0], handler = args[1], eventBinder = exports.EventBinderFactory.createEventBinder(eventName);
	            eventBinder.off(eventName, handler);
	        }
	        else if (args.length === 2 && args[0] instanceof EntityObject) {
	            var target = args[0], eventName = args[1], eventBinder = exports.CustomEventBinder.getInstance();
	            eventBinder.off(target, eventName);
	        }
	        else if (args.length === 2 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventName = args[1], eventBinder = exports.DomEventBinder.getInstance();
	            eventBinder.off(dom, eventName);
	        }
	        else if (args.length === 3 && args[0] instanceof EntityObject) {
	            var target = args[0], eventName = args[1], handler = args[2], eventBinder = exports.CustomEventBinder.getInstance();
	            eventBinder.off(target, eventName, handler);
	        }
	        else if (args.length === 3 && exports.JudgeUtils.isDom(args[0])) {
	            var dom = args[0], eventName = args[1], handler = args[2], eventBinder = exports.DomEventBinder.getInstance();
	    ...
	    EventManager.trigger = function () {
	        ...
	        var length = args.length;
	        if (length === 1) {
	            var event = args[0], eventDispatcher = exports.EventDispatcherFactory.createEventDispatcher(event);
	            eventDispatcher.trigger(event);
	        }
	        else if (length === 2 && exports.EventUtils.isEvent(args[0])) {
	            var event = args[0], userData = args[1], eventDispatcher = exports.CustomEventDispatcher.getInstance();
	            eventDispatcher.trigger(event, userData);
	        }
	        else if (length === 2 && exports.EventUtils.isEntityObject(args[0])) {
	            var target = args[0], event = args[1], eventDispatcher = exports.CustomEventDispatcher.getInstance();
	            if (!target) {
	                return;
	            }
	            ...
	            var dom = args[0], event = args[1], eventDispatcher = exports.DomEventDispatcher.getInstance();
	            if (!dom) {
	                return;
	            }
	            ...
	            var target = args[0], event = args[1], userData = args[2], eventDispatcher = exports.CustomEventDispatcher.getInstance();
	            if (!target) {
	                return;
	            }
	            ...
	            var target = args[0], event = args[1], userData = args[2], notSetTarget = args[3], eventDispatcher = exports.CustomEventDispatcher.getInstance();
	            if (!target) {
	                return;
	            }
	    ...
	    EventManager.broadcast = function () {
	        ...
	        var eventDispatcher = exports.CustomEventDispatcher.getInstance();
	    ...
	    EventManager.fromEvent = function () {
	        ...
	        else if (args.length === 2 && exports.JudgeUtils.isNumber(args[1])) {
	    ...
	    EventManager.setBubbleParent = function (target, parent) {
	        exports.CustomEventRegister.getInstance().setBubbleParent(target, parent);
	    };
	    return EventManager;
	}());
	__decorate([
	    requireCheck(function () {
	        ...
	        if (args[0] instanceof EntityObject) {
	            ...
	            it("event must be custom event", function () {
	                var eventType = exports.EventTable.getEventType(eventName_5);
	                index(eventType === exports.EEventType.CUSTOM || eventType === exports.EEventType.POINT).true;
	            });
	        }
	        else if (exports.JudgeUtils.isDom(args[0])) {
	            var eventName = args[1], eventType_1 = exports.EventTable.getEventType(eventName);
	            it("event must be dom event", function () {
	                index(eventType_1 === exports.EEventType.TOUCH || eventType_1 === exports.EEventType.MOUSE || eventType_1 === exports.EEventType.KEYBOARD).true;
	            });
	        }
	    })
	], exports.EventManager, "on", null);
	__decorate([
	    requireCheck(function () {
	        var args = [];
	        for (var _i = 0; _i < arguments.length; _i++) {
	        ...
	        if (args.length > 2 && args[0] instanceof EntityObject) {
	            var eventName = args[1], eventType_2 = exports.EventTable.getEventType(eventName);
	            it("event must be custom or point event", function () {
	                index(eventType_2 === exports.EEventType.CUSTOM || eventType_2 === exports.EEventType.POINT).true;
	            });
	        }
	        else if (args.length > 2 && exports.JudgeUtils.isDom(args[0])) {
	            var eventName = args[1], eventType_3 = exports.EventTable.getEventType(eventName);
	            it("event must be keyboard event", function () {
	                index(eventType_3 === exports.EEventType.KEYBOARD).true;
	            });
	        }
	    })
	], exports.EventManager, "off", null);
	__decorate([
	    requireCheck(function () {
	        var args = [];
	        for (var _i = 0; _i < arguments.length; _i++) {
	        ...
	        if (args.length === 2 && args[0] instanceof Event) {
	            var event = args[0];
	            assert(event instanceof exports.CustomEvent, Log$$1.info.FUNC_MUST_BE("event type", "CUSTOM"));
	        }
	        else if (args.length === 2 && args[0] instanceof EntityObject) {
	        }
	        else if (args.length === 2) {
	            if (args[0]) {
	                assert(exports.JudgeUtils.isDom(args[0]), Log$$1.info.FUNC_MUST_BE("the first param", "dom"));
	            }
	        }
	...
	], exports.EventManager, "trigger", null);
	__decorate([
	    requireCheck(function (target, eventObject, userData) {
	        assert(eventObject instanceof exports.CustomEvent, Log$$1.info.FUNC_MUST_BE("eventObject", "CustomEvent"));
	    })
	], exports.EventManager, "broadcast", null);
	__decorate([
	    requireCheck(function (target, eventObject, userData) {
	        assert(eventObject instanceof exports.CustomEvent, Log$$1.info.FUNC_MUST_BE("eventObject", "CustomEvent"));
	    })
	], exports.EventManager, "emit", null);
	__decorate([
	    requireCheck(function (target, parent) {
	        assert(target instanceof EntityObject, "only EntityObject can setBubleParent");
	    })
	], exports.EventManager, "setBubbleParent", null);
	exports.EventManager = EventManager_1 = __decorate([
	...
	var CameraController = (function (_super) {
	    ...
	    CameraController.prototype.bindClearCacheEvent = function () {
	        ...
	        this._clearCacheSubscription = fromArray([
	            exports.EventManager.fromEvent(exports.EEngineEvent.ENDLOOP),
	            exports.EventManager.fromEvent(this.entityObject, exports.EEngineEvent.TRANSFORM_TRANSLATE),
	            exports.EventManager.fromEvent(this.entityObject, exports.EEngineEvent.TRANSFORM_ROTATE),
	            exports.EventManager.fromEvent(this.entityObject, exports.EEngineEvent.TRANSFORM_SCALE)
	        ])
	            .mergeAll()
	            .subscribe(function () {
	            self._clearCache();
	...
	exports.BasicCameraController = (function (_super) {
	...
	exports.BasicCameraController = __decorate([
	    registerClass("BasicCameraController")
	], exports.BasicCameraController);

	exports.PerspectiveCamera = (function (_super) {
	...
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.PerspectiveCamera.prototype, "fovy", null);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.PerspectiveCamera.prototype, "aspect", null);
	exports.PerspectiveCamera = __decorate([
	    registerClass("PerspectiveCamera")
	], exports.PerspectiveCamera);

	exports.Face3 = (function () {
	    ...
	    Object.defineProperty(Face3.prototype, "faceNormal", {
	        get: function () {
	            return this._faceNormal !== null ? this._faceNormal : exports.Vector3.create(0, 0, 0);
	        },
	...
	__decorate([
	    cloneAttributeAsCloneable()
	], exports.Face3.prototype, "_faceNormal", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.Face3.prototype, "aIndex", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.Face3.prototype, "bIndex", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.Face3.prototype, "cIndex", void 0);
	__decorate([
	    cloneAttributeAsCustomType(function (source, target, memberName) {
	        target[memberName] = source[memberName].clone(true);
	    })
	], exports.Face3.prototype, "vertexNormals", void 0);
	exports.Face3 = __decorate([
	    registerClass("Face3")
	], exports.Face3);

	exports.GeometryUtils = (function () {
	    function GeometryUtils() {
	    }
	    GeometryUtils.convertToFaces = function (indices, normals) {
	        var hasNormals = this.hasData(normals), faces = [];
	        for (var i = 0, len = indices.length; i < len; i += 3) {
	            var a = indices[i], b = indices[i + 1], c = indices[i + 2], face = exports.Face3.create(a, b, c);
	            if (hasNormals) {
	    ...
	    GeometryUtils.getThreeComponent = function (sourceData, index) {
	        ...
	        return exports.Vector3.create(sourceData[startIndex], sourceData[startIndex + 1], sourceData[startIndex + 2]);
	    };
	    GeometryUtils.iterateThreeComponent = function (dataArr, iterator) {
	        for (var i = 0, len = dataArr.length; i < len; i += 3) {
	            iterator(exports.Vector3.create(dataArr[i], dataArr[i + 1], dataArr[i + 2]));
	        }
	    };
	    GeometryUtils.setThreeComponent = function (targetData, sourceData, index) {
	        if (sourceData instanceof exports.Vector3) {
	...
	__decorate([
	    requireCheck(function (data) {
	        if (data) {
	            assert(data instanceof Collection || data instanceof Hash || exports.JudgeUtils.isArrayExactly(data), Log$$1.info.FUNC_SHOULD("data", "be Array or Collection or Hash"));
	        }
	    })
	], exports.GeometryUtils, "hasData", null);
	__decorate([
	    requireCheck(function (dataArr, iterator) {
	        assert(dataArr.length % 3 === 0, Log$$1.info.FUNC_SHOULD("dataArr.length", "times of three"));
	    })
	], exports.GeometryUtils, "iterateThreeComponent", null);
	exports.GeometryUtils = __decorate([
	...
	exports.BoxGeometry = (function (_super) {
	    ...
	    BoxGeometry.prototype.computeData = function () {
	        ...
	        function generateFace(side, uSegments, vSegments) {
	            ...
	            for (i = 0; i <= uSegments; i++) {
	                for (j = 0; j <= vSegments; j++) {
	                    var temp1 = exports.Vector3.create();
	                    var temp2 = exports.Vector3.create();
	                    var temp3 = exports.Vector3.create();
	                    var r = exports.Vector3.create();
	        ...
	        return {
	            vertices: vertices,
	            faces: exports.GeometryUtils.convertToFaces(indices)
	        };
	    };
	    return BoxGeometry;
	}(Geometry));
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "width", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "height", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "depth", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "widthSegments", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "heightSegments", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.BoxGeometry.prototype, "depthSegments", void 0);
	...
	exports.BasicState = (function (_super) {
	...
	exports.BasicState = __decorate([
	    registerClass("BasicState")
	], exports.BasicState);

	exports.GlUtils = (function () {
	    function GlUtils() {
	    }
	...
	var RenderCommand = (function () {
	    function RenderCommand() {
	        ...
	        this.drawMode = exports.EDrawMode.TRIANGLES;
	    }
	    Object.defineProperty(RenderCommand.prototype, "webglState", {
	        get: function () {
	            return this._webglState ? this._webglState : exports.BasicState.create();
	        },
	    ...
	    RenderCommand.prototype.drawElements = function (indexBuffer) {
	        var startOffset = 0, gl = exports.DeviceManager.getInstance().gl;
	        exports.BufferTable.bindIndexBuffer(indexBuffer);
	        exports.GlUtils.drawElements(gl[this.drawMode], indexBuffer.count, gl[indexBuffer.type], indexBuffer.typeSize * startOffset);
	    };
	    RenderCommand.prototype.drawArray = function (vertexBuffer) {
	        var startOffset = 0, gl = exports.DeviceManager.getInstance().gl;
	        exports.GlUtils.drawArrays(gl[this.drawMode], startOffset, vertexBuffer.count);
	    };
	...
	exports.SingleDrawCommand = (function (_super) {
	    ...
	    SingleDrawCommand.prototype.draw = function (material) {
	        var vertexBuffer = null, indexBuffer = this.buffers.getChild(exports.EBufferDataType.INDICE);
	        this.webglState.setState(material);
	        if (indexBuffer) {
	            this.drawElements(indexBuffer);
	        }
	        else {
	            vertexBuffer = this.buffers.getChild(exports.EBufferDataType.VERTICE);
	            this.drawArray(vertexBuffer);
	        }
	    };
	    return SingleDrawCommand;
	}(QuadCommand));
	exports.SingleDrawCommand = __decorate([
	    registerClass("SingleDrawCommand")
	], exports.SingleDrawCommand);
	...
	exports.MeshRenderer = (function (_super) {
	    ...
	    MeshRenderer.prototype._createCommand = function (target, material) {
	        var cmd = null;
	        cmd = exports.SingleDrawCommand.create();
	...
	], exports.MeshRenderer.prototype, "createDrawCommand", null);
	...
	exports.ThreeDTransform = (function (_super) {
	    ...
	    function ThreeDTransform() {
	        ...
	        _this._position = exports.Vector3.create();
	        _this._rotation = exports.Quaternion.create(0, 0, 0, 1);
	        _this._scale = exports.Vector3.create(1, 1, 1);
	        _this._eulerAngles = null;
	        _this._localPosition = exports.Vector3.create(0, 0, 0);
	        _this._localRotation = exports.Quaternion.create(0, 0, 0, 1);
	        _this._localEulerAngles = null;
	        _this._localScale = exports.Vector3.create(1, 1, 1);
	        _this.dirtyWorld = null;
	        _this._localToParentMatrix = exports.Matrix4.create();
	    ...
	    ThreeDTransform.prototype.translateLocal = function () {
	        ...
	        if (args.length === 3) {
	            translation = exports.Vector3.create(args[0], args[1], args[2]);
	        }
	        else {
	            translation = args[0];
	        }
	    ...
	    ThreeDTransform.prototype.rotate = function () {
	        ...
	        var eulerAngles = null, quaternion = exports.Quaternion.create();
	        if (args.length === 3) {
	            eulerAngles = exports.Vector3.create(args[0], args[1], args[2]);
	        }
	        else {
	            eulerAngles = args[0];
	        }
	    ...
	    ThreeDTransform.prototype.rotateAround = function () {
	        ...
	        if (args.length === 3) {
	            ...
	            angle = args[0];
	            center = exports.Vector3.create(args[1], args[2], args[3]);
	            axis = exports.Vector3.create(args[4], args[5], args[6]);
	        }
	        rot = exports.Quaternion.create().setFromAxisAngle(angle, axis);
	    ...
	    ThreeDTransform.prototype.lookAt = function () {
	        ...
	        if (args.length === 1) {
	            ...
	            target = exports.Vector3.create(args[0], args[1], args[2]);
	            up = exports.Vector3.up;
	        }
	        else {
	            target = exports.Vector3.create(args[0], args[1], args[2]);
	            up = exports.Vector3.create(args[3], args[4], args[5]);
	        }
	        this.rotation = exports.Quaternion.create().setFromMatrix(exports.Matrix4.create().setLookAt(this.position, target, up));
	        return this;
	    };
	    ...
	    ThreeDTransform.prototype.handleWhenSetTransformState = function (transformState) {
	        ...
	        if (transformState === void 0) {
	            exports.EventManager.trigger(this.entityObject, exports.CustomEvent.create(exports.EEngineEvent.TRANSFORM_TRANSLATE));
	            exports.EventManager.trigger(this.entityObject, exports.CustomEvent.create(exports.EEngineEvent.TRANSFORM_ROTATE));
	            exports.EventManager.trigger(this.entityObject, exports.CustomEvent.create(exports.EEngineEvent.TRANSFORM_SCALE));
	            return;
	        }
	        switch (transformState) {
	            case exports.ETransformState.ISTRANSLATE:
	                eventName = exports.EEngineEvent.TRANSFORM_TRANSLATE;
	                break;
	            case exports.ETransformState.ISROTATE:
	                eventName = exports.EEngineEvent.TRANSFORM_ROTATE;
	                break;
	            case exports.ETransformState.ISSCALE:
	                eventName = exports.EEngineEvent.TRANSFORM_SCALE;
	                break;
	            default:
	                Log$$1.error(true, Log$$1.info.FUNC_UNKNOW("transformState:" + transformState));
	                break;
	        }
	        exports.EventManager.trigger(this.entityObject, exports.CustomEvent.create(eventName));
	    };
	...
	], exports.ThreeDTransform.prototype, "localToWorldMatrix", null);
	__decorate([
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "normalMatrix", null);
	__decorate([
	    cloneAttributeAsCloneable(),
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "position", null);
	__decorate([
	    cloneAttributeAsCloneable(),
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "rotation", null);
	__decorate([
	    cloneAttributeAsCloneable(),
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "scale", null);
	__decorate([
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "eulerAngles", null);
	__decorate([
	    cloneAttributeAsCloneable()
	], exports.ThreeDTransform.prototype, "localPosition", null);
	__decorate([
	    cloneAttributeAsCloneable()
	], exports.ThreeDTransform.prototype, "localRotation", null);
	__decorate([
	    cacheGetter(function () {
	...
	], exports.ThreeDTransform.prototype, "localEulerAngles", null);
	__decorate([
	    cloneAttributeAsCloneable()
	], exports.ThreeDTransform.prototype, "localScale", null);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.ThreeDTransform.prototype, "_isUserSpecifyTheLocalToWorldMatrix", void 0);
	__decorate([
	    cloneAttributeAsCloneable()
	], exports.ThreeDTransform.prototype, "_userLocalToWorldMatrix", void 0);
	...
	exports.RenderUtils = __decorate([
	    registerClass("RenderUtils")
	], exports.RenderUtils);

	exports.GameObject = (function (_super) {
	    ...
	    GameObject.prototype.createTransform = function () {
	        return exports.ThreeDTransform.create();
	    };
	    GameObject.prototype.getRenderList = function () {
	        return exports.RenderUtils.getGameObjectRenderList(this.getChildren());
	    };
	    return GameObject;
	}(EntityObject));
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.GameObject.prototype, "renderGroup", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.GameObject.prototype, "renderPriority", void 0);
	__decorate([
	    cloneAttributeAsBasicType()
	], exports.GameObject.prototype, "isVisible", void 0);
	...
	exports.GameObjectScene = (function (_super) {
	    ...
	    Object.defineProperty(GameObjectScene.prototype, "currentCamera", {
	        ...
	        set: function (arg) {
	            if (exports.JudgeUtils.isNumber(arg)) {
	                var index = arg;
	                this._currentCamera = this._cameraList.getChild(index);
	            }
	            else if (arg instanceof exports.GameObject) {
	...
	], exports.GameObjectScene.prototype, "currentCamera", null);
	exports.GameObjectScene = __decorate([
	    registerClass("GameObjectScene")
	], exports.GameObjectScene);

	exports.SceneDispatcher = (function (_super) {
	    __extends(SceneDispatcher, _super);
	    function SceneDispatcher() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.name = "scene" + String(_this.uid);
	        _this.gameObjectScene = exports.GameObjectScene.create();
	        return _this;
	    }
	    ...
	    SceneDispatcher.prototype.addChild = function (child) {
	        if (child instanceof exports.GameObject) {
	    ...
	    SceneDispatcher.prototype.addChildren = function () {
	        ...
	        else if (exports.JudgeUtils.isArrayExactly(args[0])) {
	            var children = args[0];
	            for (var _a = 0, children_1 = children; _a < children_1.length; _a++) {
	                var child = children_1[_a];
	                this.addChild(child);
	...
	exports.SceneDispatcher = __decorate([
	    registerClass("SceneDispatcher")
	], exports.SceneDispatcher);
	...
	exports.WebGLRenderer = (function (_super) {
	    __extends(WebGLRenderer, _super);
	    function WebGLRenderer() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this._commandQueue = Collection.create();
	        _this._clearOptions = {
	            color: exports.Color.create("#000000")
	        };
	        return _this;
	    }
	    ...
	    WebGLRenderer.prototype.clear = function () {
	        exports.DeviceManager.getInstance().clear(this._clearOptions);
	    };
	    WebGLRenderer.prototype.render = function () {
	        var deviceManager = exports.DeviceManager.getInstance(), webglState = this.webglState;
	...
	], exports.WebGLRenderer.prototype, "addCommand", null);
	__decorate([
	    requireCheck(function () {
	        assert(!!this.webglState, Log$$1.info.FUNC_MUST_DEFINE("webglState"));
	    })
	], exports.WebGLRenderer.prototype, "render", null);
	exports.WebGLRenderer = __decorate([
	...
	exports.Director = (function () {
	    ...
	    Director.prototype.initWhenCreate = function () {
	        this.scene = exports.SceneDispatcher.create();
	        this.renderer = exports.WebGLRenderer.create();
	    };
	    ...
	    Director.prototype._run = function (elapsed) {
	        ...
	        exports.EventManager.trigger(exports.CustomEvent.create(exports.EEngineEvent.STARTLOOP));
	        this._update(elapsed);
	        this._render();
	        exports.EventManager.trigger(exports.CustomEvent.create(exports.EEngineEvent.ENDLOOP));
	    };
	    ...
	    Director.prototype._render = function () {
	        ...
	        if (this.renderer.hasCommand()) {
	            this.renderer.webglState = exports.BasicState.create();
	...
	exports.ProgramTable.lastUsedProgram = null;
	exports.ProgramTable._table = Hash.create();
	exports.ProgramTable = __decorate([
	...
	exports.Main = (function () {
	    ...
	    Main.setConfig = function (_a) {
	        var _b = _a.canvasId, canvasId = _b === void 0 ? null : _b, _c = _a.isTest, isTest = _c === void 0 ? DebugConfig.isTest : _c, _d = _a.screenSize, screenSize = _d === void 0 ? exports.EScreenSize.FULL : _d, _e = _a.useDevicePixelRatio, useDevicePixelRatio = _e === void 0 ? false : _e, _f = _a.contextConfig, contextConfig = _f === void 0 ? {
	            options: {
	                alpha: true,
	                depth: true,
	                stencil: false,
	    ...
	    Main.init = function () {
	        exports.DeviceManager.getInstance().createGL(this._canvasId, this._contextConfig, this._useDevicePixelRatio);
	        exports.DeviceManager.getInstance().setScreen();
	        exports.GPUDetector.getInstance().detect();
	        return this;
	    };
	...
	exports.Main._canvasId = null;
	exports.Main._contextConfig = null;
	exports.Main._useDevicePixelRatio = null;
	exports.Main = __decorate([
	    registerClass("Main")
	], exports.Main);
	...
	var PointEvent = (function (_super) {
	    ...
	    function PointEvent() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = exports.EEventType.POINT;
	        _this.eventObj = null;
	        return _this;
	    }
	...
	exports.MousePointEvent = MousePointEvent_1 = (function (_super) {
	...
	exports.MousePointEvent = MousePointEvent_1 = __decorate([
	    registerClass("MousePointEvent")
	], exports.MousePointEvent);
	var MousePointEvent_1;

	exports.TouchPointEvent = TouchPointEvent_1 = (function (_super) {
	...
	exports.TouchPointEvent = TouchPointEvent_1 = __decorate([
	    registerClass("TouchPointEvent")
	], exports.TouchPointEvent);
	var TouchPointEvent_1;

	exports.ShaderManager = (function () {
	    ...
	    Object.defineProperty(ShaderManager.prototype, "shader", {
	        get: function () {
	            var scene = exports.Director.getInstance().scene;
	...
	], exports.ShaderManager.prototype, "shader", null);
	exports.ShaderManager = __decorate([
	    registerClass("ShaderManager")
	], exports.ShaderManager);

	var Material = (function () {
	    function Material() {
	        this._color = exports.Color.create("#ffffff");
	        this.geometry = null;
	        this._shaderManager = exports.ShaderManager.create(this);
	    }
	...
	exports.ArrayUtils = (function (_super) {
	...
	exports.ArrayUtils = __decorate([
	    registerClass("ArrayUtils")
	], exports.ArrayUtils);

	exports.GLSLDataSender = (function () {
	    ...
	    GLSLDataSender.prototype.sendMatrix3 = function (name, data) {
	        var gl = exports.DeviceManager.getInstance().gl, pos = this.getUniformLocation(name);
	        if (this._isUniformDataNotExistByLocation(pos)) {
	            return;
	        }
	    ...
	    GLSLDataSender.prototype.sendMatrix4Array = function (name, data) {
	        var gl = exports.DeviceManager.getInstance().gl, pos = this.getUniformLocation(name + "[0]");
	        if (this._isUniformDataNotExistByLocation(pos)) {
	            return;
	        }
	    ...
	    GLSLDataSender.prototype.getUniformLocation = function (name) {
	        var pos = null, gl = exports.DeviceManager.getInstance().gl;
	...
	__decorate([
	    requireCheck(function (name, data) {
	        assert(exports.JudgeUtils.isNumber(data), Log$$1.info.FUNC_MUST_BE("data", "be number"));
	    })
	], exports.GLSLDataSender.prototype, "sendNum1", null);
	__decorate([
	    requireCheck(function (name, data) {
	        it("data should be array, but actual is " + data, function () {
	            index(exports.JudgeUtils.isFloatArray(data) || exports.JudgeUtils.isArrayExactly(data)).true;
	        });
	        it("name shouldn't be the first matrix of the array", function () {
	            index(/\[0\]$/.test(name)).false;
	        });
	    })
	], exports.GLSLDataSender.prototype, "sendMatrix4Array", null);
	__decorate([
	    requireCheck(function (name, data) {
	        assert(exports.JudgeUtils.isArrayExactly(data), Log$$1.info.FUNC_SHOULD("data", "be array, but actual is " + data));
	        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
	            var unit = data_1[_i];
	            assert(exports.JudgeUtils.isNumber(unit), Log$$1.info.FUNC_SHOULD("data", "be Array<number>, but actual is " + data));
	        }
	    })
	], exports.GLSLDataSender.prototype, "sendSampleArray", null);
	__decorate([
	    requireCheck(function () {
	        assert(!exports.ArrayUtils.hasRepeatItems(this._toSendBufferArr), Log$$1.info.FUNC_SHOULD_NOT("_toSendBufferArr", "has repeat buffer"));
	    }),
	    cache(function () {
	        return exports.BufferTable.lastBindedArrayBufferListUidStr === this._toSendBuffersUidStr;
	    }, function () {
	    }, function () {
	        exports.BufferTable.lastBindedArrayBufferListUidStr = this._toSendBuffersUidStr;
	    })
	], exports.GLSLDataSender.prototype, "sendAllBufferData", null);
	exports.GLSLDataSender = __decorate([
	    registerClass("GLSLDataSender")
	], exports.GLSLDataSender);
	...
	exports.Program = (function (_super) {
	    __extends(Program, _super);
	    function Program() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.glProgram = null;
	        _this._getAttribLocationCache = Hash.create();
	        _this._sender = exports.GLSLDataSender.create(_this);
	        return _this;
	    }
	    ...
	    Program.prototype.use = function () {
	        if (exports.JudgeUtils.isEqual(this, exports.ProgramTable.lastUsedProgram)) {
	            return;
	        }
	        exports.ProgramTable.lastUsedProgram = this;
	        exports.DeviceManager.getInstance().gl.useProgram(this.glProgram);
	    ...
	    Program.prototype.sendUniformData = function (name, type, data) {
	        ...
	        switch (type) {
	            ...
	            case exports.EVariableType.VECTOR_4:
	                ...
	                break;
	            case exports.EVariableType.COLOR_3:
	                this._sender.sendColor3(name, data);
	                break;
	            case exports.EVariableType.FLOAT_MAT3:
	            ...
	            case exports.EVariableType.FLOAT_MAT4_ARRAY:
	                ...
	                break;
	            case exports.EVariableType.SAMPLER_ARRAY:
	    ...
	    Program.prototype.initWithShader = function (shader) {
	        var gl = exports.DeviceManager.getInstance().gl, vs = null, fs = null;
	        if (this.glProgram) {
	            this.dispose();
	        }
	        this.glProgram = exports.DeviceManager.getInstance().gl.createProgram();
	...
	__decorate([
	    requireCheck(function (name, type, buffer) {
	        assert(buffer instanceof exports.ArrayBuffer, Log$$1.info.FUNC_MUST_BE("ArrayBuffer"));
	        assert(type === exports.EVariableType.BUFFER, Log$$1.info.FUNC_SHOULD("type", "be EVariableType.BUFFER, but actual is " + type));
	    })
	], exports.Program.prototype, "sendAttributeBuffer", null);
	exports.Program = __decorate([
	...
	var Shader = (function () {
	    ...
	    Object.defineProperty(Shader.prototype, "program", {
	        get: function () {
	            return exports.ProgramTable.getProgram(this._getProgramTableKey());
	        },
	        enumerable: true,
	        configurable: true
	    });
	    ...
	    Shader.prototype._registerAndUpdateProgram = function () {
	        ...
	        if (exports.ProgramTable.hasProgram(key)) {
	            return;
	        }
	        exports.ProgramTable.addProgram(key, exports.Program.create());
	        this._updateProgram();
	    };
	...
	__decorate([
	        ...
	        it("should add shader lib to the top", function () {
	            index(exports.JudgeUtils.isEqual(lib, _this.libs.getChild(0))).true;
	        }, this);
	        it("should set ShaderLib.shader to be this", function () {
	            _this.libs.forEach(function (lib) {
	                index(lib.shader === _this).true;
	...
	})(exports.EVariableCategory || (exports.EVariableCategory = {}));

	exports.BufferUtils = (function () {
	    function BufferUtils() {
	    }
	    BufferUtils.convertArrayToArrayBuffer = function (type, value) {
	        var size = this._getBufferSize(type);
	        return exports.ArrayBuffer.create(value, size, exports.EBufferType.FLOAT);
	    };
	...
	__decorate([
	    requireCheck(function (type, value) {
	        it("value:" + value + " should be array", function () {
	            index(exports.JudgeUtils.isArrayExactly(value)).true;
	        });
	    })
	], exports.BufferUtils, "convertArrayToArrayBuffer", null);
	exports.BufferUtils = __decorate([
	...
	var ShaderSourceBuilder = (function () {
	    ...
	    ShaderSourceBuilder.prototype.convertAttributesData = function () {
	        this.attributes
	            ...
	            return data.value !== exports.EVariableCategory.ENGINE && exports.JudgeUtils.isArrayExactly(data.value);
	        })
	            .forEach(function (data, key) {
	            data.value = exports.BufferUtils.convertArrayToArrayBuffer(data.type, data.value);
	        });
	    };
	...
	__decorate([
	    requireCheck(function () {
	        this.attributes.forEach(function (data) {
	            assert(!exports.JudgeUtils.isFloatArray(data.value), Log$$1.info.FUNC_SHOULD_NOT("attribute->value", "be Float array"));
	        });
	    })
	...
	_table$2.addChild(exports.EVariableType.FLOAT_1, "float");
	_table$2.addChild(exports.EVariableType.FLOAT_2, "vec2");
	_table$2.addChild(exports.EVariableType.FLOAT_3, "vec3");
	_table$2.addChild(exports.EVariableType.FLOAT_4, "vec4");
	_table$2.addChild(exports.EVariableType.VECTOR_2, "vec2");
	_table$2.addChild(exports.EVariableType.VECTOR_3, "vec3");
	_table$2.addChild(exports.EVariableType.VECTOR_4, "vec4");
	_table$2.addChild(exports.EVariableType.FLOAT_MAT3, "mat3");
	_table$2.addChild(exports.EVariableType.FLOAT_MAT4, "mat4");
	_table$2.addChild(exports.EVariableType.NUMBER_1, "int");
	_table$2.addChild(exports.EVariableType.SAMPLER_CUBE, "samplerCube");
	_table$2.addChild(exports.EVariableType.SAMPLER_2D, "sampler2D");
	exports.VariableTypeTable = (function () {
	...
	exports.VariableTypeTable = __decorate([
	    registerClass("VariableTypeTable")
	], exports.VariableTypeTable);

	exports.EngineShaderSourceBuilder = (function (_super) {
	    ...
	    EngineShaderSourceBuilder.prototype._generateAttributeSource = function () {
	        ...
	        this.attributes.filter(function (data, key) {
	            ...
	            result += "attribute " + exports.VariableTypeTable.getVariableType(data.type) + " " + key + ";\n";
	        });
	        return result;
	    };
	    EngineShaderSourceBuilder.prototype._generateUniformSource = function (sourceVarDeclare, sourceFuncDefine, sourceBody) {
	        ...
	        this.uniforms.filter(function (data, key) {
	            return !!data && data.type !== exports.EVariableType.STRUCTURE && data.type !== exports.EVariableType.STRUCTURES && !self._isExistInSource(key, sourceVarDeclare) && (self._isExistInSource(key, sourceFuncDefine) || self._isExistInSource(key, sourceBody));
	        }).forEach(function (data, key) {
	            result += "uniform " + exports.VariableTypeTable.getVariableType(data.type) + " " + key + ";\n";
	        });
	        return result;
	    };
	...
	], exports.EngineShaderSourceBuilder.prototype, "build", null);
	exports.EngineShaderSourceBuilder = __decorate([
	    registerClass("EngineShaderSourceBuilder")
	], exports.EngineShaderSourceBuilder);
	...
	var EngineShader = (function (_super) {
	    ...
	    EngineShader.prototype.createShaderSourceBuilder = function () {
	        return exports.EngineShaderSourceBuilder.create();
	    };
	    return EngineShader;
	}(Shader));

	exports.CommonShader = (function (_super) {
	...
	exports.CommonShader = __decorate([
	    registerClass("CommonShader")
	], exports.CommonShader);

	exports.VariableLib = (function () {
	    function VariableLib() {
	    }
	    return VariableLib;
	}());
	exports.VariableLib.a_position = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_positionVec2 = {
	    type: exports.EVariableType.FLOAT_2,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_currentFramePosition = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_nextFramePosition = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_normal = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_currentFrameNormal = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_nextFrameNormal = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_color = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_texCoord = {
	    type: exports.EVariableType.FLOAT_2,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_tangent = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_color = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_mMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_vMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_pMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_mvpMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_vpMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_normalMatrix = {
	    type: exports.EVariableType.FLOAT_MAT3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_samplerCube0 = {
	    type: exports.EVariableType.SAMPLER_CUBE,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_sampler2D0 = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_sampler2D1 = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_lightMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap1Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap2Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap3Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_specularMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_emissionMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_normalMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_reflectionMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_refractionMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_cameraPos = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_refractionRatio = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_reflectivity = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_map0SourceRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_map1SourceRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMapSourceRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_map0RepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_map1RepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMapRepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_combineMode = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_mixRatio = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_lightMapIntensity = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuse = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_specular = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_emission = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_shininess = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_lightModel = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_isBothSide = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_opacity = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_ambient = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_directionLights = {
	    type: exports.EVariableType.STRUCTURES,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_pointLights = {
	    type: exports.EVariableType.STRUCTURES,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_vpMatrixFromLight = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_lightPos = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_farPlane = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_interpolation = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_tilesHeightNumber = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_tilesWidthNumber = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_amplitude = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_jointColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_time = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_speed = {
	    type: exports.EVariableType.VECTOR_2,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_shift = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_alphaThreshold = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_fireColor = {
	    type: exports.EVariableType.STRUCTURE,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_layerHeightDatas = {
	    type: exports.EVariableType.STRUCTURES,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_layerSampler2Ds = {
	    type: exports.EVariableType.SAMPLER_ARRAY,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_herb1Color = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_herb2Color = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_herb3Color = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_groundColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_ampScale = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_woodColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_roadColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_skyColor = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_cloudColor = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_brickColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_waveData = {
	    type: exports.EVariableType.STRUCTURE,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_windMatrix = {
	    type: exports.EVariableType.FLOAT_MAT4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_bumpMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_bumpMap1Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_bumpMap2Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_bumpMap3Sampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_levelData = {
	    type: exports.EVariableType.STRUCTURE,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_mVec4_0 = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_mVec4_1 = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_mVec4_2 = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_mVec4_3 = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_normalVec4_0 = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_normalVec4_1 = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_normalVec4_2 = {
	    type: exports.EVariableType.FLOAT_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_isRenderListEmpty = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_isReflectionRenderListEmpty = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_isRefractionRenderListEmpty = {
	    type: exports.EVariableType.NUMBER_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_bitmapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_page = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_pageSampler2Ds = {
	    type: exports.EVariableType.SAMPLER_ARRAY,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_mixMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap1RepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap2RepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_diffuseMap3RepeatRegion = {
	    type: exports.EVariableType.VECTOR_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_grassMapDatas = {
	    type: exports.EVariableType.STRUCTURES,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_quadIndex = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_grassMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_windData = {
	    type: exports.EVariableType.STRUCTURES,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_vertexIndex = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_grassRangeWidth = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_grassRangeHeight = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainRangeWidth = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainRangeHeight = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainMinHeight = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainMaxHeight = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainSubdivisions = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainScaleY = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_terrainPositionY = {
	    type: exports.EVariableType.FLOAT_1,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_heightMapSampler = {
	    type: exports.EVariableType.SAMPLER_2D,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_lightColor = {
	    type: exports.EVariableType.VECTOR_3,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_jointIndice = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.a_jointWeight = {
	    type: exports.EVariableType.FLOAT_4,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib.u_jointMatrices = {
	    type: exports.EVariableType.FLOAT_MAT4_ARRAY,
	    value: exports.EVariableCategory.ENGINE
	};
	exports.VariableLib = __decorate([
	...
	var EngineShaderLib = (function (_super) {
	    ...
	    EngineShaderLib.prototype.sendAttributeBuffer = function (program, name, data) {
	        program.sendAttributeBuffer(name, exports.EVariableType.BUFFER, data);
	    };
	    EngineShaderLib.prototype.sendUniformData = function (program, name, data) {
	        program.sendUniformData(name, exports.VariableLib[name].type, data);
	    };
	    ...
	    EngineShaderLib.prototype.setVsSource = function (vs, operator) {
	        ...
	        if (exports.JudgeUtils.isString(vs)) {
	            this.vsSource = vs;
	        }
	        else {
	    ...
	    EngineShaderLib.prototype.setFsSource = function (fs, operator) {
	        if (operator === void 0) { operator = "="; }
	        if (exports.JudgeUtils.isString(fs)) {
	            this.fsSource = fs;
	        }
	        else {
	    ...
	    EngineShaderLib.prototype._addVariable = function (target, variableArr) {
	        variableArr.forEach(function (variable) {
	            assert(exports.VariableLib[variable], Log$$1.info.FUNC_SHOULD(variable, "exist in VariableLib"));
	            target.addChild(variable, exports.VariableLib[variable]);
	        });
	    };
	...
	__decorate([
	    requireCheck(function (program, name, data) {
	        assert(!!exports.VariableLib[name], name + " should exist in VariableLib");
	    })
	    ...
	    requireCheck(function (target, variableArr) {
	        variableArr.forEach(function (variable) {
	            it("should exist in VariableLib", function () {
	                index(exports.VariableLib[variable]).exist;
	            });
	        });
	    })
	...
	exports.CommonShaderLib = (function (_super) {
	...
	exports.CommonShaderLib = __decorate([
	    registerClass("CommonShaderLib")
	], exports.CommonShaderLib);

	exports.VerticeCommonShaderLib = (function (_super) {
	    ...
	    VerticeCommonShaderLib.prototype._sendAttributeVariables = function (program, cmd) {
	        var verticeBuffer = cmd.buffers.getChild(exports.EBufferDataType.VERTICE);
	        if (!verticeBuffer) {
	            return;
	        }
	...
	exports.VerticeCommonShaderLib = __decorate([
	    registerClass("VerticeCommonShaderLib")
	], exports.VerticeCommonShaderLib);

	exports.ShaderLibUtils = (function () {
	    function ShaderLibUtils() {
	    }
	    ShaderLibUtils.addVerticeShaderLib = function (geometry, shader) {
	        shader.addLib(exports.VerticeCommonShaderLib.create());
	    };
	    return ShaderLibUtils;
	}());
	exports.ShaderLibUtils = __decorate([
	    registerClass("ShaderLibUtils")
	], exports.ShaderLibUtils);

	exports.EndShaderLib = (function (_super) {
	...
	exports.EndShaderLib = __decorate([
	    registerClass("EndShaderLib")
	], exports.EndShaderLib);
	...
	var EngineMaterial = (function (_super) {
	    ...
	    EngineMaterial.prototype.createShader = function () {
	        return exports.CommonShader.create();
	    };
	    EngineMaterial.prototype._addTopShaderLib = function () {
	        this.shader.addLib(exports.CommonShaderLib.create());
	        exports.ShaderLibUtils.addVerticeShaderLib(this.geometry, this.shader);
	    };
	    ...
	    EngineMaterial.prototype._addEndShaderLib = function () {
	        this.shader.addLib(exports.EndShaderLib.create());
	    };
	...
	exports.BasicMaterialColorShaderLib = (function (_super) {
	...
	exports.BasicMaterialColorShaderLib = __decorate([
	    registerClass("BasicMaterialColorShaderLib")
	], exports.BasicMaterialColorShaderLib);

	exports.BasicShaderLib = (function (_super) {
	...
	exports.BasicShaderLib = __decorate([
	    registerClass("BasicShaderLib")
	], exports.BasicShaderLib);

	exports.EndBasicShaderLib = (function (_super) {
	...
	exports.EndBasicShaderLib = __decorate([
	    registerClass("EndBasicShaderLib")
	], exports.EndBasicShaderLib);
	...
	var StandardBasicMaterial = (function (_super) {
	    ...
	    StandardBasicMaterial.prototype.addShaderLib = function () {
	        var envMap = null;
	        this.shader.addLib(exports.BasicMaterialColorShaderLib.create());
	        this.shader.addLib(exports.BasicShaderLib.create());
	        this.addExtendShaderLib();
	        this.shader.addLib(exports.EndBasicShaderLib.create());
	    };
	...
	})(exports.EVariableSemantic || (exports.EVariableSemantic = {}));
	...
	exports.VariableNameTable = (function () {
	...
	], exports.VariableNameTable, "getVariableName", null);
	exports.VariableNameTable = __decorate([
	    registerClass("VariableNameTable")
	], exports.VariableNameTable);
	...
	], exports.MathUtils, "generateMinToMax", null);
	__decorate([
	    ensure(function (val) {
	...
	], exports.MathUtils, "maxFloorIntegralMultiple", null);
	exports.MathUtils = __decorate([
	...
	exports.QuadCommand = QuadCommand;
	exports.RenderCommand = RenderCommand;
	exports.Renderer = Renderer;
	exports.EngineShaderLib = EngineShaderLib;
