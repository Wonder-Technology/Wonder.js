...
export var bindToUnit = function (gl, unitIndex, textureIndex, TextureCacheDataFromSystem, TextureDataFromSystem, isCached, addActiveTexture) {
...
export var disposeGLTexture = function (gl, sourceIndex, lastComponentIndex, TextureCacheDataFromSystem, TextureDataFromSystem) {
...
export var drawPartOfTextureByCanvas = function (source, canvasWidth, canvasHeight, sx, sy) {
