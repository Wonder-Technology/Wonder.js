...
export const createTypeArraysOnlyOnce = (renderCommandBufferData: BasicWorkerRenderCommandBufferForDrawData, DataBufferConfig: any, BasicRenderCommandBufferWorkerData: any) => {
