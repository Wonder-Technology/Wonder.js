...
export declare var initLocationData: (LocationDataFromSystem: any) => void;
export declare var initGLSLSenderData: (GLSLSenderDataFromSystem: any) => void;
...
export declare var initLightData: (AmbientLightData: any, DirectionLightData: any, PointLightData: any) => void;
export declare var initGameObjectData: (GameObjectData: any) => void;
export declare var initSceneData: (SceneData: any) => void;
export declare var initRenderCommandBufferData: (DataBufferConfig: any, RenderCommandBufferData: any) => void;
export declare var initDrawRenderCommandBufferData: (DrawRenderCommandBufferDataFromSystem: any) => void;
