...
var Matrix4 = Matrix4_1 = (function () {
    ...
    Matrix4.prototype.invertTo3x3 = function () {
        ...
        var mat3 = Matrix3_1.Matrix3.create();
        m = this.values;
        r = mat3.values;
        ...
        if (det === 0) {
            Log_1.Log.warn("can't invert matrix, determinant is 0");
            return mat3;
        }
        idet = 1 / det;
        r[0] = idet * a11;
    ...
    Matrix4.prototype.setLookAt = function () {
        ...
        if (args.length === 3) {
            ...
            eye = Vector3_1.Vector3.create(args[0], args[1], args[2]);
            center = Vector3_1.Vector3.create(args[3], args[4], args[5]);
            up = Vector3_1.Vector3.create(args[6], args[7], args[8]);
        }
        x = Vector3_1.Vector3.create();
    ...
    Matrix4.prototype.setPerspective = function (fovy, aspect, near, far) {
        ...
        s = Math.sin(fovy);
        Log_1.Log.error(s === 0, Log_1.Log.info.FUNC_MUST_NOT_BE("frustum", "null"));
        rd = 1 / (far - near);
        ct = Math.cos(fovy) / s;
        e = this.values;
        e[0] = ct / aspect;
    ...
    Matrix4.prototype.multiplyVector4 = function (vector) {
        ...
        return Vector4_1.Vector4.create(result[0], result[1], result[2], result[3]);
    };
    Matrix4.prototype.multiplyVector3 = function (vector) {
        ...
        return Vector3_1.Vector3.create(result[0], result[1], result[2]);
    };
    ...
    Matrix4.prototype.getY = function () {
        return Vector3_1.Vector3.create(this.values[4], this.values[5], this.values[6]);
    };
    Matrix4.prototype.getZ = function () {
        return Vector3_1.Vector3.create(this.values[8], this.values[9], this.values[10]);
    };
    Matrix4.prototype.getTranslation = function () {
        return Vector3_1.Vector3.create(this.values[12], this.values[13], this.values[14]);
    };
    Matrix4.prototype.getScale = function () {
        return Vector3_1.Vector3.create(this.getX().length(), this.getY().length(), this.getZ().length());
    };
    Matrix4.prototype.getRotation = function () {
        return Quaternion_1.Quaternion.create().setFromMatrix(this);
    };
    Matrix4.prototype.getEulerAngles = function () {
        ...
        return Vector3_1.Vector3.create(x, y, z).scale(Global_1.RAD_TO_DEG);
    };
...
__decorate([
    contract_1.requireCheck(function (angle, x, y, z) {
        contract_1.it("axis's component shouldn't all be zero", function () {
            wonder_expect_js_1.default(x === 0 && y === 0 && z === 0).false;
        });
    })
...
Matrix4 = Matrix4_1 = __decorate([
    registerClass_1.registerClass("Matrix4")
], Matrix4);
