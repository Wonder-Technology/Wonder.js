...
var Quaternion = Quaternion_1 = (function () {
    ...
    Quaternion.prototype.setFromEulerAngles = function (eulerAngles) {
        ...
        halfToRad = 0.5 * Global_1.DEG_TO_RAD;
        ex *= halfToRad;
        ey *= halfToRad;
        ez *= halfToRad;
        sx = Math.sin(ex);
    ...
    Quaternion.prototype.multiplyVector3 = function (vector) {
        ...
        return Vector3_1.Vector3.create(ix * qw + iw * -qx + iy * -qz - iz * -qy, iy * qw + iw * -qy + iz * -qx - ix * -qz, iz * qw + iw * -qz + ix * -qy - iy * -qx);
    };
