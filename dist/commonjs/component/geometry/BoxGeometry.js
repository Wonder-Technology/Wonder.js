...
var GeometryUtils_1 = require("./GeometryUtils");
var BoxGeometry = (function (_super) {
    ...
    BoxGeometry.prototype.computeData = function () {
        ...
        function generateFace(side, uSegments, vSegments) {
            ...
            for (i = 0; i <= uSegments; i++) {
                for (j = 0; j <= vSegments; j++) {
                    var temp1 = Vector3_1.Vector3.create();
                    var temp2 = Vector3_1.Vector3.create();
                    var temp3 = Vector3_1.Vector3.create();
                    var r = Vector3_1.Vector3.create();
        ...
        return {
            vertices: vertices,
            faces: GeometryUtils_1.GeometryUtils.convertToFaces(indices)
        };
    };
    return BoxGeometry;
}(Geometry_1.Geometry));
