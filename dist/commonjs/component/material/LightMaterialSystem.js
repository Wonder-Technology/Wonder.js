...
exports.create = contract_1.ensureFunc(function (component) {
    contract_1.it("index should <= max count", function () {
        wonder_expect_js_1.expect(component.index).lt(bufferUtils_1.getLightMaterialBufferStartIndex() + bufferUtils_1.getLightMaterialBufferCount());
    });
...
exports.getDiffuseMapIndex = function (LightMaterialData) {
...
exports.setDiffuseMap = function (index, map, MapManagerData, TextureData) {
    ...
    LightMaterialData_1.LightMaterialData.diffuseMapIndex = map.index;
};
exports.getSpecularMapIndex = function (LightMaterialData) {
...
exports.setSpecularMap = function (index, map, MapManagerData, TextureData) {
    ...
    LightMaterialData_1.LightMaterialData.specularMapIndex = map.index;
};
...
exports.initData = function (LightMaterialData) {
    SpecifyMaterialSystem_1.initData(bufferUtils_1.getLightMaterialBufferStartIndex(), LightMaterialData);
...
var _setLightMaterialDefaultTypeArrData = function (count, LightMaterialData) {
    var startIndex = bufferUtils_1.getLightMaterialBufferStartIndex(), color = MaterialSystem_1.createDefaultColor(), emptyColor = LightMaterialData.emptyColor, shading = LightMaterialData.defaultShading, lightModel = LightMaterialData.defaultLightModel, shininess = LightMaterialData.defaultShininess;
    count += startIndex;
