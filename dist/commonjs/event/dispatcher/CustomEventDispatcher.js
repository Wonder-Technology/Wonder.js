...
var EEventPhase_1 = require("../object/EEventPhase");
var CustomEventDispatcher = (function (_super) {
    ...
    CustomEventDispatcher.prototype.trigger = function () {
        ...
        if (length === 1) {
            ...
            return EventHandlerFactory_1.EventHandlerFactory.createEventHandler(eventType)
                .trigger(event_1);
        }
        ...
        else if ((length === 2 && EventUtils_1.EventUtils.isEntityObject(args[0])) || (length === 3 && JudgeUtils_1.JudgeUtils.isBoolean(args[2]))) {
    ...
    CustomEventDispatcher.prototype.emit = function (target, eventObject, userData) {
        ...
        eventObject.phase = EEventPhase_1.EEventPhase.EMIT;
    ...
    CustomEventDispatcher.prototype.broadcast = function (target, eventObject, userData) {
        ...
        eventObject.phase = EEventPhase_1.EEventPhase.BROADCAST;
        eventObject.target = target;
...
CustomEventDispatcher = __decorate([
    ...
    registerClass_1.registerClass("CustomEventDispatcher")
], CustomEventDispatcher);
exports.CustomEventDispatcher = CustomEventDispatcher;
