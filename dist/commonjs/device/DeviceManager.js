...
var DeviceManager = (function () {
    function DeviceManager() {
        ...
        this._scissorRegion = RectRegion_1.RectRegion.create();
        this._viewport = RectRegion_1.RectRegion.create();
            ...
            if (this._polygonOffsetMode !== polygonOffsetMode) {
                switch (polygonOffsetMode) {
                    ...
                    case EPolygonOffsetMode.CUSTOM:
                        gl.enable(gl.POLYGON_OFFSET_FILL);
                        Log_1.Log.error(!this.polygonOffset, Log_1.Log.info.FUNC_MUST_DEFINE("polygonOffset"));
    ...
    DeviceManager.prototype.createGL = function (canvasId, contextConfig, useDevicePixelRatio) {
        ...
        if (!!canvasId) {
            canvas = DomQuery_1.DomQuery.create(this._getCanvasId(canvasId)).get(0);
        }
        else {
            canvas = DomQuery_1.DomQuery.create("<canvas></canvas>").prependTo("body").get(0);
        }
        this.view = View_1.ViewWebGL.create(canvas);
        if (useDevicePixelRatio) {
            this.setPixelRatio(Variable_1.root.devicePixelRatio);
        }
    ...
    DeviceManager.prototype.setScreen = function () {
        var screenSize = MainData_1.MainData.screenSize, x = null, y = null, width = null, height = null, styleWidth = null, styleHeight = null;
        if (screenSize === EScreenSize_1.EScreenSize.FULL) {
            x = 0;
            y = 0;
            width = Variable_1.root.innerWidth;
            height = Variable_1.root.innerHeight;
            styleWidth = "100%";
            styleHeight = "100%";
            ...
            x = screenSize.x || 0;
            y = screenSize.y || 0;
            width = screenSize.width || Variable_1.root.innerWidth;
            height = screenSize.height || Variable_1.root.innerHeight;
            styleWidth = width + "px";
...
__decorate([
    contract_1.requireCheck(function () {
        contract_1.it("should exist MainData.screenSize", function () {
            wonder_expect_js_1.default(MainData_1.MainData.screenSize).exist;
        });
    })
], DeviceManager.prototype, "setScreen", null);
__decorate([
    contract_1.requireCheck(function (level) {
        contract_1.it("level should > 0, but actual is " + level, function () {
            wonder_expect_js_1.default(level).greaterThan(0);
        });
    })
], DeviceManager.prototype, "setHardwareScaling", null);
__decorate([
    contract_1.ensure(function (id) {
        contract_1.it("canvas id should be #xxx", function () {
            wonder_expect_js_1.default(/#[^#]+/.test(id)).true;
        });
    })
...
})(EDepthFunction = exports.EDepthFunction || (exports.EDepthFunction = {}));
var ESide;
(function (ESide) {
...
})(EPolygonOffsetMode = exports.EPolygonOffsetMode || (exports.EPolygonOffsetMode = {}));
var EBlendFunc;
(function (EBlendFunc) {
...
})(EBlendFunc = exports.EBlendFunc || (exports.EBlendFunc = {}));
var EBlendEquation;
...
})(EBlendEquation = exports.EBlendEquation || (exports.EBlendEquation = {}));
var EBlendType;
(function (EBlendType) {
...
})(EBlendType = exports.EBlendType || (exports.EBlendType = {}));
var ECanvasType;
(function (ECanvasType) {
    ECanvasType[ECanvasType["TwoDUI"] = "TwoDUI"] = "TwoDUI";
})(ECanvasType = exports.ECanvasType || (exports.ECanvasType = {}));
