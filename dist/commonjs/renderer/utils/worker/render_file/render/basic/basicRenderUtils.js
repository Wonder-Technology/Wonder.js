...
exports.sendUniformData = function (gl, materialIndex, shaderIndex, program, drawDataMap, renderCommandUniformData, sendDataMap, uniformLocationMap, uniformCacheMap, materialData, basicMaterialData) {
...
exports.buildSendUniformDataDataMap = function (sendFloat1, sendFloat3, sendMatrix4, sendVector3, sendInt, sendMatrix3, drawDataMap) {
    return {
        glslSenderData: {
...
exports.buildBasicMaterialDataForGetUniformData = function (BasicMaterialDataFromSystem) {
    return {
