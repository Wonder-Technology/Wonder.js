...
exports.bindToUnit = function (gl, unitIndex, textureIndex, TextureCacheDataFromSystem, TextureDataFromSystem, isCached, addActiveTexture) {
...
exports.disposeGLTexture = function (gl, sourceIndex, lastComponentIndex, TextureCacheDataFromSystem, TextureDataFromSystem) {
...
exports.drawPartOfTextureByCanvas = function (source, canvasWidth, canvasHeight, sx, sy) {
    var canvas = DomQuery_1.DomQuery.create("<canvas></canvas>").get(0), ctx = null;
