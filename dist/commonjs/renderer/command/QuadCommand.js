...
var QuadCommand = (function (_super) {
    ...
    return QuadCommand;
}(RenderCommand_1.RenderCommand));
__decorate([
    contract_1.requireGetter(function () {
        contract_1.assert(!!this.mMatrix && !!this.vMatrix && !!this.pMatrix, Log_1.Log.info.FUNC_NOT_EXIST("mMatrix or vMatrix or pMatrix"));
    })
], QuadCommand.prototype, "mvpMatrix", null);
__decorate([
    contract_1.requireGetter(function () {
        contract_1.assert(!!this.vMatrix && !!this.pMatrix, Log_1.Log.info.FUNC_NOT_EXIST("vMatrix or pMatrix"));
    })
