...
var VerticeCommonShaderLib = (function (_super) {
    ...
    VerticeCommonShaderLib.prototype._sendAttributeVariables = function (program, cmd) {
        var verticeBuffer = cmd.buffers.getChild(EBufferDataType_1.EBufferDataType.VERTICE);
        if (!verticeBuffer) {
            return;
        }
...
VerticeCommonShaderLib = __decorate([
    registerClass_1.registerClass("VerticeCommonShaderLib")
], VerticeCommonShaderLib);
exports.VerticeCommonShaderLib = VerticeCommonShaderLib;
