...
exports.buildGLSLSource = contract_1.requireCheckFunc(function (materialIndex, materialShaderLibNameArr, shaderLibData, funcDataMap, initShaderDataMap) {
    ...
    vsBody += ShaderSnippet_1.webgl1_main_begin;
    fsBody += ShaderSnippet_1.webgl1_main_begin;
    ...
    vsBody += ShaderSnippet_1.webgl1_main_end;
    fsBody += ShaderSnippet_1.webgl1_main_end;
