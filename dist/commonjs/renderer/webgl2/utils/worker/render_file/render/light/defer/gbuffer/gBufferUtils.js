...
exports.init = function (gl, GBufferData) {
...
exports.bindGBufferTargets = function (gl, GBufferData) {
...
exports.sendGBufferTargetData = function (gl, lightPassProgram) {
...
exports.bindGBuffer = function (gl, GBufferData) {
    gl.bindFramebuffer(gl.FRAMEBUFFER, GBufferData.gBuffer);
};
exports.unbindGBuffer = function (gl) {
    gl.bindFramebuffer(gl.FRAMEBUFFER, null);
};
exports.getNewTextureUnitIndex = function () { return 3; };
