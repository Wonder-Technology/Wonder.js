...
export declare var getUniformData: (field: string, from: string, renderCommandUniformData: RenderCommandUniformData, MaterialWorkerData: any, BasicMaterialWorkerData: any, LightMaterialWorkerData: any) => any;
