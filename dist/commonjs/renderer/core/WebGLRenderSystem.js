...
if (WorkerDetectSystem_1.isSupportRenderWorkerAndSharedArrayBuffer()) {
    ...
    var _init_1 = function (state, lightData, renderData) {
        MapManagerSystem_1.initMapManagers(null, TextureData_1.TextureData);
        var renderWorker = WorkerInstanceSystem_1.getRenderWorker(WorkerInstanceData_1.WorkerInstanceData), needAddedImageDataArr = TextureSystem_1.convertAllSourceMapToImageDataArr(TextureSystem_1.getNeedAddedSourceArr(TextureData_1.TextureData), DomQuery_1.DomQuery), transferList = [];
        ...
        TextureSystem_1.clearNeedAddedSourceArr(TextureData_1.TextureData);
        TextureSystem_1.clearNeedInitTextureDataArr(TextureData_1.TextureData);
