...
declare module 'wonder.js/dist/commonjs' {
    ...
    export { BasicMaterial, createBasicMaterial, initBasicMaterial, getBasicMaterialColor, setBasicMaterialColor, getBasicMaterialOpacity, setBasicMaterialOpacity, getBasicMaterialAlphaTest, setBasicMaterialAlphaTest, addBasicMaterialMap } from "wonder.js/dist/commonjs/component/material/BasicMaterial";
    ...
    export { Texture, createTexture, disposeTexture, getTextureSource, setTextureSource, getTextureWidth, setTextureWidth, getTextureHeight, setTextureHeight, getTextureIsNeedUpdate, setTextureIsNeedUpdate } from "wonder.js/dist/commonjs/renderer/texture/Texture";
...
declare module 'wonder.js/dist/commonjs/core/entityObject/gameObject/GameObject' {
    ...
    export var addRemovedGameObject: Function;
...
declare module 'wonder.js/dist/commonjs/renderer/worker/both_file/EWorkerOperateType' {
    export enum EWorkerOperateType {
        ...
        INIT_DATA = 1,
        INIT_GL = 2,
        INIT_MATERIAL_GEOMETRY_LIGHT_TEXTURE = 3,
        DRAW = 4,
    }
}
...
declare module 'wonder.js/dist/commonjs/renderer/worker/render_file/initGL' {
    ...
    export var initGL: (data: MessageInitGLData, detect: Function, WebGLDetectWorkerData: any, GPUDetectWorkerData: any) => any;
}
...
declare module 'wonder.js/dist/commonjs/renderer/worker/render_file/state/StateWorkerSytem' {
    import { Map } from "immutable";
    export var getState: (StateWorkerData: any) => any;
    export var setState: (state: Map<any, any>, StateWorkerData: any) => void;
}
...
declare module 'wonder.js/dist/commonjs/test/forRenderWorkerUnitTest' {
    ...
    export var initWebGL1GLSLSenderWorkerData: (GLSLSenderDataFromSystem: any) => void;
    export var initWebGL2GLSLSenderWorkerData: (GLSLSenderDataFromSystem: any) => void;
    export var initWebGL1LocationWorkerData: (LocationDataFromSystem: any) => void;
    export var initWebGL2LocationWorkerData: (LocationDataFromSystem: any) => void;
    export var initWebGL1ShaderWorkerData: (ShaderDataFromSystem: any) => void;
    export var initWebGL2ShaderWorkerData: (ShaderDataFromSystem: any) => void;
    export var initWebGL1LightWorkerData: (lightData: {
        ambientLightData: {
            buffer: SharedArrayBuffer;
            bufferCount: number;
            lightCount: number;
    ...
    export var initWebGL2LightWorkerData: (lightData: {
        directionLightData: {
            buffer: SharedArrayBuffer;
            bufferCount: number;
            lightCount: number;
    ...
    export var initDrawRenderCommandBufferWorkerData: (BasicDrawRenderCommandBufferDataFromSystem: any, LightDrawRenderCommandBufferDataFromSystem: any) => void;
    export var initArrayBufferWorkerData: (ArrayBufferDataFromSystemFromSystem: any) => void;
    export var initIndexBufferWorkerData: (IndexBufferDataFromSystem: any) => void;
    export var initVaoWorkerData: (VaoDataFromSystem: any) => void;
    export var getDirectionLightPositionInShaderWorker: (index: number, DirectionLightDataFromSystem: any) => any;
    export var getPointLightPositionInShaderWorker: (index: number, PointLightDataFromSystem: any) => any;
...
declare module 'wonder.js/dist/commonjs/test/forUnitTest' {
    ...
    export var initGeometryData: (DataBufferConfig: any, GeometryData: any, GPUDetectData: any) => void;
    ...
    export var initWebGL1ShaderData: (ShaderDataFromSystem: any) => void;
    export var initWebGL2ShaderData: (ShaderDataFromSystem: any) => void;
    export var initProgramData: (ProgramDataFromSystem: any) => void;
    export var initWebGL1LocationData: (LocationDataFromSystem: any) => void;
    export var initWebGL2LocationData: (LocationDataFromSystem: any) => void;
    export var initWebGL1GLSLSenderData: (GLSLSenderDataFromSystem: any) => void;
    export var initWebGL2GLSLSenderData: (GLSLSenderDataFromSystem: any) => void;
    ...
    export var initWebGL1LightData: (AmbientLightData: any, DirectionLightData: any, PointLightData: any) => void;
    export var initWebGL2LightData: (AmbientLightData: any, DirectionLightData: any, PointLightData: any) => void;
    export var initGameObjectData: (GameObjectData: any) => void;
    export var initSceneData: (SceneData: any) => void;
    export var initRenderCommandBufferData: (DataBufferConfig: any, BasicRenderCommandBufferData: any, LightRenderCommandBufferData: any) => void;
    export var initDrawRenderCommandBufferData: (BasicDrawRenderCommandBufferDataFromSystem: any, LightDrawRenderCommandBufferDataFromSystem: any) => void;
    export var initSendDrawRenderCommandBufferData: (SendDrawRenderCommandBufferData: any) => void;
    export var initVaoData: (VaoDataFromSystem: any) => void;
    export var initDeferLightPassData: (DeferAmbientLightPassDataFromSystem: any, DeferDirectionLightPassDataFromSystem: any, DeferPointLightPassDataFromSystem: any) => void;
    export var createState: () => Map<{}, {}>;
    export var useProgram: any;
    export var sendWebGL1AttributeData: (gl: WebGLRenderingContext, shaderIndex: number, program: WebGLProgram, geometryIndex: number, ProgramData: any, LocationData: any, GLSLSenderData: any, GeometryData: any, ArrayBufferData: any, GPUDetectData: any, VaoData: any) => void;
    ...
    export var getWorldToCameraMatrix: (...args: any[]) => any;
}
...
declare module 'wonder.js/dist/commonjs/renderer/type/messageDataType' {
    ...
    import { ContextConfigOptionsData, DisposedTextureDataMap } from "wonder.js/dist/commonjs/renderer/type/dataType";
    import { EBufferType } from "wonder.js/dist/commonjs/renderer/enum/EBufferType";
