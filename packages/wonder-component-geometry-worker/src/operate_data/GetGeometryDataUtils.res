...
let getData = (.
  ...
  switch dataName {
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.vertices =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.normals =>
    WonderComponentWorkerUtils.NormalsUtils.getNormals(normals, normalsInfos, isDebug, geometry)
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.texCoords =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.tangents =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.indices =>
  ...
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.vertices =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == WonderComponentTypeGeometryWorker.Index.dataName.indicesCount =>
