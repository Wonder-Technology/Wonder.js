(function (global, factory) {
	...
	function mergeData(data, source) {
	  ...
	  var isCombo =
	    ((srcBitmask == WRAP_ARY_FLAG$3) && (bitmask == WRAP_CURRY_FLAG$6)) ||
	    ((srcBitmask == WRAP_ARY_FLAG$3) && (bitmask == WRAP_REARG_FLAG$2) && (data[7].length <= source[8])) ||
	    ((srcBitmask == (WRAP_ARY_FLAG$3 | WRAP_REARG_FLAG$2)) && (source[7].length <= source[8]) && (bitmask == WRAP_CURRY_FLAG$6));
	...
	var _dirtyList = [];
	var setPosition = function (indexInArrayBuffer, position) {
	    _data.positions[indexInArrayBuffer] = position;
	};
	var getPosition = function (indexInArrayBuffer) {
	...
	var transformData = function (world, data) {
	...
	var updateAll = flow(updateTransform, updateOther);
	var updateLogicWorld = function (world, elapsed) {
	    updateAll(world);
	};
