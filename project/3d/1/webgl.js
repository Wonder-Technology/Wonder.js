...
// 程序对象的生成和着色器连接的函数
    ...
    function createAndBindVBO(data, size, stride, offset){
        ...
        a_position = gl.getAttribLocation(prg, "a_position");
        if (a_position < 0) {
            console.log('Failed to get the storage location of a_position');
            return -1;
        }

        gl.vertexAttribPointer(a_position, size, gl.FLOAT, false, stride || 0, offset || 0);
