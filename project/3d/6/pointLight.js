...
var latitudeBands = 10;
    ...
    function draw(vertices_num){
        ...
        var modelMatrix = mMatrix.copy();

        var u_mMatrix = gl.getUniformLocation(prg, 'u_mMatrix');

        gl.uniformMatrix4fv(u_mMatrix, false, modelMatrix.values);
        ...
        var u_lightColor = gl.getUniformLocation(prg, "u_lightColor");
        ...
        var u_ambientLightColor = gl.getUniformLocation(prg, "u_ambientLightColor");

        //设置环境光颜色
        gl.uniform3f(u_ambientLightColor, 0.2, 0.2, 0.2);


        //var u_lightDirection = gl.getUniformLocation(prg, "u_lightDirection");
        //
        ////var lightDirection = Math3D.Vector3.create(0.5, 3.0, 4.0);
        //var lightDirection = Math3D.Vector3.create(1.0, 0.0, 0.0);
        //lightDirection.normalize();
        //
        //gl.uniform3fv(u_lightDirection, lightDirection.values);


        var u_lightPosition = gl.getUniformLocation(prg, "u_lightPosition");

        gl.uniform3f(u_lightPosition, -1.0, 3.0, 2.0);
