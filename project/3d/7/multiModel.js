...
var latitudeBands = 10;
    ...
    var cubicPrg = initShaders("cubic-vs", "cubic-fs");
    var spherePrg = initShaders("sphere-vs", "sphere-fs");
    ...
    cubicPrg.a_position = gl.getAttribLocation(cubicPrg, "a_position");
    cubicPrg.u_mvpMatrix = gl.getUniformLocation(cubicPrg, 'u_mvpMatrix');
    ...
    var texture = initTextures(gl, spherePrg);
    ...
    var tick = function() {   // Start drawing
        ...
        drawTexCube(gl, spherePrg, sphereModel, texture, vMatrix);
