...
let _ =
  describe(
    ...
    () => {
      ...
      let page = ref(None);
      beforeAllPromise(
        () => BenchmarkTool.prepareForHeadless(~scriptFilePathList=[ "./test/performance/js/BasicBoxesTool.js", "./test/performance/js/InstanceBasicBoxesTool.js", "./test/performance/js/CameraTool.js"],"instance_basic_boxes.json", browser, page, state)
      );
