...
let prepareForNoHeadless = (~defaultConfig={"isClosePage": true, "execCount": 50, "extremeCount": 5}, ~ciConfig={"isClosePage": true, "execCount": 80, "extremeCount": 8}, defaultFileName, ciFileName, browser, page, state) => {
