...
[
      ...
      beforeEach(
        () => {
          ...
          state := InitLightMaterialJobTool.initWithJobConfig(sandbox, _buildNoWorkerJobConfig())
        }
      );
      ...
      describe(
        ...
        () => {
          let _testGetLocationWithPrepareGameObjectFunc = (name, prepareGameObjectFunc) =>
