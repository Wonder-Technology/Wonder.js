...
let createTwoMaps = (state) => {
  ...
  let state =
    state
    |> ArrayBufferViewSourceTextureAPI.setArrayBufferViewSourceTextureWidth(map1, 10)
    |> ArrayBufferViewSourceTextureAPI.setArrayBufferViewSourceTextureHeight(map1, 20);
  let state =
    state
    |> ArrayBufferViewSourceTextureAPI.setArrayBufferViewSourceTextureWidth(map2, 10)
    |> ArrayBufferViewSourceTextureAPI.setArrayBufferViewSourceTextureHeight(map2, 20);
