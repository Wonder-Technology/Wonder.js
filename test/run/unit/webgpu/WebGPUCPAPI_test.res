...
let _ = describe("WebGPUCPAPI", () => {
  ...
  describe("getTextureArrayLayerSize", () =>
    test("test default", () => WebGPUCPAPI.getTextureArrayLayerSize()->expect == (2048, 2048))
  )

  describe("setTextureArrayLayerSize", () => test("set layer width, height", () => {
