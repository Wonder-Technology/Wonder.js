let getSceneDescBufferData = () => PathTracingPassCPRepo.getSceneDescBufferData()->OptionSt.getExn

let getPointIndexBufferData = () => PathTracingPassCPRepo.getPointIndexBufferData()->OptionSt.getExn

let getVertexBufferData = () => PathTracingPassCPRepo.getVertexBufferData()->OptionSt.getExn

let getIndexBufferData = () => PathTracingPassCPRepo.getIndexBufferData()->OptionSt.getExn

let getBSDFMaterialBufferData = () =>
  PathTracingPassCPRepo.getBSDFMaterialBufferData()->OptionSt.getExn

let getShaderBindingTable = () => PathTracingPassCPRepo.getShaderBindingTable()->OptionSt.getExn
...
let getAllStaticBindGroupData = () => PathTracingPassCPRepo.getAllStaticBindGroupData()

let getPipeline = () => PathTracingPassCPRepo.getPipeline()->OptionSt.getExn
...
let createAndSetShaderBindingTable = () =>
  WebGPURayTracingDependencyTool.createShaderBindingTableObject()->PathTracingPassCPRepo.setShaderBindingTable
...
let createAndSetAllBindGroupLayoutsAndBindGroupsExceptRayTracing = () => {
  ...
  WebGPUDependencyTool.createBindGroupLayoutObject()->PathTracingPassCPRepo.setCameraBindGroupLayout
