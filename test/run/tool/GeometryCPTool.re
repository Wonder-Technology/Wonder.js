  ...
  (
    SceneGraphRepoDependencyTool.buildGeometryRepo(
      ...
      ~getNormals=
        geometry =>
          switch (geometry) {
          | geometry when geometry == geometry1 =>
            Js.Nullable.return(normals1)
          | geometry when geometry == geometry2 =>
            Js.Nullable.return(normals2)
          },
      ~getTexCoords=
        geometry =>
          switch (geometry) {
          | geometry when geometry == geometry1 =>
            Js.Nullable.return(texCoords1)
          | geometry when geometry == geometry2 =>
            Js.Nullable.return(texCoords2)
          },
      ~getTangents=
        geometry =>
          switch (geometry) {
          | geometry when geometry == geometry1 =>
            Js.Nullable.return(tangents1)
          | geometry when geometry == geometry2 =>
            Js.Nullable.return(tangents2)
          },
      ~getIndices=
        geometry =>
          switch (geometry) {
          | geometry when geometry == geometry1 =>
            Js.Nullable.return(indices1)
          | geometry when geometry == geometry2 =>
            Js.Nullable.return(indices2)
          },
      (),
    ),
    (
