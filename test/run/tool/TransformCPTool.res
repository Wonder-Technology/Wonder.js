...
let buildRepoWithTwoTransforms = sandbox => {
  ...
  let normalMatrix1 = Float32Array.make([
    0.9980211853981018,
    0.05230407789349556,
    -0.03489949554204941,
    -0.02585987187922001,
  ...
  let normalMatrix2 = Float32Array.make([
    0.17057371139526367,
    0.09848077595233917,
    -0.03472963720560074,
    -0.04832844436168671,
  ...
  let localToWorldMatrix1 = Float32Array.make([
    0.9980211853981018,
    0.05230407789349556,
    -0.03489949554204941,
    0.,
  ...
  let localToWorldMatrix2 = Float32Array.make([
    4.264342784881592,
    2.462019205093384,
    -0.8682408928871155,
    0.,
