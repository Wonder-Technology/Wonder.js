...
let _ = describe("test render_pathTracing_pass job", () => {
  open Expect
        ...
        groups: list{
          {
            name: "frame",
            link: Concat,
            elements: list{{name: "render_pathTracing_pass", type_: Job}},
          },
        },
      },
      (),
      ...
      ~handleSuccessFunc=() =>
        (
          ...
          ->SinonTool.calledWithArg2(
            Wonderjs.IWebGPURayTracingDp.passEncoderRayTracingDescriptor(),
            commandEncoder,
          ),
        )->expect == (true, true),
      (),
