...
let _ = describe("test init_camera job", () => {
  open Expect
        ...
        groups: list{
          {
            name: "frame",
            link: Concat,
            elements: list{{name: "init_camera", type_: Job}},
          },
        },
      },
      (),
  ...
  describe("build camera buffer data and set to po", () => {
    testPromise("create camera buffer", () => {
      ...
      DirectorCPTool.init(~handleSuccessFunc=() => {
        ...
        ->SinonTool.toCalledWith((
          {
            "size": (16 + 16 + 2) * Js.Typed_array.Float32Array._BYTES_PER_ELEMENT,
    ...
    testPromise("create type arr", () => {
      ...
      DirectorCPTool.init(~handleSuccessFunc=() => {
        ...
        typeArr->expect == Js.Typed_array.Float32Array.fromLength(16 + 16 + 2)
      }, ())
    })
  })
})
