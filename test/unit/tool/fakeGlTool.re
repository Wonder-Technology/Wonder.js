...
let buildFakeGl =
    (
      ...
      ~createProgram=createEmptyStub(refJsObjToSandbox(sandbox^)) |> setReturn(Obj.magic(100)),
      ...
      ~getProgramParameter=createEmptyStub(refJsObjToSandbox(sandbox^)) |> setReturn(Js.true_),
      ...
      ~getAttribLocation=createEmptyStub(refJsObjToSandbox(sandbox^)) |> setReturn(0),
      ~getUniformLocation=createEmptyStub(refJsObjToSandbox(sandbox^)) |> setReturn(0),
