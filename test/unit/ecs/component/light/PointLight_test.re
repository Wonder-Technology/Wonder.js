...
let _ =
  describe("PointLight", () => {
    ...
    describe("unsafeGetPointLightGameObject", () =>
    ...
    describe("getPointLightConstant", () =>
      test("test default constant", () => {
        let (state, light) = createPointLight(state^);
        getPointLightConstant(light, state) |> expect == 1.;
      })
    );
    describe("setPointLightConstant", () =>
      test("test set constant", () => {
        let (state, light) = createPointLight(state^);
        let constant = 2.;
    ...
    describe("getPointLightLinear", () =>
      test("test default linear", () => {
        let (state, light) = createPointLight(state^);
    ...
    describe("setPointLightLinear", () =>
      test("test set linear", () => {
        let (state, light) = createPointLight(state^);
        let linear = 2.;
    ...
    describe("getPointLightQuadratic", () =>
      test("test default quadratic", () => {
        let (state, light) = createPointLight(state^);
    ...
    describe("setPointLightQuadratic", () =>
      test("test set quadratic", () => {
        let (state, light) = createPointLight(state^);
        let quadratic = 2.;
        ...
        describe("test remove from type array", () => {
          describe("remove from colors", () => {
            let _prepare = state => {
              ...
              let state =
                state |> PointLightAPI.setPointLightColor(light2, color2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
          ...
          describe("remove from intensities", () => {
            let _prepare = state => {
              ...
              let state =
                state
                |> PointLightAPI.setPointLightIntensity(light2, intensity2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
          ...
          describe("remove from constants", () => {
            let _prepare = state => {
              ...
              let state =
                state
                |> PointLightAPI.setPointLightConstant(light2, constant2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
          ...
          describe("remove from linears", () => {
            let _prepare = state => {
              ...
              let state =
                state |> PointLightAPI.setPointLightLinear(light2, linear2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
          ...
          describe("remove from quadratics", () => {
            let _prepare = state => {
              ...
              let state =
                state
                |> PointLightAPI.setPointLightQuadratic(light2, quadratic2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
          ...
          describe("remove from ranges", () => {
            let _prepare = state => {
              ...
              let state =
                state |> PointLightAPI.setPointLightRange(light2, range2);
              let state =
                state
                |> GameObjectTool.disposeGameObjectPointLightComponent(
                     gameObject1,
    ...
    describe("contract check: is alive", () =>
      describe("if light is disposed", () => {
        ...
        test("unsafeGetPointLightGameObject should error", () =>
          _testGetFunc(unsafeGetPointLightGameObject)
        );
        test("getPointLightColor should error", () =>
          _testGetFunc(getPointLightColor)
        );
        test("getPointLightIntensity should error", () =>
          _testGetFunc(getPointLightIntensity)
        );
        test("getPointLightConstant should error", () =>
          _testGetFunc(getPointLightConstant)
        );
        test("getPointLightLinear should error", () =>
          _testGetFunc(getPointLightLinear)
        );
        test("getPointLightQuadratic should error", () =>
          _testGetFunc(getPointLightQuadratic)
        );
        test("getPointLightRange should error", () =>
          _testGetFunc(getPointLightRange)
        );
      })
    );
    ...
    describe("setRangeLevel", () => {
      let _test = (level, (range, linear, quadratic), state) => {
        let (state, light) = createPointLight(state^);
        let state =
          state |> PointLightAPI.setPointLightRangeLevel(light, level);
        (
      ...
      test("test set level 0", () =>
        _test(0, (7., 0.7, 1.8), state)
      );
      test("test set level 1", () =>
        _test(1, (13., 0.35, 0.44), state)
      );
      test("test set level 2", () =>
        _test(2, (20., 0.22, 0.20), state)
      );
      test("test set level 3", () =>
        _test(3, (32., 0.14, 0.07), state)
      );
      test("test set level 4", () =>
        _test(4, (50., 0.09, 0.032), state)
      );
      test("test set level 5", () =>
        _test(5, (65., 0.07, 0.017), state)
      );
      test("test set level 6", () =>
        _test(6, (100., 0.045, 0.0075), state)
      );
      test("test set level 7", () =>
        _test(7, (160., 0.027, 0.0028), state)
      );
      test("test set level 8", () =>
        _test(8, (200., 0.022, 0.0019), state)
      );
      test("test set level 9", () =>
        _test(9, (325., 0.014, 0.0007), state)
      );
      test("test set level 10", () =>
        _test(10, (600., 0.007, 0.0002), state)
      );
      test("test set level 11", () =>
        _test(11, (3250., 0.0014, 0.000007), state)
      );
      test("if level > 11, fatal", () => {
        let (state, light) = createPointLight(state^);
        expect(() => {
          let state =
            state |> PointLightAPI.setPointLightRangeLevel(light, 12);
          ();
        })
