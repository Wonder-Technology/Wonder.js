                ...
                () => {
                  ...
                  test(
                    ...
                    () => {
                      ...
                      let {groupCountMap, gameObjectMap} = GeometryTool.getRecord(state);
                      (
            ...
            () =>
              describe(
                ...
                () => {
                  ...
                  test(
                    "getGeometryTexCoords should error",
                    () => _testGetFunc(getGeometryTexCoords)
                  );
                  test(
                    "getGeometryNormals should error",
                    () => _testGetFunc(getGeometryNormals)
                  );
                  test(
                    "getGeometryIndices should error",
                    () => _testGetFunc(getGeometryIndices)
                  );
                  test(
                    "unsafeGetGeometryGameObject should error",
                  ...
                  test(
                    "setGeometryTexCoords should error",
                    () => _testSetFunc(setGeometryTexCoords)
                  );
                  test(
                    "setGeometryNormals should error",
                    () => _testSetFunc(setGeometryNormals)
                  );
                  test(
                    "setGeometryIndices should error",
