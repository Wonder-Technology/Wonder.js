describe("Tween", function () {
    ...
    describe("from,to, onUpdate,onFinish,onStart,onStop, start,stop", function(){
        it("test", function(){
            ...
            wd.ActionManager.getInstance().update(1);
            ...
            wd.ActionManager.getInstance().update(101);
            expect(startCount).toEqual(2);

            wd.ActionManager.getInstance().update(125);
            expect(x).toEqual(1);
    ...
    describe("interpolation", function(){
        it("when the tween has just started (progress is 0), the interpolation function will return the first value in the array. " +
            ...
            action.start();
            wd.ActionManager.getInstance().update(0);
            expect(x).toEqual(0);
    ...
    describe("reverse", function(){
        it("reverse from and to", function(){
            ...
            wd.ActionManager.getInstance().update(10);
