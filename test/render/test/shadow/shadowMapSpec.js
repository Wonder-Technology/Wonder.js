describe("shadowMap", function () {
    ...
    describe("scene test", function(){
        ...
        describe("test direction light shadow", function(){
            ...
            it("test", function(done){
                tester.compareAt(1, "shadow/shadow_direction_shadowMap.png", done);
            });
        });

        describe("test multi direction lights shadow", function(){
            function body(wrapper){
                wrapper.load([
                        {url: "../../asset/texture/1.jpg", id: "texture"},
                        {url: "../../asset/texture/crate.gif", id: "ground"}
            ...
            it("test", function(done){
                tester.compareAt(1, "shadow/shadow_multiDirection_shadowMaps.png", done);
            });
        });

        describe("test point light shadow", function(){
            function body(wrapper){
                wrapper.load([
                        {url: "../../asset/texture/1.jpg", id: "texture"},
                        {url: "../../asset/texture/crate.gif", id: "ground"}
            ...
            it("test", function(done){
                tester.compareAt(1, "shadow/shadow_point_shadowMap.png", done);
            });
        });

        describe("test direction,point light shadow", function(){
            function body(wrapper){
                wrapper.load([
                        {url: "../../asset/texture/1.jpg", id: "texture"},
                        {url: "../../asset/texture/crate.gif", id: "ground"}
            ...
            it("test", function(done){
                tester.compareAt(1, "shadow/shadow_direction_point_shadowMaps.png", done);
            });
        });
