...
//            directionLight.transform.rotateLocal(wd.Vector3.create(0, 90, 0));
        ...
        describe("test specular map", function () {
            function body(wrapper){
                wrapper.load([
            ...
            it("test", function (done) {
                tester.compareAt(1, "light/light_specularMap.png", done);
            });
        });

        describe("test point,direction light", function () {
            function body(wrapper){
                wrapper.load([
                    ])
                    .do(initSample);
            ...
            it("test", function (done) {
                tester.compareAt(1, "light/light_point_direction.png", done);
            });
        });
