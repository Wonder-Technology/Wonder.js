...
let buildFakeGl =
    (
      ...
      ~texture2D=(-1),
      ~textureCubemap=(-1),
      ~textureCubemapPositiveX=1,
      ~textureCubemapNegativeX=2,
      ~textureCubemapPositiveY=3,
      ~textureCubemapNegativeY=4,
      ~textureCubemapPositiveZ=5,
      ~textureCubemapNegativeZ=6,
      ~textureUnit0=(-1),
      ~compile_status=(-1),
      ~link_status=(-1),
      ~vertex_shader=(-1),
      ...
      ~depthFunc=createEmptyStub(refJsObjToSandbox(sandbox^)),
