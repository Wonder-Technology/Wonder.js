...
describe("MD2ToWD", function () {
    ...
    beforeAll(function () {
        filePath1 = path.join(process.cwd(), "../res/md2/cube.md2");
    ...
    describe("convert objects", function(){
        ...
        it("test1", function (done) {
            ...
            judge(testFile, filePath1, function (json) {
                ...
                var positions = [-6.94, 6.73, 5.21, 5.74, 6.73, 6.42, 6.88, -5.60, 5.21, 5.74, -5.60, -6.47, -6.94, 5.52, -6.47, 6.88, 6.73, -5.31, -5.80, -5.60, 6.42, -6.94, -4.39, -6.47, -6.94, 6.73, -5.31, 6.88, 5.52, 6.42, 6.88, 5.52, -6.47, -6.94, 5.52, 6.42, 5.74, -5.60, 6.42, -5.80, -5.60, -6.47, 6.88, -5.60, -5.31, -6.94, -5.60, 5.21, -0.01, 6.73, -0.05, 6.88, 6.73, 5.21, -5.80, 6.73, 6.42, 5.74, 6.73, -6.47, -6.94, -5.60, -5.31, 6.88, -4.39, 6.42, -6.94, -4.39, 6.42, 6.88, -4.39, -6.47, -5.80, 6.73, -6.47],
                    morphTargets = [{
                        name: "FRAME000",
                    ...
                    texCoords = [0, 0.859375, 0.0625, 0.953125, 0.90625, 0.953125, 0.484375, 0.484375, 0.078125, 0.0625, 0, 0.859375, 0.09375, 0.03125, 0.984375, 0.125, 0.09375, 0.03125, 0.984375, 0.125, 0.0625, 0.015625, 0, 0.859375, 0, 0.109375, 0.984375, 0.875, 0, 0.875, 0.90625, 0.015625, 0.078125, 0.953125, 1, 0.859375, 1, 0.109375, 0.90625, 0.953125, 0.078125, 0.015625, 0.984375, 0.109375, 0.984375, 0.859375, 0, 0.109375, 0.90625, 0.015625, 0, 0.859375, 0.078125, 0.0625, 0.90625, 0.953125, 1, 0.15625, 1, 0.859375, 0.078125, 0.953125, 0, 0.15625, 0, 0.953125, 1, 0.953125, 0, 0.0625, 1, 0.0625, 0.90625, 0.0625, 0.984375, 0.875, 0, 0.875, 0, 0.125, 0.890625, 0.96875, 0.09375, 0.96875, 0.984375, 0.96875, 0.890625, 0.03125, 0.984375, 0.03125, 0.90625, 0.9375, 1, 0.140625, 1, 0.859375, 0.078125, 0.9375, 0, 0.140625, 1, 0.9375, 1, 0.0625, 0.90625, 0.0625, 0, 0.125, 0.890625, 0.96875, 0.09375, 0.96875, 0.890625, 0.03125],
                    texCoordIndices = [15, 17, 18, 15, 20, 12, 15, 12, 11, 15, 11, 16, 16, 19, 17, 17, 15, 16, 52, 46, 51, 7, 56, 6, 9, 44, 43, 34, 31, 26, 9, 43, 8, 46, 52, 4, 28, 36, 26, 36, 28, 35, 29, 28, 26, 13, 6, 53, 13, 7, 6, 37, 9, 8, 47, 46, 4, 49, 0, 4, 31, 25, 26, 37, 8, 39, 27, 26, 25, 53, 14, 13, 39, 38, 37, 45, 4, 0, 4, 45, 47, 26, 27, 29, 54, 13, 14, 40, 37, 38, 0, 48, 45, 33, 29, 27, 30, 25, 32, 37, 40, 42, 25, 30, 27, 50, 47, 45, 38, 41, 40, 14, 55, 54, 21, 22, 2, 3, 1, 5, 5, 23, 10, 2, 3, 21, 10, 3, 5, 3, 2, 1, 3, 10, 24, 3, 24, 21],
    ...
    describe("convert materials", function () {
        it("has no materials", function(done){
