...
defineFeature(feature, test => {
  let transformData: ref<WonderEngineCore.RegisterComponentType.usedComponentData> = ref(Obj.magic(1))
  let directionLightData: ref<WonderEngineCore.RegisterComponentType.usedComponentData> = ref(
    Obj.magic(1),
  )
  ...
  let _prepare = (given, \"when", \"and") => {
    ...
    \"and"("create and set all component states", () => {
      ...
      directionLightData :=
        WonderEngineCore.Main.unsafeGetRelatedComponentData(directionLightComponentName)
    })
    ...
    \"and"("create a directionLight", () => {
      let (d, l) = WonderEngineCore.Main.createComponent(directionLightData.contents)
