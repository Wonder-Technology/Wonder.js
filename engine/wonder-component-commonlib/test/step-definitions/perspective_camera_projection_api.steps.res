...
defineFeature(feature, test => {
  ...
  let _prepare = (given, \"and", isDebug) => {
    ...
    \"and"("create a perspectiveCameraProjection", () => {
      data :=
        WonderEngineCore.Main.unsafeGetRelatedComponentData(perspectiveCameraProjectionComponentName)
      let (d, p) = WonderEngineCore.Main.createComponent(data.contents)
