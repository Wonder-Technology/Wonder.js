...
function _getAspect(data, cameraProjection) {
  return OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponentData(data, cameraProjection, Index$WonderComponentTypePerspectivecameraprojection.dataName.aspect));
}

function _getNear(data, cameraProjection) {
  return OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponentData(data, cameraProjection, Index$WonderComponentTypePerspectivecameraprojection.dataName.near));
}

function _getFar(data, cameraProjection) {
  return OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponentData(data, cameraProjection, Index$WonderComponentTypePerspectivecameraprojection.dataName.far));
}

function _getFovy(data, cameraProjection) {
  return OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponentData(data, cameraProjection, Index$WonderComponentTypePerspectivecameraprojection.dataName.fovy));
}

function _setPMatrix(data, cameraProjection, pMatrix) {
  return Main$WonderEngineCore.setComponentData(data, cameraProjection, Index$WonderComponentTypePerspectivecameraprojection.dataName.pMatrix, pMatrix);
}
