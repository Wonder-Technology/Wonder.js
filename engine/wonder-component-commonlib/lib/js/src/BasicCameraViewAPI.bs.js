...
function getViewWorldToCameraMatrix(basicCameraViewData, transformData, cameraView) {
  return OptionSt$WonderCommonlib.toNullable(OptionSt$WonderCommonlib.bind(OptionSt$WonderCommonlib.bind(ArraySt$WonderCommonlib.getFirst(Main$WonderEngineCore.getComponentGameObjects(basicCameraViewData, cameraView)), (function (gameObject) {
                        return OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponent(transformData, gameObject));
                      })), (function (transform) {
                    return OptionSt$WonderCommonlib.map(OptionSt$WonderCommonlib.fromNullable(Main$WonderEngineCore.getComponentData(transformData, transform, Index$WonderComponentTypeTransform.dataName.localToWorldMatrix)), (function (localToWorldMatrix) {
...
function _isActive(data, cameraView) {
  return NullableTool$WonderCommonlib.getExn(Main$WonderEngineCore.getComponentData(data, cameraView, Index$WonderComponentTypeBasiccameraview.dataName.active));
}
...
function getActiveCameraView(data, isDebug) {
  return OptionSt$WonderCommonlib.toNullable(OptionSt$WonderCommonlib.map(ArraySt$WonderCommonlib.getFirst(_checkAtMostTwo(ArraySt$WonderCommonlib.filter(Main$WonderEngineCore.getAllComponents(data), (function (param) {
