...
let getVerticesInfosLength = (geometryCount) =>
  geometryCount * getInfoSize();
...
let getTexCoordsInfosLength = (geometryCount) =>
  geometryCount * getInfoSize();
...
let getNormalsInfosLength = (geometryCount) =>
  geometryCount * getInfoSize();
...
let getIndicesInfosLength = (geometryCount) =>
  geometryCount * getInfoSize();
