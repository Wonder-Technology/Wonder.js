...
export var getOrCreateBuffer = (gl: WebGLRenderingContext, geometryIndex: number, getIndicesFunc:Function, GeometryWorkerData: any, IndexBufferDataFromSystem: any) => {
    ...
    _initBuffer(gl, getIndicesFunc(geometryIndex, GeometryWorkerData), buffer, IndexBufferDataFromSystem);
