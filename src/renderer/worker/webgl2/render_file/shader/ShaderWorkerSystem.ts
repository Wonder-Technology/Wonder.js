...
export var buildSendUniformDataDataMap = (
    ...
    getPointLightPosition, getPointLightColorArr3, getPointLightConstant, getPointLightIntensity, getPointLightLinear, getPointLightQuadratic, getPointLightRange, computePointLightRadius,
    ...
    return {
        ...
        pointLightData: {
            ...
            computeRadius: computePointLightRadius,
