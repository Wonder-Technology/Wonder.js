import {
    ...
    initData as initDataUtils, initShader as initShaderUtils, isProgramExist as isProgramExistUtils, registerProgram as registerProgramUtils,
...
export var sendAttributeData = sendAttributeDataUtils;
