...
export var bindAndUpdate = (gl:WebGLRenderingContext, materialIndex: number, TextureCacheWorkerData:any, TextureWorkerData:any, MapManagerWorkerData:any) => {
    bindAndUpdateUtils(gl, getMapCount(materialIndex, MapManagerWorkerData), TextureCacheWorkerData, TextureWorkerData, MapManagerWorkerData, bindToUnit, needUpdate, update);
}
