...
import { WebGL1DrawFuncDataMap, WebGL1SendUniformDataDataMap } from "../../type/utilsType";

// export var init = (gl:any, GBufferData:any, DeferLightPassData:any, ShaderData:any, ProgramData, LocationData, GLSLSenderData) => {
// }

export var draw = (gl:any, state: Map<any, any>, render_config:IRenderConfig, material_config:IMaterialConfig, shaderLib_generator:IShaderLibGenerator, DataBufferConfig: any, initMaterialShader:Function, drawFuncDataMap:WebGL1DrawFuncDataMap, drawDataMap: DrawDataMap, sendDataMap:WebGL1SendUniformDataDataMap, initShaderDataMap:InitShaderDataMap, bufferData: RenderCommandBufferForDrawData) => {
