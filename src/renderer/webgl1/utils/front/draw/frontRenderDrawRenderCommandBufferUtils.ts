...
export var draw = (gl:any, state:Map<any, any>, render_config:IRenderConfig, material_config:IMaterialConfig, shaderLib_generator:IShaderLibGenerator, DataBufferConfig: any, initMaterialShader:Function, {
    bindIndexBuffer,
    sendAttributeData,
    sendUniformData,
    ...
    bindAndUpdate,
    useShader
}, drawDataMap: DrawDataMap, sendDataMap:WebGL1SendUniformDataDataMap, initShaderDataMap:InitShaderDataMap, bufferData: RenderCommandBufferForDrawData) => {
    var {
