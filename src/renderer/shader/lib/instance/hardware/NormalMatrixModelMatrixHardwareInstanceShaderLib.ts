module wd{
    export class NormalMatrixModelMatrixHardwareInstanceShaderLib extends NormalMatrixModelMatrixInstanceShaderLib{
        ...
        public type:string = "normalMatrix_modelMatrix_hardware_instance";
