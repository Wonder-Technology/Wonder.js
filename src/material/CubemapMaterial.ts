...
module dy{
    export class CubemapMaterial extends Material{
        ...
        public init(){
            ...
            ////todo build method
            ////todo move to base
            //this.shader.addLib(render.CommonShaderLib.getInstance().createShaderDefinition());
            //
            //if(envMap.mode === CubemapMode.REFLECTION){
            //    this.shader.addLib(render.RelectionShaderLib.getInstance().createShaderDefinition());
            //}
            ////todo more
            //
            //this.shader.build();
