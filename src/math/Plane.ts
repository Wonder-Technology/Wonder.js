...
module dy {
    export class Plane{
        ...
        constructor(a: number, b: number, c: number, d: number){
            ...
            this.originToPlaneDistance = d;
        }

        public normal:Vector3 = Vector3.create(0, 1, 0);
        public originToPlaneDistance:number = 0;
        ...
        public getReflectionMatrix():Matrix {
            ...
            result.values[12] = temp * this.originToPlaneDistance;
            result.values[13] = temp2 * this.originToPlaneDistance;
            result.values[14] = temp3 * this.originToPlaneDistance;
        ...
        public normalize():Plane {
            ...
            this.originToPlaneDistance *= magnitude;
