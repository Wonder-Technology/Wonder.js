...
let execJob = (flags, e, stateData) =>
  MostUtils.callFunc(
    () => {
      ...
      let {matrixFloat32ArrayMap, matrixInstanceBufferCapacityMap, isSendTransformMatrixDataMap} = sourceInstanceRecord;
      let (matrixFloat32ArrayMap, matrixInstanceBufferCapacityMap, isSendTransformMatrixDataMap) =
        ...
        |> WonderCommonlib.ArrayService.reduceOneParam(
             ...
             (
               (
                 ...
                 DisposeSourceInstanceAllService.disposeMatrixFloat32ArrayMap(
                   sourceInstance,
                   MemoryRenderWorkerSettingService.getMaxBigTypeArrayPoolSize(settingRecord),
                   matrixFloat32ArrayMap,
                   typeArrayPoolRecord
                 ),
             ...
             (matrixFloat32ArrayMap, matrixInstanceBufferCapacityMap, isSendTransformMatrixDataMap)
           );
