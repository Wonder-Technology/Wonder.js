...
[@bs.get]
external getTextureMagFilter : webgl1Context => int = "TEXTURE_MAG_FILTER";

[@bs.get]
external getTextureMinFilter : webgl1Context => int = "TEXTURE_MIN_FILTER";

[@bs.get] external getRepeat : webgl1Context => int = "REPEAT";

[@bs.get]
external getMirroredRepeat : webgl1Context => int = "MIRRORED_REPEAT";
...
[@bs.get]
external getNearestMipmapNearest : webgl1Context => int =
  "NEAREST_MIPMAP_NEAREST";

[@bs.get]
external getNearestMipmapLinear : webgl1Context => int =
  "NEAREST_MIPMAP_LINEAR";

[@bs.get] external getLinear : webgl1Context => int = "LINEAR";

[@bs.get]
external getLinearMipmapNearest : webgl1Context => int =
  "LINEAR_MIPMAP_NEAREST";

[@bs.get]
external getLinearMipmapLinear : webgl1Context => int = "LINEAR_MIPMAP_LINEAR";
...
[@bs.get]
external getLuminanceAlpha : webgl1Context => int = "LUMINANCE_ALPHA";
...
[@bs.get]
external getUnsignedShort565 : webgl1Context => int = "UNSIGNED_SHORT_5_6_5";

[@bs.get]
external getUnsignedShort4444 : webgl1Context => int =
  "UNSIGNED_SHORT_4_4_4_4";

[@bs.get]
external getUnsignedShort5551 : webgl1Context => int =
  "UNSIGNED_SHORT_5_5_5_1";

[@bs.get]
external getUnpackFlipYWebgl : webgl1Context => int = "UNPACK_FLIP_Y_WEBGL";

[@bs.get]
external getMaxTextureImageUnits : webgl1Context => int =
...
[@bs.get]
external getFragmentShader : webgl1Context => int = "FRAGMENT_SHADER";
...
external getWebgl1Context :
  ('canvas, [@bs.as "webgl"] _, ContextType.contextConfigJsObj) =>
  webgl1Context =
  "getContext";

[@bs.send]
external getVertexAttribArrayEnabled : int => int =
  "VERTEX_ATTRIB_ARRAY_ENABLED";

[@bs.send.pipe: webgl1Context]
external getExtension : string => Js.nullable(extension) = "";
...
[@bs.send.pipe: webgl1Context]
external bindBuffer : (int, buffer) => unit = "";
...
[@bs.send.pipe: webgl1Context]
external bufferFloat32DataWithCapacity : (int, int, int) => unit =
  "bufferData";
...
[@bs.send.pipe: webgl1Context]
external texParameteri : (int, int, int) => unit = "";
...
[@bs.send.pipe: webgl1Context]
external disableVertexAttribArray : int => unit = "";