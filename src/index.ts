...
export { DeviceManager, setDeviceManagerViewport, setDeviceManagerGL, setDeviceManagerClearColor, getDeviceManagerGL } from "./renderer/device/DeviceManager";
