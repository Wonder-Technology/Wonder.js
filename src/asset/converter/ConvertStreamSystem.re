...
let _addImageData =
  ...
  /* WonderLog.Log.print("add image data") |> ignore; */

  /* WonderLog.Log.print((lightMaterial, materials, textures, images)) |> ignore; */
...
let buildJsonData =
  ...
  /* WonderLog.Log.print(activeCameraNodeIndex) |> ignore; */
...
let _writeStreamChunk =
    (
      ...
      (chunkType, default11ImageUint8Array, streamChunkArr),
      byteOffset,
      dataView,
    ) => {
  WonderLog.Contract.requireCheck(
  ...
  let byteOffset =
    byteOffset
    |> DataViewCommon.writeUint32_1(
         default11ImageUint8ArrayAlignedByteLength
         + streamChunkArrAlignedByteLength,
         _,
         dataView,
       )
    |> DataViewCommon.writeUint32_1(chunkType, _, dataView);
...
let getStreamChunkArrAlignedByteLength = streamChunkArr =>
...
let buildStreamChunk = (byteOffset, streamChunkArr, dataView) => {
  ...
  _writeStreamChunk(
    ...
    (chunkType, _getDefault11ImageUint8Array(), streamChunkArr),
    byteOffset,
    dataView,
  );
};
               ...
               test(
                 ...
                 () => {
                   ...
                   WonderLog.Log.print((
                     ...
                     + byteLength
                     |> BufferUtils.alignedLength,
                     _getBinBufferByteLength(binBuffer),
                   ))
                   |> ignore;
