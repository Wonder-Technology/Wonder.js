module wd{
    export class OneToOneSourceInstance extends SourceInstance{
        ...
        @ensure(function(){
            it("children should contain OneToOneSourceInstance component", () => {
                this.entityObject.forEach((child:GameObject) => {
                    IterateUtils.forEachAll(child, (child:GameObject) => {
                        expect(InstanceUtils.isOneToOneSourceInstance(child)).true;
                    });
                });
            }, this);
        })
        ...
        public cloneInstance(name:string):GameObject{
            ...
            var clone = (name:string, entityObject:GameObject) => {
                ...
                sourceInstanceList = entityObject.getComponent<OneToOneSourceInstance>(OneToOneSourceInstance).instanceList;
        ...
        @ensure(function(){
            it("children should contain only one OneToOneSourceInstance component", () => {
        ...
        private _addSourceInstanceToChildren(){
            var add = (child:GameObject) => {
                if(!InstanceUtils.isOneToOneSourceInstance(child)){
                    let sourceInstanceComponent = OneToOneSourceInstance.create();
