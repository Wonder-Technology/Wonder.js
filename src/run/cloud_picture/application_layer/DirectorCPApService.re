...
let _injectDependencies =
  ...
  RepoDpRunAPI.set({
    ...
    bsdfMaterialRepo: {
      ...
      getTransmission: BSDFMaterialCPRepoDp.getTransmission,
      setTransmission: BSDFMaterialCPRepoDp.setTransmission,
      getIOR: BSDFMaterialCPRepoDp.getIOR,
      setIOR: BSDFMaterialCPRepoDp.setIOR,
