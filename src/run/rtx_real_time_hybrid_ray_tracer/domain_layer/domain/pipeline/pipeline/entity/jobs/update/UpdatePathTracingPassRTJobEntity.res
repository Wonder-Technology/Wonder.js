...
let _buildAndSetSceneDescBufferData = (
  ...
  ->Result.mapSuccess(_ => {
    ...
    PathTracingPassRTRepo.setSceneDescBufferData((buffer, bufferSize, bufferData))
  })
}
...
let _buildAndSetPointIndexBufferData = (device, allRenderGeometries) => {
  ...
  ->ListSt.traverseReduceResultMi((0, 0), ((vertexIndex, faceIndex), (geometryIndex, geometry)) =>
    ListResult.mergeResults(list{
      TypeArrayRTRepoUtils.setUint32_1(geometryIndex * stride, vertexIndex, bufferData),
      TypeArrayRTRepoUtils.setUint32_1(geometryIndex * stride + 1, faceIndex, bufferData),
    })->Result.mapSuccess(() => (
  ...
  ->Result.mapSuccess(_ => {
    ...
    PathTracingPassRTRepo.setPointIndexBufferData((buffer, bufferSize, bufferData))
  })
}
...
let _buildAndSetVertexBufferData = (device, allRenderGeometries) => {
  ...
  PathTracingPassRTRepo.setVertexBufferData((buffer, bufferSize, bufferData))
}
...
let _createIndexBufferData = allRenderGeometries => {
  ...
  allRenderGeometries->ListSt.traverseReduceResultM(0, (offset, geometry) =>
    ...
    | Some(indices) =>
      TypeArrayRTRepoUtils.fillUint32ArrayWithOffset(
        bufferData,
...
let _buildAndSetIndexBufferData = (device, allRenderGeometries) =>
  _createIndexBufferData(allRenderGeometries)->Result.mapSuccess(bufferData => {
    ...
    PathTracingPassRTRepo.setIndexBufferData((buffer, bufferSize))
  })
...
let _getMapLayerIndex = mapImageIdOpt =>
  ...
  | Some(imageId) =>
    TextureArrayWebGPURTRepo.getLayerIndex(imageId->ImageIdVO.value)->OptionSt.getWithDefault(
...
let _computeMapScale = mapImageIdOpt => {
  ...
  | Some(imageId) =>
    ...
    | Some({width, height}: ImageRepoType.data) =>
      ...
      ) = TextureArrayWebGPURTDoService.getTextureArrayLayerSize()
...
let _buildAndSetBSDFMaterialBufferData = (device, allRenderBSDFMaterials) => {
  ...
  allRenderBSDFMaterials->ListSt.traverseReduceResultM(0, (offset, bsdfMaterial) => {
    ...
    ->Result.bind(((
      ...
      ListResult.mergeResults(list{
        TypeArrayRTRepoUtils.setFloat4(offset + 0, diffuse, bufferData),
        TypeArrayRTRepoUtils.setFloat3(offset + 4, emissionColor, bufferData),
        TypeArrayRTRepoUtils.setFloat3(offset + 8, specularColor, bufferData),
        TypeArrayRTRepoUtils.setFloat1(offset + 11, alphaCutoff, bufferData),
        TypeArrayRTRepoUtils.setFloat4(
          offset + 12,
        ...
        TypeArrayRTRepoUtils.setFloat2(offset + 24, diffuseMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 26, channelRoughnessMetallicMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 28, emissionMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 30, normalMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 32, transmissionMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 34, specularMapScale, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 36, diffuseMapImageWrapData, bufferData),
        TypeArrayRTRepoUtils.setFloat2(
          offset + 38,
          channelRoughnessMetallicMapImageWrapData,
          bufferData,
        ),
        TypeArrayRTRepoUtils.setFloat2(offset + 40, emissionMapImageWrapData, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 42, normalMapImageWrapData, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 44, transmissionMapImageWrapData, bufferData),
        TypeArrayRTRepoUtils.setFloat2(offset + 46, specularMapImageWrapData, bufferData),
      })
    )
    ...
    PathTracingPassRTRepo.setBSDFMaterialBufferData((buffer, bufferSize, bufferData))
  })
}
    ...
    WebGPURayTracingDpRunAPI.unsafeGet().device.createRayTracingBindGroup(
      {
        ...
        "entries": [
          ...
          IWebGPURayTracingDp.binding(
            ~binding=10,
            ~buffer=bmfrDataBuffer->StorageBufferVO.value,
            ~offset=0,
...
let _createAndSetPipeline = (device, rtBindGroupLayout) =>
  Tuple3.collectOption(
    PathTracingPassRTRepo.getShaderBindingTable(),
    PathTracingPassRTRepo.getCameraBindGroupLayout(),
    PathTracingPassRTRepo.getDirectionLightBindGroupLayout(),
  )->Result.mapSuccess(((
    shaderBindingTable,
    ...
    WebGPURayTracingDpRunAPI.unsafeGet().device.createRayTracingPipeline(
      ...
      device,
    )->PathTracingPassRTRepo.setPipeline
  )

let exec = () =>
  Tuple2.collectOption(WebGPURTRepo.getDevice(), WebGPURTRepo.getQueue())
      ...
      _buildAndSetAllBufferData(device, SceneRunAPI.getSceneGameObject())->Result.bind(() =>
        Tuple3.collectOption(
          ...
          Tuple7.collectOption(
            PathTracingPassRTRepo.getSceneDescBufferData(),
            PathTracingPassRTRepo.getPointIndexBufferData(),
            PathTracingPassRTRepo.getVertexBufferData(),
            PathTracingPassRTRepo.getIndexBufferData(),
            PathTracingPassRTRepo.getBSDFMaterialBufferData(),
            TextureArrayWebGPURTRepo.getTextureSampler(),
            TextureArrayWebGPURTRepo.getTextureArrayView(),
