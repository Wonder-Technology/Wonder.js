...
let _updateCameraBuffer = ((viewInverse, projectionInverse, near, far)) =>
  CameraRTRepo.getCameraBufferData()
  ->OptionSt.get
  ->Result.bind(((cameraBuffer, cameraBufferData)) =>
    ListResult.mergeResults(list{
      TypeArrayRTRepoUtils.setFloat16WithFloat32Array(0, viewInverse, cameraBufferData),
      TypeArrayRTRepoUtils.setFloat16WithFloat32Array(16, projectionInverse, cameraBufferData),
      TypeArrayRTRepoUtils.setFloat2(16 + 16, (near, far), cameraBufferData),
    })->Result.mapSuccess(() => {
      ...
      CameraRTRepo.setCameraBufferData((cameraBuffer, cameraBufferData))
    })
  )
