let set = (
  {
    ...
    bsdfMaterialRepo,
    geometryRepo,
  }: SceneGraphRepoDpRTType.sceneGraphRepo,
) => {
  let {
    getTransform,
    getDirectionLight,
  ...
  }: SceneGraphRepoDpRTType.gameObjectRepo = gameObjectRepo
  let {
    getColor,
    getIntensity,
    getDirection,
    getAllLights,
  }: SceneGraphRepoDpRTType.directionLightRepo = directionLightRepo
  let {
    getGameObject,
    getViewWorldToCameraMatrix,
    getActiveBasicCameraView,
  }: SceneGraphRepoDpRTType.basicCameraViewRepo = basicCameraViewRepo
  let {
    getDiffuseColor,
    getEmissionColor,
    getSpecular,
    ...
    isDoubleSide,
  }: SceneGraphRepoDpRTType.bsdfMaterialRepo = bsdfMaterialRepo
  let {
    getVertices,
    getNormals,
    getTexCoords,
    ...
    getId: getGeometryId,
  }: SceneGraphRepoDpRTType.geometryRepo = geometryRepo
