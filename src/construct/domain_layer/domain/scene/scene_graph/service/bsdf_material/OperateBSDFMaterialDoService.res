let getDiffuseColor = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getDiffuseColor(material->BSDFMaterialEntity.value)
  ->Color4VO.create
  ->DiffuseVO.create

let getEmissionColor = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getEmissionColor(material->BSDFMaterialEntity.value)
  ->Color3VO.create
  ->EmissionColorVO.create
...
let getSpecularColor = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getSpecularColor(material->BSDFMaterialEntity.value)
  ->Color3VO.create
...
let getIOR = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getIOR(material->BSDFMaterialEntity.value)->IORVO.create
...
let getId = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getId(material->BSDFMaterialEntity.value)
...
let getChannelRoughnessMetallicMapImageWrapData = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().getChannelRoughnessMetallicMapImageWrapData(
    material->BSDFMaterialEntity.value,
  )->OptionSt.map(Tuple2.map(WrapVO.create))
...
let isDoubleSide = material =>
  DpContainer.unsafeGetBSDFMaterialRepoDp().isDoubleSide(material->BSDFMaterialEntity.value)
