...
let create = () =>
  WonderCommonlib.MutableHashMapService.{
    chunkMap:
      ...
      |> set(
           "webgl1_outline_origin_fragment",
           _buildChunk(
             ({||}, {||}),
             {||},
             ({||}, {||}),
      ...
      |> set(
           "webgl1_outline_expand_fragment",
           _buildChunk(
             ({||}, {||}),
             {||},
             ({||}, {||}),
...
|},
      ...
      |> set(
           "webgl1_no_emission_map_fragment",
           _buildChunk(
             ({||}, {||}),
             {||},
             (
...
|},
      ...
      |> set(
           "webgl1_rotation_gizmo_circle_for_editor_vertex",
           _buildChunk(
             ({||}, {||}),
      ...
      |> set(
           "webgl1_rotation_gizmo_circle_for_editor_fragment",
           _buildChunk(
             ({||}, {||}),
             {| varying vec3 v_position; |},
             (
